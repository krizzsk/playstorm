...
public class Toolbar extends ViewGroup {
    ...
    public Toolbar(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getContext(), attributeSet, C0050R.styleable.Toolbar, i, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, C0050R.styleable.Toolbar, attributeSet, obtainStyledAttributes.getWrappedTypeArray(), i, 0);
        ...
        dimensionPixelOffset = obtainStyledAttributes.hasValue(C0050R.styleable.Toolbar_titleMargins) ? obtainStyledAttributes.getDimensionPixelOffset(C0050R.styleable.Toolbar_titleMargins, dimensionPixelOffset) : dimensionPixelOffset;
        ...
        if (obtainStyledAttributes.hasValue(C0050R.styleable.Toolbar_titleTextColor)) {
            setTitleTextColor(obtainStyledAttributes.getColorStateList(C0050R.styleable.Toolbar_titleTextColor));
        }
        if (obtainStyledAttributes.hasValue(C0050R.styleable.Toolbar_subtitleTextColor)) {
            setSubtitleTextColor(obtainStyledAttributes.getColorStateList(C0050R.styleable.Toolbar_subtitleTextColor));
        }
        if (obtainStyledAttributes.hasValue(C0050R.styleable.Toolbar_menu)) {
            inflateMenu(obtainStyledAttributes.getResourceId(C0050R.styleable.Toolbar_menu, 0));
        }
