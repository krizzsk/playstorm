...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mSearchPlate = findViewById(C0050R.C0052id.search_plate);
        this.mSubmitArea = findViewById(C0050R.C0052id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0050R.C0052id.search_button);
        this.mGoButton = (ImageView) findViewById(C0050R.C0052id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0050R.C0052id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0050R.C0052id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0050R.C0052id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, obtainStyledAttributes.getDrawable(C0050R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, obtainStyledAttributes.getDrawable(C0050R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0050R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0050R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0050R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0050R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(obtainStyledAttributes.getDrawable(C0050R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = obtainStyledAttributes.getDrawable(C0050R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0050R.string.abc_searchview_description_search));
        ...
        int i2 = obtainStyledAttributes.getInt(C0050R.styleable.SearchView_android_imeOptions, -1);
        if (i2 != -1) {
            setImeOptions(i2);
        }
        int i3 = obtainStyledAttributes.getInt(C0050R.styleable.SearchView_android_inputType, -1);
        if (i3 != -1) {
            setInputType(i3);
        }
