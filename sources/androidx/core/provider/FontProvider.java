...
class FontProvider {
    private static final Comparator<byte[]> sByteArrayComparator = new Comparator<byte[]>() {
        ...
        public int compare(byte[] r5, byte[] r6) {
            ...
            L_0x001b:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.core.provider.FontProvider.C02311.compare(byte[], byte[]):int");
        }
    };
    ...
    static FontsContractCompat.FontInfo[] query(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) {
        ...
        Uri build2 = new Uri.Builder().scheme("content").authority(str2).appendPath(ShareInternalUtility.STAGING_PARAM).build();
        Cursor cursor = null;
        try {
