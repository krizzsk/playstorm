...
public final class WorkSpec {
    ...
    public int hashCode() {
        int hashCode = ((((this.f39id.hashCode() * 31) + this.state.hashCode()) * 31) + this.workerClassName.hashCode()) * 31;
        String str = this.inputMergerClassName;
    ...
    public static class IdAndState {
        ...
        public boolean equals(Object obj) {
            ...
            return this.f40id.equals(idAndState.f40id);
        }

        public int hashCode() {
            return (this.f40id.hashCode() * 31) + this.state.hashCode();
        }
    }
    ...
    public static class WorkInfoPojo {
        ...
        public WorkInfo toWorkInfo() {
            ...
            return new WorkInfo(UUID.fromString(this.f41id), this.state, this.output, this.tags, data, this.runAttemptCount);
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (str == null ? workInfoPojo.f41id != null : !str.equals(workInfoPojo.f41id)) {
                return false;
            }
