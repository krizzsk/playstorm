                ...
                TaskExecutor.this.executeOnBackgroundThread(new Runnable() {
                    public void run() {
                        synchronized (obj) {
                            ...
                            if (C06261.this.mCurrentOutput == null && apply != null) {
                                C06261.this.mCurrentOutput = apply;
                                mediatorLiveData.postValue(apply);
                            } else if (C06261.this.mCurrentOutput != null && !C06261.this.mCurrentOutput.equals(apply)) {
                                C06261.this.mCurrentOutput = apply;
                                mediatorLiveData.postValue(apply);
                            }
                        }
