...
class SystemJobInfoConverter {
    ...
    public JobInfo convert(WorkSpec workSpec, int i) {
        ...
        persistableBundle.putString(EXTRA_WORK_SPEC_ID, workSpec.f39id);
    ...
    static /* synthetic */ class C05881 {
        ...
        static {
            ...
            L_0x003e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.work.impl.background.systemjob.SystemJobInfoConverter.C05881.<clinit>():void");
        }
    }

    static int convertNetworkType(NetworkType networkType) {
        int i = C05881.$SwitchMap$androidx$work$NetworkType[networkType.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
