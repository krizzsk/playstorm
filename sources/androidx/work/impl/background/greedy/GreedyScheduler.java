        ...
        for (WorkSpec workSpec : workSpecArr) {
            ...
            if (workSpec.state == WorkInfo.State.ENQUEUED) {
                if (currentTimeMillis < calculateNextRunTime) {
                    ...
                    Logger.get().debug(TAG, String.format("Starting work for %s", new Object[]{workSpec.f39id}), new Throwable[0]);
                    this.mWorkManagerImpl.startWork(workSpec.f39id);
