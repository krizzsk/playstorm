        ...
        return new Iterator<String>() {
            ...
            public boolean hasNext() {
                ...
                L_0x003b:
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: okhttp3.Cache.C124282.hasNext():boolean");
            }
    ...
    private static final class Entry {
        ...
        private void writeCertList(BufferedSink bufferedSink, List<Certificate> list) throws IOException {
            try {
                ...
                int size = list.size();
                for (int i = 0; i < size; i++) {
                    bufferedSink.writeUtf8(ByteString.m34811of(list.get(i).getEncoded()).base64()).writeByte(10);
                }
