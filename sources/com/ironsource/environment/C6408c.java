...
public class C6408c {
    ...
    public C6408c(int i, String str, String str2, String str3) {
        this.f16298c = i;
        this.f16297b = str2;
        this.f16296a = str;
        this.f16299d = str3;
    ...
    public C6408c(String str, String str2, String str3) {
        this.f16298c = -1;
        this.f16297b = str2;
        this.f16296a = str;
        this.f16299d = str3;
    ...
    /* renamed from: a */
    public static long m19236a(Context context) {
        try {
            return m19244e(context).firstInstallTime;
    ...
    /* renamed from: a */
    public static JSONObject m19237a(Context context, JSONArray jSONArray) {
    ...
    public static boolean m19238a(android.content.Context r3, java.lang.String r4) {
        /*
        ...
        L_0x0035:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.environment.C6408c.m19238a(android.content.Context, java.lang.String):boolean");
    }

    /* renamed from: b */
    public static long m19239b(Context context) {
        try {
            return m19244e(context).lastUpdateTime;
        } catch (PackageManager.NameNotFoundException e) {
            e.printStackTrace();
            return -1;
        }
    ...
    /* renamed from: b */
    public static boolean m19240b(Context context, String str) {
        return context.checkCallingOrSelfPermission(str) == 0;
    }

    /* renamed from: c */
    public static String m19241c(Context context) {
        try {
            return m19244e(context).versionName;
        } catch (PackageManager.NameNotFoundException e) {
            e.printStackTrace();
            return "";
        }
    ...
    /* renamed from: c */
    public static String m19242c(Context context, String str) {
        try {
    ...
    /* renamed from: d */
    public static String m19243d(Context context) {
        String str;
        try {
    ...
    /* renamed from: e */
    private static PackageInfo m19244e(Context context) {
        return context.getPackageManager().getPackageInfo(context.getPackageName(), 0);
    }

    /* renamed from: a */
    public String mo35916a() {
        return this.f16296a;
    }

    /* renamed from: b */
    public String mo35917b() {
        return this.f16297b;
    }

    /* renamed from: c */
    public String mo35918c() {
        return this.f16299d;
    }

    /* renamed from: d */
    public void mo35919d() {
        C6424f.m19285a(this);
    }
}
