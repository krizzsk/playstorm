...
public class IronSourceStorageUtils {
    ...
    /* renamed from: a */
    private static C8357e f20117a;

    /* renamed from: a */
    private static void m24021a(File file) {
        if (file != null) {
            deleteFolder(m24022b(file).getPath());
        }
    }

    /* renamed from: b */
    private static File m24022b(File file) {
    ...
    public static JSONObject buildFilesMapOfDirectory(C8355c cVar, JSONObject jSONObject) {
        ...
        for (File path : listFiles) {
            C8355c cVar2 = new C8355c(path.getPath());
            if (cVar2.isFile()) {
                str = cVar2.getName();
                jSONObject2 = cVar2.mo56870a();
    ...
    /* renamed from: c */
    private static Object m24023c(File file) {
        JSONObject jSONObject = new JSONObject();
        ...
        try {
            ...
            for (File file2 : file.listFiles()) {
                if (file2.isDirectory()) {
                    jSONObject.put(file2.getName(), m24023c(file2));
                } else {
    ...
    public static void deleteCacheDirectories(Context context) {
        m24021a(C6429h.m19341r(context));
        m24021a(C6429h.m19345t(context));
    }

    public static synchronized boolean deleteFile(C8355c cVar) {
    ...
    public static void deleteFilesDirectories(Context context) {
        m24021a(C6429h.m19343s(context));
        m24021a(C6429h.m19346u(context));
    }
    ...
    public static String getDiskCacheDirPath(Context context) {
        if (SDKUtils.isExternalStorageAvailable()) {
            C8357e eVar = f20117a;
            File s = (eVar == null || !eVar.mo56877a()) ? C6429h.m19343s(context) : C6429h.m19341r(context);
            if (s != null && s.canWrite()) {
                return s.getPath();
            }
        }
        C8357e eVar2 = f20117a;
        return ((eVar2 == null || !eVar2.mo56877a()) ? C6429h.m19346u(context) : C6429h.m19345t(context)).getPath();
    }

    public static ArrayList<C8355c> getFilesInFolderRecursive(C8355c cVar) {
        if (cVar == null || !cVar.isDirectory()) {
            return new ArrayList<>();
        }
        ArrayList<C8355c> arrayList = new ArrayList<>();
        File[] listFiles = cVar.listFiles();
        if (listFiles != null) {
            for (File path : listFiles) {
                C8355c cVar2 = new C8355c(path.getPath());
    ...
    public static String getNetworkStorageDir(Context context) {
        File b = m24022b(new File(getDiskCacheDirPath(context)));
        if (!b.exists()) {
            b.mkdir();
        }
        return b.getPath();
    ...
    public static long getTotalSizeOfDir(C8355c cVar) {
        long totalSizeOfDir;
        long j = 0;
        if (cVar != null && cVar.isDirectory()) {
            File[] listFiles = cVar.listFiles();
    ...
    public static void initializeCacheDirectory(Context context, C8357e eVar) {
        f20117a = eVar;
        if (eVar != null && eVar.f20075a.optBoolean("deleteCacheDir", false)) {
            deleteCacheDirectories(context);
        }
        C8357e eVar2 = f20117a;
        if (eVar2 != null && eVar2.f20075a.optBoolean("deleteFilesDir", false)) {
    ...
    public static String readFile(C8355c cVar) {
