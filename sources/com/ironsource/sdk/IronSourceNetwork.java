...
public class IronSourceNetwork {
    ...
    /* renamed from: a */
    private static C8332e f19404a;

    /* renamed from: b */
    private static C8367d f19405b;

    /* renamed from: c */
    private static JSONObject f19406c;

    /* renamed from: a */
    private static synchronized void m23434a() {
    ...
    public static synchronized void applyConsentInfo(JSONObject jSONObject) {
        synchronized (IronSourceNetwork.class) {
            if (f19404a != null) {
                if (jSONObject != null) {
                    f19404a.mo56794a(jSONObject);
                }
            }
        }
    }

    public static C8367d getInitListener() {
        return f19405b;
    }

    public static synchronized void getOfferWallCredits(C8368e eVar) {
        synchronized (IronSourceNetwork.class) {
            m23434a();
            f19404a.mo56784a(eVar);
        }
    }
    ...
    public static synchronized JSONObject getRawToken(Context context) {
        JSONObject b;
        synchronized (IronSourceNetwork.class) {
            b = C8388d.m24005a().mo56905b(context);
        }
        return b;
    }
    ...
    public static synchronized String getToken(Context context) {
        String a;
        synchronized (IronSourceNetwork.class) {
            a = C8388d.m24005a().mo56900a(context);
        }
        return a;
    }
    ...
    public static synchronized void initOfferWall(Map<String, String> map, C8368e eVar) {
        synchronized (IronSourceNetwork.class) {
            m23434a();
            f19404a.mo56793a(map, eVar);
        }
    }
    ...
    public static synchronized void initSDK(android.content.Context r6, java.lang.String r7, java.lang.String r8, java.util.Map<java.lang.String, java.lang.String> r9) {
        /*
            ...
            com.ironsource.sdk.utils.Logger.m24026e(r6, r7)     // Catch:{ all -> 0x00be }
            monitor-exit(r0)
            return
        L_0x0012:
            com.ironsource.sdk.e r1 = f19404a     // Catch:{ all -> 0x00be }
            ...
            r3.<init>(r4, r5)     // Catch:{ Exception -> 0x0099 }
            r1.add(r3)     // Catch:{ Exception -> 0x0099 }
            java.util.ArrayList<android.util.Pair<java.lang.String, java.lang.String>> r3 = r2.f16221f     // Catch:{ Exception -> 0x0099 }
            r3.addAll(r1)     // Catch:{ Exception -> 0x0099 }
            r1 = 0
            r2.f16220e = r1     // Catch:{ Exception -> 0x0099 }
            com.ironsource.a.a r3 = new com.ironsource.a.a     // Catch:{ Exception -> 0x0099 }
            r3.<init>(r2)     // Catch:{ Exception -> 0x0099 }
            boolean r2 = r3.f16211b     // Catch:{ Exception -> 0x0099 }
            ...
            r2.f19412a = r9     // Catch:{ Exception -> 0x0099 }
        L_0x008a:
            r2.f19414c = r6     // Catch:{ Exception -> 0x0099 }
            r2.f19415d = r8     // Catch:{ Exception -> 0x0099 }
            r2.f19413b = r7     // Catch:{ Exception -> 0x0099 }
            com.ironsource.sdk.a.b r9 = new com.ironsource.sdk.a.b     // Catch:{ Exception -> 0x0099 }
            r9.<init>(r2, r1)     // Catch:{ Exception -> 0x0099 }
            com.ironsource.sdk.p286a.C8154d.m23440a((com.ironsource.p197a.C6375a) r3, (com.ironsource.sdk.p286a.C8151b) r9)     // Catch:{ Exception -> 0x0099 }
            goto L_0x00b1
        L_0x0099:
            r9 = move-exception
            ...
            com.ironsource.sdk.utils.Logger.m24026e(r1, r9)     // Catch:{ all -> 0x00be }
        L_0x00b1:
            com.ironsource.sdk.e r6 = com.ironsource.sdk.p289d.C8315b.m23815a((java.lang.String) r7, (java.lang.String) r8, (android.content.Context) r6)     // Catch:{ all -> 0x00be }
            f19404a = r6     // Catch:{ all -> 0x00be }
            org.json.JSONObject r6 = f19406c     // Catch:{ all -> 0x00be }
    ...
    public static synchronized boolean isAdAvailableForInstance(C8158b bVar) {
        synchronized (IronSourceNetwork.class) {
            if (f19404a == null) {
                return false;
            }
            boolean a = f19404a.mo56795a(bVar);
            return a;
        }
    }

    public static synchronized void loadAd(Activity activity, C8158b bVar, Map<String, String> map) {
        synchronized (IronSourceNetwork.class) {
            m23434a();
            f19404a.mo56777a(activity, bVar, map);
        }
    }
    ...
    public static synchronized void setInitListener(C8367d dVar) {
        synchronized (IronSourceNetwork.class) {
            f19405b = dVar;
        }
    }

    public static synchronized void showAd(C8158b bVar, Map<String, String> map) {
        synchronized (IronSourceNetwork.class) {
            m23434a();
            f19404a.mo56779a(bVar, map);
        }
    }
    ...
    public static synchronized void updateMetadata(JSONObject jSONObject) {
        synchronized (IronSourceNetwork.class) {
            ...
            while (keys.hasNext()) {
                ...
                a.mo56903a("metadata_" + next, jSONObject.opt(next));
            }
        }
    }
}
