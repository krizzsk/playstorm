...
import com.ironsource.environment.p204d.C6415b;
...
public class ServerURL {
    ...
    public static String getCPVProvidersURL(Context context, String str, String str2, String str3, String str4, boolean z, Vector<Pair<String, String>> vector) {
        ...
        if (z) {
            vector2.add(new Pair(REWARDED_VIDEO_MANUAL_MODE, z ? "1" : "0"));
        }
        ...
        String c = C6408c.m19242c(context, context.getPackageName());
        ...
        ConcurrentHashMap<String, List<String>> d = C6774k.m20599a().mo36978d();
        ...
        String r = C6429h.m19342r();
        if (r.length() != 0) {
            vector2.add(new Pair(BROWSER_USER_AGENT, r));
        }
        String str5 = null;
        try {
            str5 = C6429h.m19303a(context) + "-" + C6429h.m19307b(context);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        if (context != null) {
            ...
            sb3.append(C6399a.C64001.m19223c(context));
            vector2.add(new Pair(MOBILE_COUNTRY_CODE, sb3.toString()));
            StringBuilder sb4 = new StringBuilder();
            sb4.append(C6399a.C64001.m19226d(context));
        ...
        return getBaseUrl(IronSourceUtils.getSDKVersion()) + URLEncoder.encode(IronSourceAES.encode(C6770g.m20577a().mo36966b(), createURLParams(vector2)), "UTF-8");
    }
