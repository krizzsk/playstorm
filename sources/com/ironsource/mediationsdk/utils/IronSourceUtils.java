...
import com.ironsource.mediationsdk.C6479F;
...
public class IronSourceUtils {
    ...
    private static final String SDK_VERSION = "7.2.2.1";
    ...
    public static String getDeviceType(Context context) {
        return C6429h.m19311c(context) ? "Tablet" : "Phone";
    }

    public static boolean getFirstSession(Context context) {
        if (mFirstSession == null) {
            mFirstSession = Boolean.valueOf(!C6479F.m19406b(context));
        }
    ...
    public static C6485I getIronSourceAdvId(Context context) {
        String str;
        if (context == null) {
            return null;
        }
        C6490J.m19474a();
        String a = C6490J.m19476a(context);
    ...
    public static String getMediationUserId() {
        return C6723e.m20496a().mo36909a(DataKeys.USER_ID);
    }

    public static JSONObject getProviderAdditionalData(C6642b bVar) {
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put(PROVIDER_PRIORITY, bVar.f17253n);
            jSONObject.put(SUB_PROVIDER_ID_KEY, bVar.f17245f);
            jSONObject.put("provider", !TextUtils.isEmpty(bVar.f17246g) ? bVar.f17246g : bVar.mo36637j());
            jSONObject.put(SDK_VERSION_KEY, bVar.f17241b.getCoreSDKVersion());
            jSONObject.put(ADAPTER_VERSION_KEY, bVar.f17241b.getVersion());
        } catch (Exception e) {
            IronSourceLoggerManager logger = IronSourceLoggerManager.getLogger();
            IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.NATIVE;
            logger.logException(ironSourceTag, "IronSourceUtils:getProviderAdditionalData(adapter: " + bVar.mo36637j() + ")", e);
        }
        return jSONObject;
    }

    public static JSONObject getProviderAdditionalData(C6708n nVar) {
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put(SUB_PROVIDER_ID_KEY, nVar.f17559b.getSubProviderId());
            jSONObject.put("provider", !TextUtils.isEmpty(nVar.f17559b.getAdSourceNameForEvents()) ? nVar.f17559b.getAdSourceNameForEvents() : nVar.mo36831a());
            jSONObject.put(SDK_VERSION_KEY, nVar.f17558a.getCoreSDKVersion());
            jSONObject.put(ADAPTER_VERSION_KEY, nVar.f17558a.getVersion());
            jSONObject.put(PROVIDER_PRIORITY, nVar.f17563f);
        } catch (Exception e) {
            IronSourceLoggerManager logger = IronSourceLoggerManager.getLogger();
            IronSourceLogger.IronSourceTag ironSourceTag = IronSourceLogger.IronSourceTag.NATIVE;
            logger.logException(ironSourceTag, "IronSourceUtils:getProviderAdditionalData(adapter: " + nVar.mo36831a() + ")", e);
        }
        return jSONObject;
    }
    ...
    public static String getSHA256(String str) {
        try {
            return String.format("%064x", new Object[]{new BigInteger(1, MessageDigest.getInstance(Constants.SHA256).digest(str.getBytes()))});
    ...
    public static String getTransId(long j, String str) {
        return getSHA256(String.format("%s%s%s", new Object[]{Long.valueOf(j), C6490J.m19474a().f16544j, str}));
    }

    public static String getUserIdForNetworks() {
        String a = C6723e.m20496a().mo36909a("userIdType");
        String a2 = C6723e.m20496a().mo36909a(DataKeys.USER_ID);
