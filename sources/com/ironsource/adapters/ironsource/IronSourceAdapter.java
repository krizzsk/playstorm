...
import com.ironsource.sdk.C8165c;
...
public class IronSourceAdapter extends AbstractAdapter implements ContextProvider.C6397a, C6753m, C8368e {
    private static final int IS_LOAD_EXCEPTION = 1000;
    private static final int IS_SHOW_EXCEPTION = 1001;
    private static final int RV_LOAD_EXCEPTION = 1002;
    private static final int RV_SHOW_EXCEPTION = 1003;
    private static final String VERSION = "7.2.2.1";
    ...
    private com.ironsource.sdk.C8149a convertBannerSize(android.app.Activity r10, com.ironsource.mediationsdk.ISBannerSize r11) {
        /*
            r9 = this;
    ...
    private C8158b createBannerAdInstance(String str, C8149a aVar) {
        IronLog ironLog = IronLog.ADAPTER_API;
        ironLog.verbose("creating banner ad instance for " + str);
        C8165c cVar = new C8165c(str, new IronSourceBannerListener(this, this.mDemandSourceToBNSmash.get(str), str));
        cVar.f19469d = getInitParams();
        cVar.f19467b = true;
        cVar.f19468c = aVar;
        return cVar.mo56437a();
    }

    private C8158b getAdInstance(String str, boolean z, boolean z2, boolean z3) {
        C8165c cVar;
        C8158b bVar = (z3 ? this.mDemandSourceToRvAd : this.mDemandSourceToISAd).get(str);
        if (bVar == null) {
            IronLog ironLog = IronLog.ADAPTER_API;
            ...
            if (z3) {
                ...
                cVar = new C8165c(str, new IronSourceInterstitialListener(this.mDemandSourceToISSmash.get(str), str));
                cVar.f19469d = getInitParams();
            }
            if (z2) {
                cVar.f19467b = true;
    ...
    private HashMap<String, String> getInitParams() {
        ...
        if (!TextUtils.isEmpty(C6490J.m19474a().f16550p)) {
            hashMap.put("sessionid", C6490J.m19474a().f16550p);
        }
        return hashMap;
    }
    ...
    private void initSDK(String str, JSONObject jSONObject) {
        if (mDidInitSdk.compareAndSet(false, true)) {
            ...
            HashMap<String, String> initParams = getInitParams();
            String str2 = C6490J.m19474a().f16544j;
            IronLog ironLog4 = IronLog.ADAPTER_API;
            ironLog4.verbose("with appKey=" + str2 + " userId=" + mediationUserId + " parameters " + initParams);
            IronSourceNetwork.setInitListener(new C8367d() {
                public void onFail(C8349e eVar) {
                    IronLog ironLog = IronLog.ADAPTER_API;
                    ironLog.verbose("OnNetworkSDKInitListener fail - code:" + eVar.f20064b + " message:" + eVar.f20063a);
                }
    ...
    private void loadAdInternal(String str, String str2, boolean z, boolean z2, boolean z3) {
        ...
        if (str2 != null) {
            C6656f.m20309a();
            hashMap.put("adm", C6656f.m20319c(str2));
            C6656f.m20309a();
            hashMap.putAll(C6656f.m20317b(str2));
        }
        C8158b adInstance = getAdInstance(str, z, z2, z3);
        printInstanceExtraParams(hashMap);
        IronLog ironLog = IronLog.ADAPTER_API;
        ironLog.verbose("demandSourceName=" + adInstance.f19444c);
    ...
    private void loadBannerInternal(ISBannerSize iSBannerSize, JSONObject jSONObject, BannerSmashListener bannerSmashListener, String str) {
        ...
        try {
            C8149a convertBannerSize = convertBannerSize(ContextProvider.getInstance().getCurrentActiveActivity(), iSBannerSize);
            ...
            if (str != null) {
                C6656f.m20309a();
                hashMap.put("adm", C6656f.m20319c(str));
                C6656f.m20309a();
                hashMap.putAll(C6656f.m20317b(str));
                printInstanceExtraParams(hashMap);
            }
    ...
    private void showAdInternal(C8158b bVar, int i) {
        int b = C6782o.m20647a().mo36990b(i);
        HashMap hashMap = new HashMap();
        hashMap.put(IronSourceConstants.KEY_SESSION_DEPTH, String.valueOf(b));
        IronLog ironLog = IronLog.ADAPTER_API;
        ironLog.verbose("demandSourceName=" + bVar.f19444c + " showParams=" + hashMap);
    ...
    public void destroyBanner(JSONObject jSONObject) {
        ...
        C8166a aVar = this.mBannerAdContainer;
        if (aVar != null) {
            try {
                if (aVar.f19472a == null || aVar.f19472a.f19482d == null) {
        ...
        postOnUIThread(new Runnable() {
            public void run() {
                try {
                    ...
                    C6724f access$100 = IronSourceAdapter.this.mOfferwallListener;
                    access$100.mo36255a(false, ErrorBuilder.buildInitFailedError("Adapter initialization failure - " + IronSourceAdapter.this.getProviderName() + " - " + e.getMessage(), IronSourceConstants.OFFERWALL_AD_UNIT));
                }
            }
        });
    }
    ...
    public boolean isInterstitialReady(JSONObject jSONObject) {
        C8158b bVar = this.mDemandSourceToISAd.get(getDemandSourceName(jSONObject));
    ...
    public boolean isRewardedVideoAvailable(JSONObject jSONObject) {
        C8158b bVar = this.mDemandSourceToRvAd.get(getDemandSourceName(jSONObject));
        return bVar != null && IronSourceNetwork.isAdAvailableForInstance(bVar);
    }
    ...
    public void onOWAdClosed() {
        IronLog.ADAPTER_CALLBACK.verbose(getProviderName());
        C6724f fVar = this.mOfferwallListener;
        if (fVar != null) {
    ...
    public void onOfferwallInitFail(String str) {
        IronLog.ADAPTER_CALLBACK.verbose(getProviderName());
        if (this.mOfferwallListener != null) {
            this.mOfferwallListener.mo36255a(false, ErrorBuilder.buildGenericError(str));
        }
    }
    ...
    public void setInternalOfferwallListener(C6724f fVar) {
