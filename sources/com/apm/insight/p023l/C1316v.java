...
public final class C1316v {
    ...
    /* renamed from: a */
    private static final StackTraceElement f1312a = new StackTraceElement("", "", "", 0);
    ...
    public static class C1317a {
        ...
        public C1317a(int i, int i2) {
            this.f1313a = i;
            this.f1314b = i2;
        }

        /* renamed from: a */
        public JSONObject mo12374a() {
            JSONObject jSONObject = new JSONObject();
            try {
                jSONObject.put("start", this.f1313a);
                jSONObject.put("end", this.f1314b);
    ...
    public static java.lang.String m1902a(java.lang.String r8) {
        /*
        ...
        L_0x0053:
            ...
            goto L_0x0031
        L_0x0056:
            com.apm.insight.p023l.C1300k.m1795a((java.io.Closeable) r6)
            goto L_0x005e
        L_0x005a:
            r1 = r6
        L_0x005b:
        ...
        L_0x008a:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.apm.insight.p023l.C1316v.m1902a(java.lang.String):java.lang.String");
    }

    /* renamed from: a */
    public static String m1903a(Throwable th) {
        StringWriter stringWriter = new StringWriter();
        PrintWriter printWriter = new PrintWriter(stringWriter);
        try {
            m1914a(th, printWriter);
    ...
    /* renamed from: a */
    public static String m1904a(Throwable th, Thread thread, PrintStream printStream, C1293e.C1294a aVar) {
        ...
        C1293e eVar = new C1293e(printStream, messageDigest, aVar);
        try {
            m1914a(th, (PrintWriter) eVar);
        } catch (Throwable unused2) {
        }
        eVar.close();
        if (messageDigest != null) {
            return m1905a(messageDigest.digest());
        }
        return null;
    }

    /* renamed from: a */
    private static String m1905a(byte[] bArr) {
        ...
        for (byte b : bArr) {
            ...
            cArr2[i] = cArr[(b >>> 4) & 15];
            i = i2 + 1;
            cArr2[i2] = cArr[b & Ascii.f17944SI];
        }
        return new String(cArr2);
    }

    /* renamed from: a */
    public static String m1906a(StackTraceElement[] stackTraceElementArr) {
    ...
    /* renamed from: a */
    public static StringBuilder m1907a(StackTraceElement stackTraceElement, StringBuilder sb) {
    ...
    /* renamed from: a */
    public static JSONArray m1908a(StackTraceElement[] stackTraceElementArr, String[] strArr) {
        C1317a aVar = new C1317a(-1, -1);
        JSONArray jSONArray = new JSONArray();
        for (int i = 0; i < stackTraceElementArr.length; i++) {
            if (aVar.f1313a == -1) {
                if (m1918a(stackTraceElementArr[i].getClassName(), strArr)) {
                    aVar.f1313a = i;
                    aVar.f1314b = i;
                }
            } else if (!m1918a(stackTraceElementArr[i].getClassName(), strArr)) {
                aVar.f1314b = i;
                jSONArray.put(aVar.mo12374a());
                aVar = new C1317a(-1, -1);
            }
        }
        if (aVar.f1313a != -1) {
            aVar.f1314b = stackTraceElementArr.length;
            jSONArray.put(aVar.mo12374a());
        }
        return jSONArray;
    }
    ...
    /* renamed from: a */
    public static JSONArray m1909a(String[] strArr, String[] strArr2) {
        C1317a aVar = new C1317a(-1, -1);
        JSONArray jSONArray = new JSONArray();
        for (int i = 0; i < strArr.length; i++) {
            if (aVar.f1313a == -1) {
                if (m1918a(strArr[i], strArr2)) {
                    aVar.f1313a = i;
                    aVar.f1314b = i;
                }
            } else if (!m1918a(strArr[i], strArr2)) {
                aVar.f1314b = i;
                jSONArray.put(aVar.mo12374a());
                aVar = new C1317a(-1, -1);
            }
    ...
    /* renamed from: a */
    private static void m1910a(StackTraceElement stackTraceElement, int i) {
        String str;
        String valueOf;
        try {
            m1911a("\tat ", i);
            m1911a(stackTraceElement.getClassName(), i);
            m1911a(".", i);
            m1911a(stackTraceElement.getMethodName(), i);
            if (stackTraceElement.isNativeMethod()) {
                ...
                if (stackTraceElement.getFileName() != null) {
                    if (stackTraceElement.getLineNumber() >= 0) {
                        m1911a("(", i);
                        m1911a(stackTraceElement.getFileName(), i);
                        m1911a(CertificateUtil.DELIMITER, i);
    ...
    /* renamed from: a */
    private static void m1911a(String str, int i) {
        NativeImpl.m1947a(i, str);
    }

    /* renamed from: a */
    public static void m1912a(Throwable th, int i) {
        try {
            m1922c(th, i);
        } catch (Throwable unused) {
        }
    ...
    /* renamed from: a */
    private static void m1913a(Throwable th, int i, String str, String str2) {
        StackTraceElement[] stackTrace = th.getStackTrace();
        try {
            NativeImpl.m1947a(i, str2);
            NativeImpl.m1947a(i, str);
        } catch (Throwable unused) {
        }
        m1920b(th, i);
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            for (Throwable a2 : th.getSuppressed()) {
                m1913a(a2, i, "Suppressed: ", str2 + "\t");
            }
        }
        Throwable cause = th.getCause();
        if (cause != null) {
            m1913a(cause, i, "Caused by: ", str2);
        }
    }

    /* renamed from: a */
    private static void m1914a(Throwable th, PrintWriter printWriter) {
        if (th != null && printWriter != null) {
            ...
            if (Build.VERSION.SDK_INT >= 19) {
                for (Throwable a : th.getSuppressed()) {
                    m1915a(a, printWriter, stackTrace, "Suppressed: ", "\t", (Set<Throwable>) newSetFromMap, 128);
                }
            }
            Throwable cause = th.getCause();
            if (cause != null) {
                m1915a(cause, printWriter, stackTrace, "Caused by: ", "", (Set<Throwable>) newSetFromMap, 128);
            }
        }
    }

    /* renamed from: a */
    private static void m1915a(Throwable th, PrintWriter printWriter, StackTraceElement[] stackTraceElementArr, String str, String str2, Set<Throwable> set, int i) {
        Throwable th2 = th;
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            for (Throwable a : th.getSuppressed()) {
                int i5 = i2 / 2;
                m1915a(a, printWriter, stackTrace, "Suppressed: ", str3 + "\t", set, i5 > 10 ? i5 : 10);
            }
        }
        Throwable cause = th.getCause();
        if (cause != null) {
            int i6 = i2 / 2;
            m1915a(cause, printWriter, stackTrace, "Caused by: ", str2, set, i6 > 10 ? i6 : 10);
        }
    }

    /* renamed from: a */
    private static void m1916a(Throwable th, List<StackTraceElement> list) {
        if (th != null && list != null) {
            ...
            if (Build.VERSION.SDK_INT >= 19) {
                for (Throwable a : th.getSuppressed()) {
                    m1917a(a, list, stackTrace, "Suppressed: ", "\t", (Set<Throwable>) newSetFromMap, 128);
                }
            }
            Throwable cause = th.getCause();
            if (cause != null) {
                m1917a(cause, list, stackTrace, "Caused by: ", "", (Set<Throwable>) newSetFromMap, 128);
            }
        }
    }

    /* renamed from: a */
    private static void m1917a(Throwable th, List<StackTraceElement> list, StackTraceElement[] stackTraceElementArr, String str, String str2, Set<Throwable> set, int i) {
        Throwable th2 = th;
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            for (Throwable a : th.getSuppressed()) {
                int i5 = i2 / 2;
                m1917a(a, list, stackTrace, "Suppressed: ", str2 + "\t", set, i5 > 10 ? i5 : 10);
            }
        }
        Throwable cause = th.getCause();
        if (cause != null) {
            int i6 = i2 / 2;
            m1917a(cause, list, stackTrace, "Caused by: ", str2, set, i6 > 10 ? i6 : 10);
        }
    }

    /* renamed from: a */
    public static boolean m1918a(String str, String[] strArr) {
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static org.json.JSONObject m1919b(java.lang.String r16) {
        /*
            r0 = r16
            java.lang.String r1 = ")"
            java.lang.String r2 = "("
        ...
        L_0x0029:
            ...
            boolean r11 = m1923c((java.lang.String) r10)     // Catch:{ all -> 0x00e0 }
        ...
        L_0x00e0:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.apm.insight.p023l.C1316v.m1919b(java.lang.String):org.json.JSONObject");
    }

    /* renamed from: b */
    private static void m1920b(Throwable th, int i) {
        th.getClass().getName();
        String localizedMessage = th.getLocalizedMessage();
        try {
            m1911a(th.getClass().getName(), i);
            if (localizedMessage != null) {
                m1911a(": ", i);
                m1911a(localizedMessage, i);
            }
            m1911a("\n", i);
        } catch (Throwable unused) {
        }
    ...
    /* renamed from: b */
    public static StackTraceElement[] m1921b(Throwable th) {
        ArrayList arrayList = new ArrayList();
        try {
            m1916a(th, (List<StackTraceElement>) arrayList);
        } catch (Throwable unused) {
        }
    ...
    /* renamed from: c */
    private static void m1922c(Throwable th, int i) {
        if (th != null && i > 0) {
            m1920b(th, i);
            ...
            if (Build.VERSION.SDK_INT >= 19) {
                for (Throwable a2 : th.getSuppressed()) {
                    m1913a(a2, i, "Suppressed: ", "\t");
                }
            }
            Throwable cause = th.getCause();
            if (cause != null) {
                m1913a(cause, i, "Caused by: ", "");
            }
        }
    }

    /* renamed from: c */
    private static boolean m1923c(String str) {
        Set<String> a = C1299j.m1793a();
        if (a.contains(str)) {
            return true;
        }
        for (String next : a) {
    ...
    /* renamed from: c */
    public static boolean m1924c(Throwable th) {
        if (th == null) {
            return false;
        }
        int i = 0;
    ...
    /* renamed from: d */
    public static boolean m1925d(Throwable th) {
        if (th == null) {
            return false;
        }
        int i = 0;
