...
public abstract class RetainedRepositoryAdPresenterListener implements StateMachine.Listener<AdStateMachine.State> {
    ...
    static /* synthetic */ class C111791 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.smaato.sdk.rewarded.repository.RetainedRepositoryAdPresenterListener.C111791.<clinit>():void");
        }
    }

    public void onStateChanged(AdStateMachine.State state, AdStateMachine.State state2, Metadata metadata) {
        switch (C111791.$SwitchMap$com$smaato$sdk$core$ad$AdStateMachine$State[state2.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
