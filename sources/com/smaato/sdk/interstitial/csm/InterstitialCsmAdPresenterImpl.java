...
public final class InterstitialCsmAdPresenterImpl extends BaseAdPresenter implements InterstitialCsmAdPresenter {
    ...
    private final SMAInterstitialNetworkEventListener interstitialNetworkEventListener = new SMAInterstitialNetworkEventListener() {
        public void onAdLoaded() {
            Objects.onNotNull(InterstitialCsmAdPresenterImpl.this.adLoadedListener, new Consumer() {
                public final void accept(Object obj) {
                    InterstitialCsmAdPresenterImpl.C111261.this.lambda$onAdLoaded$0$InterstitialCsmAdPresenterImpl$1((CsmAdPresenter.Listener) obj);
                }
            });
        }
        ...
        public void onAdFailedToLoad() {
            Objects.onNotNull(InterstitialCsmAdPresenterImpl.this.adLoadedListener, new Consumer() {
                public final void accept(Object obj) {
                    InterstitialCsmAdPresenterImpl.C111261.this.lambda$onAdFailedToLoad$1$InterstitialCsmAdPresenterImpl$1((CsmAdPresenter.Listener) obj);
                }
            });
        }
        ...
        public void onAdOpened() {
            ...
            Objects.onNotNull(InterstitialCsmAdPresenterImpl.this.interstitialAdListener, new Consumer() {
                public final void accept(Object obj) {
                    InterstitialCsmAdPresenterImpl.C111261.this.lambda$onAdOpened$2$InterstitialCsmAdPresenterImpl$1((InterstitialCsmAdPresenter.Listener) obj);
                }
            });
        }
        ...
        public void onAdClosed() {
            ...
            Objects.onNotNull(InterstitialCsmAdPresenterImpl.this.interstitialAdListener, new Consumer() {
                public final void accept(Object obj) {
                    InterstitialCsmAdPresenterImpl.C111261.this.lambda$onAdClosed$3$InterstitialCsmAdPresenterImpl$1((InterstitialCsmAdPresenter.Listener) obj);
                }
            });
        }
        ...
        public void onAdTTLExpired() {
            ...
            Objects.onNotNull(InterstitialCsmAdPresenterImpl.this.interstitialAdListener, new Consumer() {
                public final void accept(Object obj) {
                    InterstitialCsmAdPresenterImpl.C111261.this.lambda$onAdTTLExpired$4$InterstitialCsmAdPresenterImpl$1((InterstitialCsmAdPresenter.Listener) obj);
                }
            });
        }
    ...
    public /* synthetic */ void lambda$new$0$InterstitialCsmAdPresenterImpl(InterstitialCsmAdPresenter.Listener listener) {
    ...
    public /* synthetic */ void lambda$new$1$InterstitialCsmAdPresenterImpl(AdInteractor adInteractor2) {
        Objects.onNotNull(this.interstitialAdListener, new Consumer() {
            public final void accept(Object obj) {
                InterstitialCsmAdPresenterImpl.this.lambda$new$0$InterstitialCsmAdPresenterImpl((InterstitialCsmAdPresenter.Listener) obj);
            }
        });
    }
    ...
    static /* synthetic */ class C111272 {
        ...
        static {
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.smaato.sdk.interstitial.csm.InterstitialCsmAdPresenterImpl.C111272.<clinit>():void");
        }
    }
    ...
    public /* synthetic */ void lambda$new$3$InterstitialCsmAdPresenterImpl(CsmAdInteractor csmAdInteractor, Logger logger2, AdStateMachine.State state, AdStateMachine.State state2, Metadata metadata) {
        switch (C111272.$SwitchMap$com$smaato$sdk$core$ad$AdStateMachine$State[state2.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
            ...
            case 6:
                Objects.onNotNull(this.interstitialAdListener, new Consumer() {
                    public final void accept(Object obj) {
                        InterstitialCsmAdPresenterImpl.this.lambda$new$2$InterstitialCsmAdPresenterImpl((InterstitialCsmAdPresenter.Listener) obj);
                    }
                });
                return;
            case 7:
    ...
    public /* synthetic */ void lambda$new$2$InterstitialCsmAdPresenterImpl(InterstitialCsmAdPresenter.Listener listener) {
        listener.onAdClicked(this);
    }

    public /* synthetic */ void lambda$new$4$InterstitialCsmAdPresenterImpl(InterstitialCsmAdPresenter.Listener listener) {
    ...
    public /* synthetic */ void lambda$new$5$InterstitialCsmAdPresenterImpl() {
        Objects.onNotNull(this.interstitialAdListener, new Consumer() {
            public final void accept(Object obj) {
                InterstitialCsmAdPresenterImpl.this.lambda$new$4$InterstitialCsmAdPresenterImpl((InterstitialCsmAdPresenter.Listener) obj);
            }
        });
    }
