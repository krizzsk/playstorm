...
public class ToolTipPopup {
        ...
        if (!CrashShieldHandler.isObjectCrashing(this)) {
            try {
                if (this.mAnchorViewRef.get() != null) {
                    ...
                    ((TextView) popupContentView.findViewById(C4126R.C4128id.com_facebook_tooltip_bubble_view_text_body)).setText(this.mText);
                    if (this.mStyle == Style.BLUE) {
                        this.mPopupContent.bodyFrame.setBackgroundResource(C4126R.C4127drawable.com_facebook_tooltip_blue_background);
                        this.mPopupContent.bottomArrow.setImageResource(C4126R.C4127drawable.com_facebook_tooltip_blue_bottomnub);
                        this.mPopupContent.topArrow.setImageResource(C4126R.C4127drawable.com_facebook_tooltip_blue_topnub);
                        this.mPopupContent.xOut.setImageResource(C4126R.C4127drawable.com_facebook_tooltip_blue_xout);
                    } else {
                        this.mPopupContent.bodyFrame.setBackgroundResource(C4126R.C4127drawable.com_facebook_tooltip_black_background);
                        this.mPopupContent.bottomArrow.setImageResource(C4126R.C4127drawable.com_facebook_tooltip_black_bottomnub);
                        this.mPopupContent.topArrow.setImageResource(C4126R.C4127drawable.com_facebook_tooltip_black_topnub);
                        this.mPopupContent.xOut.setImageResource(C4126R.C4127drawable.com_facebook_tooltip_black_xout);
                    }
    ...
    private class PopupContentView extends FrameLayout {
        ...
        private void init() {
            LayoutInflater.from(getContext()).inflate(C4126R.layout.com_facebook_tooltip_bubble, this);
            this.topArrow = (ImageView) findViewById(C4126R.C4128id.com_facebook_tooltip_bubble_view_top_pointer);
            this.bottomArrow = (ImageView) findViewById(C4126R.C4128id.com_facebook_tooltip_bubble_view_bottom_pointer);
            this.bodyFrame = findViewById(C4126R.C4128id.com_facebook_body_frame);
            this.xOut = (ImageView) findViewById(C4126R.C4128id.com_facebook_button_xout);
        }
