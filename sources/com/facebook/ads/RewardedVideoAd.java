...
public class RewardedVideoAd implements FullScreenAd {
    ...
    public interface RewardedVideoAdLoadConfigBuilder extends C4033Ad.LoadConfigBuilder {
    ...
    public interface RewardedVideoLoadAdConfig extends C4033Ad.LoadAdConfig {
    }
