...
public class InterstitialAd implements FullScreenAd {
    ...
    public interface InterstitialAdLoadConfigBuilder extends C4033Ad.LoadConfigBuilder {
    ...
    public interface InterstitialLoadAdConfig extends C4033Ad.LoadAdConfig {
    }
