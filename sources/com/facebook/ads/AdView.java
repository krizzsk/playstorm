...
public class AdView extends RelativeLayout implements C4033Ad {
    ...
    public interface AdViewLoadConfig extends C4033Ad.LoadAdConfig {
    }

    public interface AdViewLoadConfigBuilder extends C4033Ad.LoadConfigBuilder {
