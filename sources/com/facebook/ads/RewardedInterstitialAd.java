...
public class RewardedInterstitialAd implements FullScreenAd {
    ...
    public interface RewardedInterstitialAdLoadConfigBuilder extends C4033Ad.LoadConfigBuilder {
    ...
    public interface RewardedInterstitialLoadAdConfig extends C4033Ad.LoadAdConfig {
    }
