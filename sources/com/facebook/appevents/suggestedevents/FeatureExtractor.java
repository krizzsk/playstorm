...
public final class FeatureExtractor {
    ...
    public static final void initialize(File file) {
        ...
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                ...
                try {
                    languageInfo = MapsKt.mapOf(TuplesKt.m34639to(ViewHierarchyConstants.ENGLISH, "1"), TuplesKt.m34639to(ViewHierarchyConstants.GERMAN, "2"), TuplesKt.m34639to(ViewHierarchyConstants.SPANISH, "3"), TuplesKt.m34639to(ViewHierarchyConstants.JAPANESE, MBridgeConstans.DYNAMIC_VIEW_TYPE_ALTER_NATIVE_STR_4));
                    eventInfo = MapsKt.mapOf(TuplesKt.m34639to(ViewHierarchyConstants.VIEW_CONTENT, "0"), TuplesKt.m34639to(ViewHierarchyConstants.SEARCH, "1"), TuplesKt.m34639to(ViewHierarchyConstants.ADD_TO_CART, "2"), TuplesKt.m34639to(ViewHierarchyConstants.ADD_TO_WISHLIST, "3"), TuplesKt.m34639to(ViewHierarchyConstants.INITIATE_CHECKOUT, MBridgeConstans.DYNAMIC_VIEW_TYPE_ALTER_NATIVE_STR_4), TuplesKt.m34639to(ViewHierarchyConstants.ADD_PAYMENT_INFO, "5"), TuplesKt.m34639to(ViewHierarchyConstants.PURCHASE, "6"), TuplesKt.m34639to(ViewHierarchyConstants.LEAD, "7"), TuplesKt.m34639to(ViewHierarchyConstants.COMPLETE_REGISTRATION, "8"));
                    textTypeInfo = MapsKt.mapOf(TuplesKt.m34639to(ViewHierarchyConstants.BUTTON_TEXT, "1"), TuplesKt.m34639to(ViewHierarchyConstants.PAGE_TITLE, "2"), TuplesKt.m34639to(ViewHierarchyConstants.RESOLVED_DOCUMENT_LINK, "3"), TuplesKt.m34639to(ViewHierarchyConstants.BUTTON_ID, MBridgeConstans.DYNAMIC_VIEW_TYPE_ALTER_NATIVE_STR_4));
                    initialized = true;
                } catch (Throwable th) {
                    CrashShieldHandler.handleThrowable(th, cls);
                }
    ...
    private final float[] nonparseFeatures(JSONObject jSONObject, JSONArray jSONArray, String str, String str2, String str3) {
        ...
        try {
            ...
            fArr[18] = StringsKt.contains$default((CharSequence) str4, (CharSequence) REGEX_CR_PASSWORD_FIELD, false, 2, (Object) null) ? 1.0f : 0.0f;
