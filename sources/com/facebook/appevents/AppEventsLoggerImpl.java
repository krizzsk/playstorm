...
public final class AppEventsLoggerImpl {
    ...
    public static final class Companion {
                ...
                if (access$getBackgroundExecutor$cp != null) {
                    access$getBackgroundExecutor$cp.execute(new Runnable(context, appEventsLoggerImpl) {
                        ...
                        public final void run() {
                            AppEventsLoggerImpl.Companion.m34857initializeLib$lambda4(this.f$0, this.f$1);
                        }
                    });
                    return;
                }
        ...
        public static final void m34857initializeLib$lambda4(Context context, AppEventsLoggerImpl appEventsLoggerImpl) {
            Intrinsics.checkNotNullParameter(context, "$context");
        ...
        public final String getInstallReferrer() {
            ...
            FacebookSdk facebookSdk = FacebookSdk.INSTANCE;
            return FacebookSdk.getApplicationContext().getSharedPreferences("com.facebook.sdk.appEventPreferences", 0).getString(com.adjust.sdk.Constants.INSTALL_REFERRER, (String) null);
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:10:0x001b, code lost:
            r3 = com.facebook.appevents.C4049xd20d8340.INSTANCE;
        ...
        public final void initializeTimersIfNeeded() {
            /*
                ...
                monitor-enter(r0)
                java.util.concurrent.ScheduledThreadPoolExecutor r1 = com.facebook.appevents.AppEventsLoggerImpl.access$getBackgroundExecutor$cp()     // Catch:{ all -> 0x003c }
                if (r1 == 0) goto L_0x000d
                monitor-exit(r0)
                return
            L_0x000d:
                com.facebook.appevents.AppEventsLoggerImpl$Companion r1 = com.facebook.appevents.AppEventsLoggerImpl.Companion     // Catch:{ all -> 0x003c }
                java.util.concurrent.ScheduledThreadPoolExecutor r1 = new java.util.concurrent.ScheduledThreadPoolExecutor     // Catch:{ all -> 0x003c }
                r2 = 1
                r1.<init>(r2)     // Catch:{ all -> 0x003c }
                com.facebook.appevents.AppEventsLoggerImpl.access$setBackgroundExecutor$cp(r1)     // Catch:{ all -> 0x003c }
                kotlin.Unit r1 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x003c }
                monitor-exit(r0)
                com.facebook.appevents.-$$Lambda$AppEventsLoggerImpl$Companion$BVyOVuKsF-eL5r9hStsFJI8nP-s r3 = com.facebook.appevents.C4049xd20d8340.INSTANCE
        ...
        public static final void m34858initializeTimersIfNeeded$lambda6() {
