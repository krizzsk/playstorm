...
public final class ViewHierarchy {
    ...
    public final boolean isRCTButton(View view, View view2) {
        ...
        try {
            ...
            if (!Intrinsics.areEqual((Object) name, (Object) CLASS_RCTVIEWGROUP) || (touchReactView = getTouchReactView(getViewLocationOnScreen(view), view2)) == null || touchReactView.getId() != view.getId()) {
                return false;
            }
            return true;
        } catch (Throwable th) {
