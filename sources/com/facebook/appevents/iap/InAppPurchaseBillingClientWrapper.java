...
public final class InAppPurchaseBillingClientWrapper {
            ...
            try {
                ...
                queryPurchaseHistoryAsync(str, new Runnable(runnable) {
                    ...
                    public final void run() {
                        InAppPurchaseBillingClientWrapper.m34893queryPurchaseHistory$lambda0(InAppPurchaseBillingClientWrapper.this, this.f$1);
                    }
                });
            } catch (Throwable th) {
    ...
    public static final void m34893queryPurchaseHistory$lambda0(InAppPurchaseBillingClientWrapper inAppPurchaseBillingClientWrapper, Runnable runnable) {
        Class<InAppPurchaseBillingClientWrapper> cls = InAppPurchaseBillingClientWrapper.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
    ...
    public static final class BillingClientStateListenerWrapper implements InvocationHandler {
        public Object invoke(Object obj, Method method, Object[] objArr) {
            ...
            try {
                ...
                Intrinsics.checkNotNullParameter(method, InneractiveMediationDefs.GENDER_MALE);
