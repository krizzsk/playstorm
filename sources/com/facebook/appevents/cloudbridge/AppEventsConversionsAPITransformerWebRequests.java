...
public final class AppEventsConversionsAPITransformerWebRequests {
    ...
    private static final HashSet<Integer> RETRY_EVENTS_HTTP_RESPONSE = SetsKt.hashSetOf(503, Integer.valueOf(C12379c.COLLECT_MODE_TIKTOK_GUEST), 429);
    ...
    public static final void transformGraphRequestAndSendToCAPIGEndPoint(GraphRequest graphRequest) {
        ...
        Utility.runOnNonUiThread(new Runnable() {
            public final void run() {
                AppEventsConversionsAPITransformerWebRequests.m34875transformGraphRequestAndSendToCAPIGEndPoint$lambda0(GraphRequest.this);
            }
        });
    }
    ...
    public static final void m34875transformGraphRequestAndSendToCAPIGEndPoint$lambda0(GraphRequest graphRequest) {
        Intrinsics.checkNotNullParameter(graphRequest, "$request");
        ...
        try {
            ...
            if (transformAppEventRequestForCAPIG != null) {
                ...
                List<T> slice = CollectionsKt.slice(INSTANCE.getTransformedEvents$facebook_core_release(), new IntRange(0, min - 1));
                ...
                INSTANCE.makeHttpRequest$facebook_core_release(str, ShareTarget.METHOD_POST, jSONObject.toString(), MapsKt.mapOf(TuplesKt.m34639to("Content-Type", "application/json")), 60000, new C4053xf719cce4(slice));
            }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:38:?, code lost:
        kotlin.p396io.CloseableKt.closeFinally(r10, r8);
     */
    ...
    public final void makeHttpRequest$facebook_core_release(java.lang.String r8, java.lang.String r9, java.lang.String r10, java.util.Map<java.lang.String, java.lang.String> r11, int r12, kotlin.jvm.functions.Function2<? super java.lang.String, ? super java.lang.Integer, kotlin.Unit> r13) {
        ...
        L_0x0063:
            ...
            r12 = r10
            java.io.BufferedReader r12 = (java.io.BufferedReader) r12     // Catch:{ all -> 0x00c9 }
        L_0x00b9:
            java.lang.String r0 = r12.readLine()     // Catch:{ all -> 0x00c9 }
            if (r0 == 0) goto L_0x00c3
            r9.append(r0)     // Catch:{ all -> 0x00c9 }
            goto L_0x00b9
        L_0x00c3:
            kotlin.Unit r12 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00c9 }
            kotlin.p396io.CloseableKt.closeFinally(r10, r11)     // Catch:{ UnknownHostException -> 0x011a, IOException -> 0x0107 }
            goto L_0x00d0
        L_0x00c9:
            r8 = move-exception
        ...
        L_0x00cb:
            r9 = move-exception
            kotlin.p396io.CloseableKt.closeFinally(r10, r8)     // Catch:{ UnknownHostException -> 0x011a, IOException -> 0x0107 }
