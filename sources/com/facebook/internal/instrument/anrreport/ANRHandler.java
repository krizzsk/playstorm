...
@Metadata(mo75041d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\bÇ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\b\u0010\u0007\u001a\u00020\bH\u0007J\b\u0010\t\u001a\u00020\bH\u0007R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u0004¢\u0006\u0002\n\u0000¨\u0006\n"}, mo75042d2 = {"Lcom/facebook/internal/instrument/anrreport/ANRHandler;", "", "()V", "MAX_ANR_REPORT_NUM", "", "enabled", "Ljava/util/concurrent/atomic/AtomicBoolean;", "enable", "", "sendANRReports", "facebook-core_release"}, mo75043k = 1, mo75044mv = {1, 5, 1}, mo75046xi = 48)
...
public final class ANRHandler {
        ...
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
                ...
                if (!Utility.isDataProcessingRestricted()) {
                    ...
                    List sortedWith = CollectionsKt.sortedWith((List) arrayList2, $$Lambda$ANRHandler$32rOoGQOVWzJ05Z7eDHv0iZy0M.INSTANCE);
                    ...
                    InstrumentUtility.sendReports("anr_reports", jSONArray, new GraphRequest.Callback(sortedWith) {
                        ...
                        public final void onCompleted(GraphResponse graphResponse) {
                            ANRHandler.m34980sendANRReports$lambda5(this.f$0, graphResponse);
                        }
                    });
                }
            } catch (Throwable th) {
    ...
    public static final int m34979sendANRReports$lambda2(InstrumentData instrumentData, InstrumentData instrumentData2) {
        Class<ANRHandler> cls = ANRHandler.class;
        if (CrashShieldHandler.isObjectCrashing(cls)) {
            return 0;
        }
    ...
    public static final void m34980sendANRReports$lambda5(List list, GraphResponse graphResponse) {
        Class<ANRHandler> cls = ANRHandler.class;
        if (!CrashShieldHandler.isObjectCrashing(cls)) {
            try {
