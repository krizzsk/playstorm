...
public final class FacebookSdk {
    ...
    @Metadata(mo75041d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\bá\u0001\u0018\u00002\u00020\u0001J0\u0010\u0002\u001a\u00020\u00032\b\u0010\u0004\u001a\u0004\u0018\u00010\u00052\b\u0010\u0006\u001a\u0004\u0018\u00010\u00072\b\u0010\b\u001a\u0004\u0018\u00010\t2\b\u0010\n\u001a\u0004\u0018\u00010\u000bH&¨\u0006\f"}, mo75042d2 = {"Lcom/facebook/FacebookSdk$GraphRequestCreator;", "", "createPostRequest", "Lcom/facebook/GraphRequest;", "accessToken", "Lcom/facebook/AccessToken;", "publishUrl", "", "publishParams", "Lorg/json/JSONObject;", "callback", "Lcom/facebook/GraphRequest$Callback;", "facebook-core_release"}, mo75043k = 1, mo75044mv = {1, 5, 1}, mo75046xi = 48)
    /* compiled from: FacebookSdk.kt */
    ...
    @Metadata(mo75041d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\bæ\u0001\u0018\u00002\u00020\u0001J\b\u0010\u0002\u001a\u00020\u0003H&¨\u0006\u0004"}, mo75042d2 = {"Lcom/facebook/FacebookSdk$InitializeCallback;", "", "onInitialized", "", "facebook-core_release"}, mo75043k = 1, mo75044mv = {1, 5, 1}, mo75046xi = 48)
    /* compiled from: FacebookSdk.kt */
    ...
    public static final GraphRequest m34826graphRequestCreator$lambda0(AccessToken accessToken, String str, JSONObject jSONObject, GraphRequest.Callback callback) {
    ...
    public static final synchronized void sdkInitialize(android.content.Context r4, com.facebook.FacebookSdk.InitializeCallback r5) {
        /*
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r4, r1)     // Catch:{ all -> 0x010f }
            java.util.concurrent.atomic.AtomicBoolean r1 = sdkInitialized     // Catch:{ all -> 0x010f }
            boolean r1 = r1.get()     // Catch:{ all -> 0x010f }
            if (r1 == 0) goto L_0x0018
            if (r5 != 0) goto L_0x0013
            goto L_0x0016
        L_0x0013:
            r5.onInitialized()     // Catch:{ all -> 0x010f }
        L_0x0016:
            monitor-exit(r0)
            return
        L_0x0018:
            com.facebook.internal.Validate r1 = com.facebook.internal.Validate.INSTANCE     // Catch:{ all -> 0x010f }
            r1 = 0
            com.facebook.internal.Validate.hasFacebookActivity(r4, r1)     // Catch:{ all -> 0x010f }
            com.facebook.internal.Validate r2 = com.facebook.internal.Validate.INSTANCE     // Catch:{ all -> 0x010f }
            com.facebook.internal.Validate.hasInternetPermissions(r4, r1)     // Catch:{ all -> 0x010f }
            android.content.Context r2 = r4.getApplicationContext()     // Catch:{ all -> 0x010f }
            java.lang.String r3 = "applicationContext.applicationContext"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r3)     // Catch:{ all -> 0x010f }
            applicationContext = r2     // Catch:{ all -> 0x010f }
            com.facebook.appevents.AppEventsLogger$Companion r2 = com.facebook.appevents.AppEventsLogger.Companion     // Catch:{ all -> 0x010f }
            r2.getAnonymousAppDeviceGUID(r4)     // Catch:{ all -> 0x010f }
            android.content.Context r4 = applicationContext     // Catch:{ all -> 0x010f }
            r2 = 0
            if (r4 == 0) goto L_0x0109
            loadDefaultsFromMetadata$facebook_core_release(r4)     // Catch:{ all -> 0x010f }
            java.lang.String r4 = applicationId     // Catch:{ all -> 0x010f }
            java.lang.CharSequence r4 = (java.lang.CharSequence) r4     // Catch:{ all -> 0x010f }
            r3 = 1
            if (r4 == 0) goto L_0x004b
            int r4 = r4.length()     // Catch:{ all -> 0x010f }
        ...
        L_0x004c:
            ...
            java.lang.String r4 = appClientToken     // Catch:{ all -> 0x010f }
            java.lang.CharSequence r4 = (java.lang.CharSequence) r4     // Catch:{ all -> 0x010f }
        ...
        L_0x005b:
            ...
            java.util.concurrent.atomic.AtomicBoolean r4 = sdkInitialized     // Catch:{ all -> 0x010f }
            r4.set(r3)     // Catch:{ all -> 0x010f }
            boolean r4 = getAutoInitEnabled()     // Catch:{ all -> 0x010f }
            if (r4 == 0) goto L_0x006b
            fullyInitialize()     // Catch:{ all -> 0x010f }
        L_0x006b:
            android.content.Context r4 = applicationContext     // Catch:{ all -> 0x010f }
            if (r4 == 0) goto L_0x00f3
            boolean r4 = r4 instanceof android.app.Application     // Catch:{ all -> 0x010f }
            if (r4 == 0) goto L_0x008f
            com.facebook.UserSettingsManager r4 = com.facebook.UserSettingsManager.INSTANCE     // Catch:{ all -> 0x010f }
            boolean r4 = com.facebook.UserSettingsManager.getAutoLogAppEventsEnabled()     // Catch:{ all -> 0x010f }
            if (r4 == 0) goto L_0x008f
            com.facebook.appevents.internal.ActivityLifecycleTracker r4 = com.facebook.appevents.internal.ActivityLifecycleTracker.INSTANCE     // Catch:{ all -> 0x010f }
            android.content.Context r4 = applicationContext     // Catch:{ all -> 0x010f }
            if (r4 == 0) goto L_0x0089
            android.app.Application r4 = (android.app.Application) r4     // Catch:{ all -> 0x010f }
            java.lang.String r1 = applicationId     // Catch:{ all -> 0x010f }
            com.facebook.appevents.internal.ActivityLifecycleTracker.startTracking(r4, r1)     // Catch:{ all -> 0x010f }
            goto L_0x008f
        L_0x0089:
            java.lang.String r4 = "applicationContext"
            kotlin.jvm.internal.Intrinsics.throwUninitializedPropertyAccessException(r4)     // Catch:{ all -> 0x010f }
            throw r2     // Catch:{ all -> 0x010f }
        L_0x008f:
            com.facebook.internal.FetchedAppSettingsManager r4 = com.facebook.internal.FetchedAppSettingsManager.INSTANCE     // Catch:{ all -> 0x010f }
            com.facebook.internal.FetchedAppSettingsManager.loadAppSettingsAsync()     // Catch:{ all -> 0x010f }
            com.facebook.internal.NativeProtocol r4 = com.facebook.internal.NativeProtocol.INSTANCE     // Catch:{ all -> 0x010f }
            com.facebook.internal.NativeProtocol.updateAllAvailableProtocolVersionsAsync()     // Catch:{ all -> 0x010f }
            com.facebook.internal.BoltsMeasurementEventListener$Companion r4 = com.facebook.internal.BoltsMeasurementEventListener.Companion     // Catch:{ all -> 0x010f }
            android.content.Context r1 = applicationContext     // Catch:{ all -> 0x010f }
            if (r1 == 0) goto L_0x00ed
            r4.getInstance(r1)     // Catch:{ all -> 0x010f }
            com.facebook.internal.LockOnGetVariable r4 = new com.facebook.internal.LockOnGetVariable     // Catch:{ all -> 0x010f }
            com.facebook.-$$Lambda$FacebookSdk$J0805Clgxed1K59G9leFVPRGzM4 r1 = com.facebook.$$Lambda$FacebookSdk$J0805Clgxed1K59G9leFVPRGzM4.INSTANCE     // Catch:{ all -> 0x010f }
            r4.<init>(r1)     // Catch:{ all -> 0x010f }
            cacheDir = r4     // Catch:{ all -> 0x010f }
            com.facebook.internal.FeatureManager r4 = com.facebook.internal.FeatureManager.INSTANCE     // Catch:{ all -> 0x010f }
            com.facebook.internal.FeatureManager$Feature r4 = com.facebook.internal.FeatureManager.Feature.Instrument     // Catch:{ all -> 0x010f }
            com.facebook.-$$Lambda$FacebookSdk$fGv4uIuB4ckkxwOf8O4RgtXZub4 r1 = com.facebook.$$Lambda$FacebookSdk$fGv4uIuB4ckkxwOf8O4RgtXZub4.INSTANCE     // Catch:{ all -> 0x010f }
            com.facebook.internal.FeatureManager.checkFeature(r4, r1)     // Catch:{ all -> 0x010f }
            com.facebook.internal.FeatureManager r4 = com.facebook.internal.FeatureManager.INSTANCE     // Catch:{ all -> 0x010f }
            com.facebook.internal.FeatureManager$Feature r4 = com.facebook.internal.FeatureManager.Feature.AppEvents     // Catch:{ all -> 0x010f }
            com.facebook.-$$Lambda$FacebookSdk$8Xi3kKcv5EqcfpghgczttKFq8YE r1 = com.facebook.$$Lambda$FacebookSdk$8Xi3kKcv5EqcfpghgczttKFq8YE.INSTANCE     // Catch:{ all -> 0x010f }
            com.facebook.internal.FeatureManager.checkFeature(r4, r1)     // Catch:{ all -> 0x010f }
            com.facebook.internal.FeatureManager r4 = com.facebook.internal.FeatureManager.INSTANCE     // Catch:{ all -> 0x010f }
            com.facebook.internal.FeatureManager$Feature r4 = com.facebook.internal.FeatureManager.Feature.ChromeCustomTabsPrefetching     // Catch:{ all -> 0x010f }
            com.facebook.-$$Lambda$FacebookSdk$PFMuGw4-GX6YxoewlCboSNJ46iw r1 = com.facebook.$$Lambda$FacebookSdk$PFMuGw4GX6YxoewlCboSNJ46iw.INSTANCE     // Catch:{ all -> 0x010f }
            com.facebook.internal.FeatureManager.checkFeature(r4, r1)     // Catch:{ all -> 0x010f }
            com.facebook.internal.FeatureManager r4 = com.facebook.internal.FeatureManager.INSTANCE     // Catch:{ all -> 0x010f }
            com.facebook.internal.FeatureManager$Feature r4 = com.facebook.internal.FeatureManager.Feature.IgnoreAppSwitchToLoggedOut     // Catch:{ all -> 0x010f }
            com.facebook.-$$Lambda$FacebookSdk$xnPiGMIrZY-efkOoczDJVIjnueQ r1 = com.facebook.$$Lambda$FacebookSdk$xnPiGMIrZYefkOoczDJVIjnueQ.INSTANCE     // Catch:{ all -> 0x010f }
            com.facebook.internal.FeatureManager.checkFeature(r4, r1)     // Catch:{ all -> 0x010f }
            com.facebook.internal.FeatureManager r4 = com.facebook.internal.FeatureManager.INSTANCE     // Catch:{ all -> 0x010f }
            com.facebook.internal.FeatureManager$Feature r4 = com.facebook.internal.FeatureManager.Feature.BypassAppSwitch     // Catch:{ all -> 0x010f }
            com.facebook.-$$Lambda$FacebookSdk$4yZ8An2h0IO8z381mtb9us73H-E r1 = com.facebook.$$Lambda$FacebookSdk$4yZ8An2h0IO8z381mtb9us73HE.INSTANCE     // Catch:{ all -> 0x010f }
            com.facebook.internal.FeatureManager.checkFeature(r4, r1)     // Catch:{ all -> 0x010f }
            java.util.concurrent.FutureTask r4 = new java.util.concurrent.FutureTask     // Catch:{ all -> 0x010f }
            com.facebook.-$$Lambda$FacebookSdk$0kbXjfnH1rWqSbnFNjnUSyk2drw r1 = new com.facebook.-$$Lambda$FacebookSdk$0kbXjfnH1rWqSbnFNjnUSyk2drw     // Catch:{ all -> 0x010f }
            r1.<init>()     // Catch:{ all -> 0x010f }
            r4.<init>(r1)     // Catch:{ all -> 0x010f }
            java.util.concurrent.Executor r5 = getExecutor()     // Catch:{ all -> 0x010f }
            java.lang.Runnable r4 = (java.lang.Runnable) r4     // Catch:{ all -> 0x010f }
            r5.execute(r4)     // Catch:{ all -> 0x010f }
            monitor-exit(r0)
            return
        L_0x00ed:
            java.lang.String r4 = "applicationContext"
        ...
        L_0x00f3:
            ...
            throw r2     // Catch:{ all -> 0x010f }
        L_0x00f9:
            com.facebook.FacebookException r4 = new com.facebook.FacebookException     // Catch:{ all -> 0x010f }
            ...
            r4.<init>((java.lang.String) r5)     // Catch:{ all -> 0x010f }
    ...
    public static final File m34831sdkInitialize$lambda3() {
    ...
    public static final void m34832sdkInitialize$lambda4(boolean z) {
        if (z) {
    ...
    public static final void m34833sdkInitialize$lambda5(boolean z) {
        if (z) {
    ...
    public static final void m34834sdkInitialize$lambda6(boolean z) {
        if (z) {
    ...
    public static final void m34835sdkInitialize$lambda7(boolean z) {
        if (z) {
    ...
    public static final void m34836sdkInitialize$lambda8(boolean z) {
        if (z) {
    ...
    public static final Void m34837sdkInitialize$lambda9(InitializeCallback initializeCallback) {
            ...
            try {
                ...
                getExecutor().execute(new Runnable(context.getApplicationContext(), str) {
                    ...
                    public final void run() {
                        FacebookSdk.m34830publishInstallAsync$lambda15(this.f$0, this.f$1);
                    }
                });
    ...
    public static final void m34830publishInstallAsync$lambda15(Context context, String str) {
        Intrinsics.checkNotNullParameter(str, "$applicationId");
