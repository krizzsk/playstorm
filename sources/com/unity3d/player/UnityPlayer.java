...
import com.unity3d.player.C11931l;
import com.unity3d.player.C11941q;
import java.io.UnsupportedEncodingException;
import java.util.concurrent.ConcurrentLinkedQueue;
import java.util.concurrent.Semaphore;
import java.util.concurrent.TimeUnit;

public class UnityPlayer extends FrameLayout implements IUnityPlayerLifecycleEvents, C11921f {
    ...
    C11926k mSoftInputDialog;
    private C11935n mState;
    /* access modifiers changed from: private */
    public C11941q mVideoPlayerProxy;
    ...
    private C11900a m_FakeListener;
    private HFPStatus m_HFPStatus;
    C11904e m_MainThread;
    private NetworkConnectivity m_NetworkConnectivity;
    private C11902c m_PhoneCallListener;
    /* access modifiers changed from: private */
    public C11931l m_SplashScreen;
    ...
    class C11900a implements SensorEventListener {
        C11900a() {
        }
    ...
    enum C11901b {
        ...
        static {
            f29124d = new int[]{1, 2, 3};
        }
    }

    /* renamed from: com.unity3d.player.UnityPlayer$c */
    private class C11902c extends PhoneStateListener {
        private C11902c() {
        }

        /* synthetic */ C11902c(UnityPlayer unityPlayer, byte b) {
            this();
        }
    ...
    private class C11904e extends Thread {
        ...
        private C11904e() {
            this.f29138b = false;
            this.f29139c = false;
            this.f29140d = C11901b.f29122b;
            this.f29141e = 0;
            this.f29144h = 5;
        }

        /* synthetic */ C11904e(UnityPlayer unityPlayer, byte b) {
            this();
        }

        /* renamed from: a */
        private void m34480a(C11903d dVar) {
            Handler handler = this.f29137a;
            if (handler != null) {
        ...
        /* renamed from: a */
        public final void mo72990a() {
            m34480a(C11903d.QUIT);
        }

        /* renamed from: a */
        public final void mo72991a(int i, int i2) {
            this.f29142f = i;
            this.f29143g = i2;
            m34480a(C11903d.ORIENTATION_ANGLE_CHANGE);
        }

        /* renamed from: a */
        public final void mo72992a(Runnable runnable) {
            if (this.f29137a != null) {
                m34480a(C11903d.PAUSE);
                Message.obtain(this.f29137a, runnable).sendToTarget();
            }
        }

        /* renamed from: b */
        public final void mo72993b() {
            m34480a(C11903d.RESUME);
        }

        /* renamed from: b */
        public final void mo72994b(Runnable runnable) {
            if (this.f29137a != null) {
                m34480a(C11903d.SURFACE_LOST);
                Message.obtain(this.f29137a, runnable).sendToTarget();
            }
        }

        /* renamed from: c */
        public final void mo72995c() {
            m34480a(C11903d.FOCUS_GAINED);
        }

        /* renamed from: c */
        public final void mo72996c(Runnable runnable) {
            Handler handler = this.f29137a;
            if (handler != null) {
                Message.obtain(handler, runnable).sendToTarget();
                m34480a(C11903d.SURFACE_ACQUIRED);
            }
        }

        /* renamed from: d */
        public final void mo72997d() {
            m34480a(C11903d.FOCUS_LOST);
        }

        /* renamed from: d */
        public final void mo72998d(Runnable runnable) {
            Handler handler = this.f29137a;
            if (handler != null) {
                Message.obtain(handler, runnable).sendToTarget();
            }
        ...
        /* renamed from: e */
        public final void mo72999e() {
            m34480a(C11903d.URL_ACTIVATED);
        }

        public final void run() {
            setName("UnityMain");
            Looper.prepare();
            this.f29137a = new Handler(new Handler.Callback() {
                /* renamed from: a */
                private void m34491a() {
                    if (C11904e.this.f29140d == C11901b.f29123c && C11904e.this.f29139c) {
                        UnityPlayer.this.nativeFocusChanged(true);
                        C11904e.this.f29140d = C11901b.f29121a;
                    }
                }
                ...
                public final boolean handleMessage(Message message) {
                    ...
                    C11903d dVar = (C11903d) message.obj;
                    if (dVar == C11903d.NEXT_FRAME) {
                        C11904e.this.f29141e--;
                        UnityPlayer.this.executeGLThreadJobs();
                        if (!C11904e.this.f29138b || !C11904e.this.f29139c) {
                            return true;
                        }
                        if (C11904e.this.f29144h >= 0) {
                            if (C11904e.this.f29144h == 0 && UnityPlayer.this.getSplashEnabled()) {
                                UnityPlayer.this.DisableStaticSplashScreen();
                            }
                            C11904e.this.f29144h--;
                        }
                        if (!UnityPlayer.this.isFinishing() && !UnityPlayer.this.nativeRender()) {
                            UnityPlayer.this.finish();
                        }
                    } else if (dVar == C11903d.QUIT) {
                        Looper.myLooper().quit();
                    } else if (dVar == C11903d.RESUME) {
                        C11904e.this.f29138b = true;
                    } else if (dVar == C11903d.PAUSE) {
                        C11904e.this.f29138b = false;
                    } else if (dVar == C11903d.SURFACE_LOST) {
                        C11904e.this.f29139c = false;
                    } else {
                        if (dVar == C11903d.SURFACE_ACQUIRED) {
                            C11904e.this.f29139c = true;
                        } else if (dVar == C11903d.FOCUS_LOST) {
                            if (C11904e.this.f29140d == C11901b.f29121a) {
                                UnityPlayer.this.nativeFocusChanged(false);
                            }
                            C11904e.this.f29140d = C11901b.f29122b;
                        } else if (dVar == C11903d.FOCUS_GAINED) {
                            C11904e.this.f29140d = C11901b.f29123c;
                        } else if (dVar == C11903d.URL_ACTIVATED) {
                            UnityPlayer.this.nativeSetLaunchURL(UnityPlayer.this.getLaunchURL());
                        } else if (dVar == C11903d.ORIENTATION_ANGLE_CHANGE) {
                            UnityPlayer.this.nativeOrientationChanged(C11904e.this.f29142f, C11904e.this.f29143g);
                        }
                        m34491a();
                    }
                    if (C11904e.this.f29138b && C11904e.this.f29141e <= 0) {
                        Message.obtain(C11904e.this.f29137a, UnityPlayer.RUN_STATE_CHANGED_MSG_CODE, C11903d.NEXT_FRAME).sendToTarget();
                        C11904e.this.f29141e++;
                    }
                    return true;
                }
    ...
    private abstract class C11906f implements Runnable {
        private C11906f() {
        }

        /* synthetic */ C11906f(UnityPlayer unityPlayer, byte b) {
            this();
        }

        /* renamed from: a */
        public abstract void mo72962a();
    ...
    public UnityPlayer(Context context, IUnityPlayerLifecycleEvents iUnityPlayerLifecycleEvents) {
        ...
        this.mState = new C11935n();
        this.m_Events = new ConcurrentLinkedQueue();
        this.mKillingIsMyBusiness = null;
        this.mOrientationListener = null;
        this.m_MainThread = new C11904e(this, (byte) 0);
        this.m_AddPhoneCallListener = false;
        this.m_PhoneCallListener = new C11902c(this, (byte) 0);
        this.m_ARCoreApi = null;
        this.m_FakeListener = new C11900a();
        ...
        if (currentActivity != null && getSplashEnabled()) {
            C11931l lVar = new C11931l(this.mContext, C11931l.C11933a.m34556a()[getSplashMode()]);
            this.m_SplashScreen = lVar;
            addView(lVar);
        }
        String loadNative = loadNative(this.mContext.getApplicationInfo());
        if (!C11935n.m34560c()) {
            C11922g.Log(6, "Your hardware does not support this application.");
    ...
    public void DisableStaticSplashScreen() {
        runOnUiThread(new Runnable() {
            public final void run() {
                ...
                C11931l unused = UnityPlayer.this.m_SplashScreen = null;
            }
        });
    }
    ...
    public static void UnitySendMessage(String str, String str2, String str3) {
        if (!C11935n.m34560c()) {
            C11922g.Log(5, "Native libraries not loaded - dropping message for " + str + "." + str2);
            return;
        }
        try {
    ...
    private void checkResumePlayer() {
        if (this.mState.mo73075f()) {
            this.mState.mo73072d(true);
            queueGLThreadEvent((Runnable) new Runnable() {
                public final void run() {
                    UnityPlayer.this.nativeResume();
                }
            });
            this.m_MainThread.mo72993b();
        }
    }
    ...
    private static String loadNative(ApplicationInfo applicationInfo) {
        ...
        try {
            ...
            C11922g.Log(6, "NativeLoader.load failure, Unity libraries were not loaded.");
            return "NativeLoader.load failure, Unity libraries were not loaded.";
        } catch (UnsatisfiedLinkError e) {
            return logLoadLibMainError(str, e.toString());
    ...
    private void pauseUnity() {
        ...
        if (this.mState.mo73076g()) {
            if (C11935n.m34560c()) {
                final Semaphore semaphore = new Semaphore(0);
                this.m_MainThread.mo72992a(isFinishing() ? new Runnable() {
                    public final void run() {
                ...
                try {
                    if (!semaphore.tryAcquire(4, TimeUnit.SECONDS)) {
                        C11922g.Log(5, "Timeout while trying to pause the Unity Engine.");
                    }
                } catch (InterruptedException unused) {
                    C11922g.Log(5, "UI thread got interrupted while trying to pause the Unity Engine.");
                }
                if (semaphore.drainPermits() > 0) {
                    destroy();
                }
            }
            this.mState.mo73072d(false);
            this.mState.mo73070b(true);
    ...
    private void queueGLThreadEvent(C11906f fVar) {
        if (!isFinishing()) {
    ...
    public void sendSurfaceChangedEvent() {
        if (C11935n.m34560c() && this.mState.mo73074e()) {
            this.m_MainThread.mo72998d(new Runnable() {
                public final void run() {
    ...
    private boolean updateDisplayInternal(final int i, final Surface surface) {
        ...
        if (i == 0) {
            C11904e eVar = this.m_MainThread;
            if (surface == null) {
                eVar.mo72994b(r1);
            } else {
                eVar.mo72996c(r1);
        ...
        try {
            ...
            C11922g.Log(5, "Timeout while trying detaching primary window.");
            return true;
        } catch (InterruptedException unused) {
            C11922g.Log(5, "UI thread got interrupted while trying to detach the primary window from the Unity Engine.");
            return true;
        }
    }
    ...
    public boolean addViewToPlayer(View view, boolean z) {
        ...
        if (!z2) {
            if (!z3) {
                C11922g.Log(6, "addViewToPlayer: Failure adding view to hierarchy");
            }
            if (!z4 && !z5) {
                C11922g.Log(6, "addViewToPlayer: Failure removing old view from hierarchy");
            }
        }
        return z2;
    }
    ...
    public void configurationChanged(Configuration configuration) {
        ...
        C11941q qVar = this.mVideoPlayerProxy;
        if (qVar != null) {
            qVar.mo73111c();
        }
        GoogleVrProxy b = GoogleVrApi.m34435b();
        if (b != null) {
            b.mo72866c();
        }
    }
    ...
    public void destroy() {
        ...
        if (networkConnectivity != null) {
            networkConnectivity.mo72893b();
            this.m_NetworkConnectivity = null;
        }
        this.mQuitting = true;
        if (!this.mState.mo73073d()) {
            pause();
        }
        this.m_MainThread.mo72990a();
        try {
    ...
    public String getKeyboardLayout() {
        C11926k kVar = this.mSoftInputDialog;
        if (kVar == null) {
            return null;
        }
        return kVar.mo73048a();
    }
    ...
    public int getNetworkConnectivity() {
        ...
        return this.m_NetworkConnectivity.mo72892a();
    }
    ...
    public boolean initializeGoogleVr() {
        final GoogleVrProxy b = GoogleVrApi.m34435b();
        if (b == null) {
            GoogleVrApi.m34434a(this);
            b = GoogleVrApi.m34435b();
            if (b == null) {
                C11922g.Log(6, "Unable to create Google VR subsystem.");
                return false;
            }
        }
        final Semaphore semaphore = new Semaphore(0);
        final C1187814 r3 = new Runnable() {
            public final void run() {
        ...
        runOnUiThread(new Runnable() {
            public final void run() {
                if (!b.mo72864a(UnityPlayer.currentActivity, UnityPlayer.this.mContext, UnityPlayer.this.CreateGlView(), r3)) {
                    C11922g.Log(6, "Unable to initialize Google VR subsystem.");
                }
                if (UnityPlayer.currentActivity != null) {
                    b.mo72862a(UnityPlayer.currentActivity.getIntent());
                }
                semaphore.release();
            }
        });
        try {
            ...
            C11922g.Log(5, "Timeout while trying to initialize Google VR.");
            return false;
        } catch (InterruptedException e) {
            C11922g.Log(5, "UI thread was interrupted while initializing Google VR. " + e.getLocalizedMessage());
            return false;
        }
    }
    ...
    public void removeViewFromPlayer(View view) {
        ...
        if (!z) {
            if (!z2) {
                C11922g.Log(6, "removeViewFromPlayer: Failure removing view from hierarchy");
            }
            if (!z3) {
                C11922g.Log(6, "removeVireFromPlayer: Failure agging old view to hierarchy");
            }
        }
    }

    public void reportError(String str, String str2) {
        C11922g.Log(6, str + ": " + str2);
    }

    /* access modifiers changed from: protected */
    public void reportSoftInputArea(final Rect rect) {
        queueGLThreadEvent((C11906f) new C11906f() {
            /* renamed from: a */
            public final void mo72962a() {
    ...
    public void requestUserAuthorization(String str) {
        if (C11925j.f29205b && str != null && !str.isEmpty() && currentActivity != null) {
            C11925j.f29207d.mo73044a(currentActivity, str);
        }
    }
    ...
    public void runOnUiThread(Runnable runnable) {
        ...
        if (context instanceof Activity) {
            ...
            C11922g.Log(5, "Not running Unity from an Activity; ignored...");
        }
    }
    ...
    public void setCharacterLimit(final int i) {
        runOnUiThread(new Runnable() {
            public final void run() {
                if (UnityPlayer.this.mSoftInputDialog != null) {
                    UnityPlayer.this.mSoftInputDialog.mo73049a(i);
                }
            }
        });
    }
    ...
    public void setHideInputField(final boolean z) {
        runOnUiThread(new Runnable() {
            public final void run() {
                if (UnityPlayer.this.mSoftInputDialog != null) {
                    UnityPlayer.this.mSoftInputDialog.mo73052a(z);
                }
            }
        });
    }
    ...
    public void setSelection(final int i, final int i2) {
        runOnUiThread(new Runnable() {
            public final void run() {
                if (UnityPlayer.this.mSoftInputDialog != null) {
                    UnityPlayer.this.mSoftInputDialog.mo73050a(i, i2);
                }
            }
        });
    }
        ...
        runOnUiThread(new Runnable() {
            public final void run() {
                if (UnityPlayer.this.mSoftInputDialog != null && str != null) {
                    UnityPlayer.this.mSoftInputDialog.mo73051a(str);
                }
            }
        });
    }
    ...
    public void showSoftInput(String str, int i, boolean z, boolean z2, boolean z3, boolean z4, String str2, int i2, boolean z5) {
        ...
        postOnUiThread(new Runnable() {
            public final void run() {
                UnityPlayer.this.mSoftInputDialog = new C11926k(UnityPlayer.this.mContext, this, str3, i3, z6, z7, z8, str4, i4, z10);
    ...
    public boolean showVideoPlayer(String str, int i, int i2, int i3, boolean z, int i4, int i5) {
        if (this.mVideoPlayerProxy == null) {
            this.mVideoPlayerProxy = new C11941q(this);
        }
        boolean a = this.mVideoPlayerProxy.mo73109a(this.mContext, str, i, i2, i3, z, (long) i4, (long) i5, new C11941q.C11948a() {
            /* renamed from: a */
            public final void mo72965a() {
                C11941q unused = UnityPlayer.this.mVideoPlayerProxy = null;
            }
        });
        if (a) {
            runOnUiThread(new Runnable() {
    ...
    public boolean skipPermissionsDialog() {
        if (!C11925j.f29205b || currentActivity == null) {
            return false;
        }
        return C11925j.f29207d.mo73045a(currentActivity);
    }
    ...
    public boolean startOrientationListener(int i) {
        ...
        if (this.mOrientationListener != null) {
            ...
            C1188319 r0 = new OrientationEventListener(this.mContext, i) {
                public final void onOrientationChanged(int i) {
                    UnityPlayer.this.m_MainThread.mo72991a(UnityPlayer.this.mNaturalOrientation, i);
                }
            };
    ...
    public boolean stopOrientationListener() {
        ...
        if (orientationEventListener == null) {
            C11922g.Log(5, "Orientation Listener was not started.");
            return false;
        }
    ...
    public void windowFocusChanged(boolean z) {
        this.mState.mo73069a(z);
        if (this.mState.mo73074e()) {
            if (z) {
                this.m_MainThread.mo72995c();
            } else {
                this.m_MainThread.mo72997d();
            }
            checkResumePlayer();
        }
    }
