...
import com.unity3d.services.core.api.C12060Connectivity;
...
public class CoreModuleConfiguration implements IModuleConfiguration {
    public Class[] getWebAppApiClassList() {
        return new Class[]{Broadcast.class, Cache.class, C12060Connectivity.class, DeviceInfo.class, ClassDetection.class, Storage.class, Sdk.class, Request.class, Resolve.class, Intent.class, Lifecycle.class, Preferences.class, SensorInfo.class, Permissions.class};
    }
    ...
    public boolean initErrorState(com.unity3d.services.core.configuration.Configuration r4, java.lang.String r5, final java.lang.String r6) {
        /*
            r3 = this;
            com.unity3d.services.core.request.metrics.SDKMetrics.setConfiguration(r4)
            ...
            java.util.Map r4 = r4.getMetricTags()
            r0.setMetricTags(r4)
            int r4 = r5.hashCode()
