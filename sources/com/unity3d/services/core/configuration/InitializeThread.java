...
public class InitializeThread extends Thread {
                ...
                configurationLoader.loadConfiguration(new IConfigurationLoaderListener() {
                    public void onSuccess(Configuration configuration) {
                        ...
                        if (InitializeStateConfig.this._configuration.getDelayWebViewUpdate()) {
                            InitializeState unused2 = InitializeStateConfig.this._nextState = new InitializeStateLoadCacheConfigAndWebView(InitializeStateConfig.this._configuration, InitializeStateConfig.this._localConfig);
                        }
                        ...
                        InitializeState unused3 = InitializeStateConfig.this._nextState = new InitializeStateLoadCache(InitializeStateConfig.this._configuration);
                    }
    ...
    public static class InitializeStateLoadWeb extends InitializeState {
        ...
        public InitializeState execute() {
            ...
            try {
                try {
                    String makeRequest = new WebRequest(this._configuration.getWebViewUrl(), ShareTarget.METHOD_GET, (Map<String, List<String>>) null).makeRequest();
