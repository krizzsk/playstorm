            ...
            Utilities.runOnUiThread(new Runnable() {
                public void run() {
                    try {
                        ...
                        String urlWithQueryString = new WebViewUrlBuilder(Advertisement.FILE_SCHEME + SdkProperties.getLocalWebViewFile(), configuration).getUrlWithQueryString();
                        if (urlWithQueryString == null) {
                            ...
                            webViewApp.getWebView().loadDataWithBaseURL(Advertisement.FILE_SCHEME + SdkProperties.getLocalWebViewFile() + str, configuration.getWebViewData(), "text/html", "UTF-8", (String) null);
                        } else {
