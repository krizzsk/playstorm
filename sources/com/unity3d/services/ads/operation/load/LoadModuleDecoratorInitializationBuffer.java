...
public class LoadModuleDecoratorInitializationBuffer extends LoadModuleDecorator implements IInitializationListener {
    ...
    static /* synthetic */ class C120132 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f29314xe3e1bbe9     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.ads.operation.load.LoadModuleDecoratorInitializationBuffer.C120132.<clinit>():void");
        }
    }
    ...
    public void executeAdOperation(IWebViewBridgeInvoker iWebViewBridgeInvoker, LoadOperationState loadOperationState) {
        if (loadOperationState != null) {
            int i = C120132.f29314xe3e1bbe9[SdkProperties.getCurrentInitializationState().ordinal()];
            if (i == 1) {
