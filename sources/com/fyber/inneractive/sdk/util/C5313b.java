...
public class C5313b {
    /* renamed from: a */
    public static Bitmap m16709a(Context context, Bitmap bitmap, C5317c cVar) {
        boolean z;
        Bitmap bitmap2;
        int i = cVar.f14152a;
        int i2 = cVar.f14155d;
        int i3 = i / i2;
        int i4 = cVar.f14153b / i2;
        int[] iArr = {i3, i4};
        int i5 = 0;
        while (true) {
            if (i5 >= 2) {
        ...
        float f = 1.0f / ((float) cVar.f14155d);
        canvas.scale(f, f);
        ...
        if (Build.VERSION.SDK_INT >= 18) {
            try {
                bitmap2 = m16708a(context, createBitmap, cVar.f14154c);
            } catch (RSRuntimeException unused) {
                bitmap2 = m16710a(createBitmap, cVar.f14154c, true);
            }
        } else {
            bitmap2 = m16710a(createBitmap, cVar.f14154c, true);
        }
        ...
        Bitmap createScaledBitmap = Bitmap.createScaledBitmap(bitmap2, cVar.f14152a, cVar.f14153b, true);
        bitmap2.recycle();
    ...
    public static android.graphics.Bitmap m16708a(android.content.Context r5, android.graphics.Bitmap r6, int r7) throws android.renderscript.RSRuntimeException {
        /*
            r0 = 0
        ...
        L_0x0064:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fyber.inneractive.sdk.util.C5313b.m16708a(android.content.Context, android.graphics.Bitmap, int):android.graphics.Bitmap");
    }

    /* renamed from: a */
    public static Bitmap m16710a(Bitmap bitmap, int i, boolean z) {
        Bitmap bitmap2;
        int[] iArr;
        int i2 = i;
        if (z) {
