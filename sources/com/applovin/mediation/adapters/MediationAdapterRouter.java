...
public abstract class MediationAdapterRouter {
    ...
    protected MediationAdapterRouter() {
        for (AppLovinSdk next : AppLovinSdk.m5781a()) {
            if ("max".equalsIgnoreCase(next.getMediationProvider())) {
                this.mSdk = next.coreSdk;
            }
        }
        if (C2092v.m5047a() && this.mSdk == null) {
            C2092v.m5053i(this.mTag, "Invalid mediation provider detected. Please set AppLovin SDK mediation provider to MAX via AppLovinSdk.getInstance(context).setMediationProvider( AppLovinMediationProvider.MAX )");
        }
    }
    ...
    public void log(String str) {
        C1959m mVar;
        if (C2092v.m5047a() && (mVar = this.mSdk) != null) {
            mVar.mo14286A().mo14791c(this.mTag, str);
        }
    }

    /* access modifiers changed from: protected */
    public void log(String str, Throwable th) {
        if (this.mSdk != null && C2092v.m5047a()) {
            this.mSdk.mo14286A().mo14790b(this.mTag, str, th);
        }
    }
