...
public class C2080m {
    /* renamed from: a */
    public static String m4988a(String str, String str2) {
        return m4991a(str, str2, new byte[]{-83, -98, -53, -112, -29, -118, 55, 117, 59, 8, -12, -15, 73, 110, -67, 57, 117, 4, -26, 97, 66, -12, 125, 91, -119, -103, -30, 114, 123, 54, 51, -77});
    }

    /* renamed from: a */
    public static String m4989a(String str, String str2, long j) {
        return m4990a(str, str2, j, new byte[]{-83, -98, -53, -112, -29, -118, 55, 117, 59, 8, -12, -15, 73, 110, -67, 57, 117, 4, -26, 97, 66, -12, 125, 91, -119, -103, -30, 114, 123, 54, 51, -77});
    }

    /* renamed from: a */
    private static String m4990a(String str, String str2, long j, byte[] bArr) {
        String str3 = str;
        String str4 = str2;
        byte[] bArr2 = bArr;
        if (str4 == null) {
            ...
            if (bArr2.length < 32) {
                ...
                try {
                    ...
                    byte[] a = m4994a(substring2, bArr2);
                    ...
                    String b = m4996b(byteArrayOutputStream.toByteArray());
                    return "1:" + m4992a(bArr) + CertificateUtil.DELIMITER + substring + CertificateUtil.DELIMITER + b;
    ...
    /* renamed from: a */
    private static String m4991a(String str, String str2, byte[] bArr) {
        String str3 = str;
        String str4 = str2;
        byte[] bArr2 = bArr;
        if (str4 == null) {
            ...
            if (bArr2.length < 32) {
                ...
                try {
                    ...
                    String str5 = split[1];
                    String str6 = split[2];
                    byte[] a = m4993a(split[3]);
                    if (!str4.endsWith(str6)) {
                        return null;
                    }
                    if (!m4992a(bArr).equals(str5)) {
                        return null;
                    }
                    byte[] a2 = m4994a(str4.substring(0, 32), bArr2);
    ...
    /* renamed from: a */
    private static String m4992a(byte[] bArr) {
        try {
    ...
    /* renamed from: a */
    private static byte[] m4993a(String str) {
        return Base64.decode(m4995b(str), 0);
    }

    /* renamed from: a */
    private static byte[] m4994a(String str, byte[] bArr) {
        try {
    ...
    /* renamed from: b */
    private static String m4995b(String str) {
        return str.replace('-', '+').replace('_', '/').replace('*', '=');
    }

    /* renamed from: b */
    private static String m4996b(byte[] bArr) throws UnsupportedEncodingException {
        return m4997c(Base64.encode(bArr, 2));
    }

    /* renamed from: c */
    private static String m4997c(byte[] bArr) throws UnsupportedEncodingException {
