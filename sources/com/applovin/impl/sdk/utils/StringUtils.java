...
public class StringUtils {
    ...
    /* renamed from: a */
    private static final char[] f3948a = "0123456789abcdef".toCharArray();

    /* renamed from: a */
    private static String m4856a(String str, Integer num) {
    ...
    public static String encodeUriString(String str, C1959m mVar) {
        if (TextUtils.isEmpty(str)) {
            return "";
        }
        if (((Boolean) mVar.mo14311a(C1857b.f3294eO)).booleanValue()) {
    ...
    public static String toHexString(byte[] bArr) {
        if (bArr != null) {
            ...
            for (int i = 0; i < bArr.length; i++) {
                ...
                cArr[i2 + 1] = cArr2[bArr[i] & Ascii.f17944SI];
            }
