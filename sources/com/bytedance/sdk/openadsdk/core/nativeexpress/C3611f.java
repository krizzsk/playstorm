...
public class C3611f extends C3427b {
    public C3611f(Context context, C3498n nVar, String str, int i) {
    ...
    public C3476g mo19393a(float f, float f2, float f3, float f4, SparseArray<C3429c.C3430a> sparseArray, long j, long j2, View view, View view2, String str, float f5, int i, float f6, int i2, JSONObject jSONObject) {
        ...
        if (a == null || a.length != 2) {
            ...
            if (this.f8277r == 0) {
                ...
                float f12 = (float) i3;
                f8 = (C4020v.m13297b(this.f8261b, f3) + f11) - 0.5f;
                f7 = (C4020v.m13297b(this.f8261b, f4) + f12) - 0.5f;
                f9 = (b2 + f12) - 0.5f;
                f10 = (b + f11) - 0.5f;
            } else {
                f10 = f;
        ...
        if (this.f8262c != null) {
            ...
            if (this.f8277r == 0) {
                iArr[0] = ((int) C4020v.m13297b(this.f8261b, (float) this.f8262c.f8486g)) + i9;
                iArr[1] = ((int) C4020v.m13297b(this.f8261b, (float) this.f8262c.f8487h)) + i3;
                i8 = (int) C4020v.m13297b(this.f8261b, (float) this.f8262c.f8488i);
                i7 = (int) C4020v.m13297b(this.f8261b, (float) this.f8262c.f8489j);
                c = 0;
                i5 = 1;
            } else {
                c = 0;
                ...
                i8 = this.f8262c.f8488i;
                i7 = this.f8262c.f8489j;
            }
            iArr2[c] = i8;
            iArr2[i5] = i7;
        ...
        this.f8277r = i6;
        return new C3476g.C3478a().mo19532f(f10).mo19530e(f9).mo19527d(f8).mo19524c(f7).mo19522b(j4).mo19514a(j3).mo19523b(a).mo19518a(iArr).mo19526c(C4020v.m13309c(view)).mo19529d(iArr2).mo19528d(this.f8296y).mo19531e(this.f8297z).mo19533f(this.f8284A).mo19521b(C3524h.m10852d().mo19842b() ? i5 : 2).mo19515a(sparseArray).mo19516a(str).mo19513a(i2).mo19517a(jSONObject).mo19519a();
    }

    /* renamed from: a */
    public void mo20183a(C3481j jVar) {
        this.f8262c = jVar;
    }
}
