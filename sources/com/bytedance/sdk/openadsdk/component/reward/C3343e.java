...
public class C3343e {
    ...
    public static void m9944a(String str, int i, String str2, String str3, String str4) {
        try {
            ...
            if (a != null) {
                if (a.mo19607J() != null) {
                    a.mo19607J().mo16349d(str5);
                }
                if (a.mo19657aa() != null) {
                    if (!TextUtils.isEmpty(str2)) {
                        a.mo19657aa().mo19494a(str2);
                        a.mo19657aa().mo19497b("Test the downloaded app");
                    } else {
                        a.mo19657aa().mo19494a((String) null);
                        a.mo19657aa().mo19497b("");
                    }
                    if (!TextUtils.isEmpty(str2)) {
                        a.mo19657aa().mo19499c(str3);
                    } else {
                        str2 = str4;
                    }
                    if (!TextUtils.isEmpty(str2)) {
                        if (a.mo19658ab() != null) {
                            a.mo19658ab().mo19536a(str2);
                        } else {
                ...
                if (a.mo19610M() != null) {
                    a.mo19610M().mo19561a("https://p0.ipstatp.com/origin/ad-site-i18n-sg/202011255d0d219920adb0fd474eac28");
                }
                if (i == 1) {
                    a.mo19745s(15);
                } else {
            ...
            C3369k kVar = new C3369k(C3578m.m11231a(), a, new AdSlot.Builder().build());
            kVar.mo19237a(true);
            kVar.showFullScreenVideoAd((Activity) null);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
