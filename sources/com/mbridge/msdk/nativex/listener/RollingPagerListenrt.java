...
public class RollingPagerListenrt implements ViewPager.OnPageChangeListener {
    ...
    private C8526d reportController;
    ...
    public void setCampList(List<Frame> list2, Context context, String str) {
        this.frames = list2;
        this.reportController = new C8526d(context, 2);
        this.unit_id = str;
        this.list.clear();
        reportRollBC(0);
    }
    ...
    public void reportRollBC(int i) {
        ...
        if (!this.list.contains(Integer.valueOf(i))) {
            ...
            if (campaigns != null && !campaigns.isEmpty()) {
                ...
                String a = C8542e.m24694a("2000005", (Map<String, Object>) hashMap);
                if (C8518b.m24607a().mo57681c()) {
                    C8518b.m24607a().mo57679a(a);
                } else {
                    this.reportController.mo57695a("native_rollbc", a, this.unit_id, frame);
                }
            }
        }
    }
