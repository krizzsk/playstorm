...
public class MBNativeHandler extends MBCommonHandler {
    ...
    private boolean loadMB() {
        ...
        if (list != null && list.size() > 0) {
            try {
                ...
                C8608u.m24883c(TAG, "MBSDK set template error");
            }
        }
        try {
            this.properties.put(MBridgeConstans.PROPERTIES_HANDLER_CONTROLLER, this);
            if (this.nativeProvider == null) {
                C8777a aVar = new C8777a(this.adListener, this.trackingListener);
                this.nativeProvider = aVar;
                aVar.mo58164a(this.context, (Resources) null, (Map<String, Object>) this.properties);
            }
            this.nativeProvider.mo58163a();
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            return true;
    ...
    public String getRequestId() {
        C8777a aVar = this.nativeProvider;
        return aVar != null ? aVar.mo58175e() : "";
    }
}
