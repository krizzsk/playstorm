...
public class LoadingActivity extends Activity {
    ...
    private C8428c cipl = new C8428c() {
    ...
    private View initView() {
        if (this.rlayout_main == null) {
            ...
            int b = C8613y.m24929b((Context) this, 15.0f);
            ...
            this.rlayout.addView(new TextView(this), new RelativeLayout.LayoutParams(C8613y.m24929b((Context) this, 140.0f), C8613y.m24929b((Context) this, 31.5f)));
            MBImageView mBImageView = new MBImageView(this);
            this.img_icon = mBImageView;
            mBImageView.setId(C8613y.m24911a());
            this.img_icon.setTag(this.icon_url);
            if (!TextUtils.isEmpty(this.icon_url)) {
                C8425b.m24339a(getApplicationContext()).mo57506a(this.icon_url, this.cipl);
            }
            int b2 = C8613y.m24929b((Context) this, 64.0f);
