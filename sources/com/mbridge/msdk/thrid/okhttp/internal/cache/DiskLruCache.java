...
import com.mbridge.msdk.thrid.okhttp.internal.p344io.FileSystem;
...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final Runnable cleanupRunnable = new Runnable() {
        ...
        public void run() {
            ...
            L_0x0045:
                ...
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache.C91551.run():void");
        }
    };
    boolean closed;
    ...
    public synchronized boolean remove(java.lang.String r6) throws java.io.IOException {
        /*
            ...
            java.util.LinkedHashMap<java.lang.String, com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Entry> r0 = r5.lruEntries     // Catch:{ all -> 0x0029 }
            java.lang.Object r6 = r0.get(r6)     // Catch:{ all -> 0x0029 }
            com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Entry r6 = (com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache.Entry) r6     // Catch:{ all -> 0x0029 }
            r0 = 0
        ...
        public Sink newSink(int i) {
            synchronized (DiskLruCache.this) {
                if (this.done) {
                    ...
                    try {
                        C91581 r1 = new FaultHidingSink(DiskLruCache.this.fileSystem.sink(this.entry.dirtyFiles[i])) {
                            /* access modifiers changed from: protected */
                            public void onException(IOException iOException) {
                                synchronized (DiskLruCache.this) {
                                    Editor.this.detach();
