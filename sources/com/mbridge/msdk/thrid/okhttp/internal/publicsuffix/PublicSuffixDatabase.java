...
public final class PublicSuffixDatabase {
    ...
    public String getEffectiveTldPlusOne(String str) {
        ...
        int i2;
        if (str != null) {
            String[] split = IDN.toUnicode(str).split(DnsName.ESCAPED_DOT);
    ...
    private String[] findMatchingRule(String[] strArr) {
        ...
        if (str != null) {
            ...
            String[] split = str2 != null ? str2.split(DnsName.ESCAPED_DOT) : EMPTY_RULE;
            String[] split2 = str3 != null ? str3.split(DnsName.ESCAPED_DOT) : EMPTY_RULE;
