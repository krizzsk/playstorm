...
public class PlayerView extends LinearLayout {
    ...
    public void addSurfaceView() {
        try {
            C8608u.m24882b(TAG, "addSurfaceView");
    ...
    public void removeSurface() {
        try {
            C8608u.m24882b(TAG, "removeSurface");
    ...
    private void initView() {
        View inflate = LayoutInflater.from(getContext()).inflate(C8594o.m24812a(getContext(), "mbridge_playercommon_player_view", "layout"), (ViewGroup) null);
        if (inflate != null) {
            this.mLlSurContainer = (LinearLayout) inflate.findViewById(C8594o.m24812a(getContext(), "mbridge_playercommon_ll_sur_container", "id"));
            this.mLoadingView = (LinearLayout) inflate.findViewById(C8594o.m24812a(getContext(), "mbridge_playercommon_ll_loading", "id"));
            addSurfaceView();
            addView(inflate, -1, -1);
        }
    }
    ...
    private class MySurfaceHoldeCallback implements SurfaceHolder.Callback {
        ...
        public void surfaceCreated(SurfaceHolder surfaceHolder) {
            try {
                ...
                C8608u.m24884d(PlayerView.TAG, e.getMessage());
            }
        }
        ...
        public void surfaceChanged(SurfaceHolder surfaceHolder, int i, int i2, int i3) {
            try {
                if (PlayerView.this.mIsSurfaceHolderDestoryed && !PlayerView.this.mIsCovered && !PlayerView.this.isComplete() && !PlayerView.this.isBTVideo && !C2347b.f4898c) {
