...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener<Object> {
    ...
    public final synchronized void onTransferEnd(Object obj) {
        ...
        if (i > 0) {
            this.slidingPercentile.addSample((int) Math.sqrt((double) this.sampleBytesTransferred), (float) ((this.sampleBytesTransferred * RtspMediaSource.DEFAULT_TIMEOUT_MS) / j));
