    ...
    private void onMoovContainerAtomRead(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        while (i5 < size2) {
            ...
            if (containerAtom3.type == Atom.TYPE_trak) {
                ...
                if (parseTrak != null) {
                    sparseArray2.put(parseTrak.f21667id, parseTrak);
                }
            } else {
                i = i5;
                i2 = size2;
        ...
        if (this.trackBundles.size() == 0) {
            while (i3 < size3) {
                ...
                trackBundle.init(track, getDefaultSampleValues(sparseArray, track.f21667id));
                this.trackBundles.put(track.f21667id, trackBundle);
        ...
        while (i3 < size3) {
            ...
            this.trackBundles.get(track2.f21667id).init(track2, getDefaultSampleValues(sparseArray, track2.f21667id));
            i3++;
        }
    }
    ...
    private boolean readSample(ExtractorInput extractorInput) throws IOException, InterruptedException {
        ...
        if (track.nalUnitLengthFieldLength == 0) {
            while (true) {
                ...
                this.sampleBytesWritten += trackOutput.sampleData(extractorInput2, i5 - i4, false);
            }
        } else {
            ...
            while (this.sampleBytesWritten < this.sampleSize) {
                ...
                if (i8 == 0) {
                    ...
                    if (this.processSeiNalUnitPayload) {
                        ...
                        i = trackOutput.sampleData(extractorInput2, i8, z3);
                    }
        ...
        boolean z4 = trackFragment.sampleIsSyncFrameTable[i3];
