...
final class AtomParsers {
    ...
    public static Track parseTrak(Atom.ContainerAtom containerAtom, Atom.LeafAtom leafAtom, long j, DrmInitData drmInitData, boolean z, boolean z2) throws ParserException {
        ...
        StsdData parseStsd = parseStsd(containerAtomOfType2.getLeafAtomOfType(Atom.TYPE_stsd).data, parseTkhd.f21666id, parseTkhd.rotationDegrees, (String) parseMdhd.second, drmInitData, z2);
        if (!z) {
        ...
        return new Track(parseTkhd.f21666id, parseHdlr, ((Long) parseMdhd.first).longValue(), parseMvhd, j4, parseStsd.format, parseStsd.requiredSampleTransformation, parseStsd.trackEncryptionBoxes, parseStsd.nalUnitLengthFieldLength, jArr2, jArr);
    }

    /* JADX WARNING: Removed duplicated region for block: B:100:0x0268  */
    /* JADX WARNING: Removed duplicated region for block: B:124:0x0309  */
    /* JADX WARNING: Removed duplicated region for block: B:130:0x033f  */
    /* JADX WARNING: Removed duplicated region for block: B:191:0x048f  */
