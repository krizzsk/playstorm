...
final class SeiReader {
    ...
    public final void createTracks(ExtractorOutput extractorOutput, TsPayloadReader.TrackIdGenerator trackIdGenerator) {
        for (int i = 0; i < this.outputs.length; i++) {
            ...
            track.format(Format.createTextSampleFormat(format.f21662id != null ? format.f21662id : trackIdGenerator.getFormatId(), str, (String) null, -1, format.selectionFlags, format.language, format.accessibilityChannel, (DrmInitData) null));
