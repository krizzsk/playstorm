...
public abstract class CompositeMediaSource<T> extends BaseMediaSource {
    ...
    public final void prepareChildSource(final T t, MediaSource mediaSource) {
        ...
        C89941 r0 = new MediaSource.SourceInfoRefreshListener() {
    ...
    private final class ForwardingEventListener implements MediaSourceEventListener {
        ...
        private boolean maybeUpdateEventDispatcher(int i, MediaSource.MediaPeriodId mediaPeriodId) {
            ...
            if (mediaPeriodId != null) {
                mediaPeriodId2 = CompositeMediaSource.this.getMediaPeriodIdForChildMediaPeriodId(this.f21679id, mediaPeriodId);
            ...
            int windowIndexForChildWindowIndex = CompositeMediaSource.this.getWindowIndexForChildWindowIndex(this.f21679id, i);
        ...
        private MediaSourceEventListener.MediaLoadData maybeUpdateMediaLoadData(MediaSourceEventListener.MediaLoadData mediaLoadData) {
            long mediaTimeForChildMediaTime = CompositeMediaSource.this.getMediaTimeForChildMediaTime(this.f21679id, mediaLoadData.mediaStartTimeMs);
            long mediaTimeForChildMediaTime2 = CompositeMediaSource.this.getMediaTimeForChildMediaTime(this.f21679id, mediaLoadData.mediaEndTimeMs);
