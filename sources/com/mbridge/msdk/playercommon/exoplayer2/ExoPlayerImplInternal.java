...
final class ExoPlayerImplInternal implements Handler.Callback, DefaultMediaClock.PlaybackParameterListener, PlayerMessage.Sender, MediaPeriod.Callback, MediaSource.SourceInfoRefreshListener, TrackSelector.InvalidationListener {
    ...
    public final synchronized void release() {
        /*
            r7 = this;
            monitor-enter(r7)
            boolean r0 = r7.released     // Catch:{ all -> 0x0044 }
            if (r0 != 0) goto L_0x0042
            android.os.HandlerThread r0 = r7.internalPlaybackThread     // Catch:{ all -> 0x0044 }
            boolean r0 = r0.isAlive()     // Catch:{ all -> 0x0044 }
            if (r0 != 0) goto L_0x000e
            goto L_0x0042
        L_0x000e:
            com.mbridge.msdk.playercommon.exoplayer2.util.HandlerWrapper r0 = r7.handler     // Catch:{ all -> 0x0044 }
            r1 = 7
            r0.sendEmptyMessage(r1)     // Catch:{ all -> 0x0044 }
            com.mbridge.msdk.playercommon.exoplayer2.util.Clock r0 = r7.clock     // Catch:{ all -> 0x0044 }
            long r0 = r0.elapsedRealtime()     // Catch:{ all -> 0x0044 }
            r2 = 500(0x1f4, double:2.47E-321)
            long r0 = r0 + r2
            r4 = 0
        L_0x001e:
            boolean r5 = r7.released     // Catch:{ all -> 0x0044 }
            if (r5 != 0) goto L_0x0037
            r5 = 0
            int r5 = (r2 > r5 ? 1 : (r2 == r5 ? 0 : -1))
            if (r5 <= 0) goto L_0x0037
            r7.wait(r2)     // Catch:{ InterruptedException -> 0x002c }
            goto L_0x002e
        L_0x002c:
            r2 = 1
            r4 = r2
        L_0x002e:
            com.mbridge.msdk.playercommon.exoplayer2.util.Clock r2 = r7.clock     // Catch:{ all -> 0x0044 }
    ...
    private void seekToCurrentPosition(boolean z) throws ExoPlaybackException {
        MediaSource.MediaPeriodId mediaPeriodId = this.queue.getPlayingPeriod().info.f21663id;
    ...
    private void seekToInternal(com.mbridge.msdk.playercommon.exoplayer2.ExoPlayerImplInternal.SeekPosition r21) throws com.mbridge.msdk.playercommon.exoplayer2.ExoPlaybackException {
        ...
        L_0x005b:
            r9 = 2
            com.mbridge.msdk.playercommon.exoplayer2.source.MediaSource r10 = r1.mediaSource     // Catch:{ all -> 0x00da }
        ...
        L_0x0065:
            ...
            goto L_0x00c8
        L_0x0071:
            com.mbridge.msdk.playercommon.exoplayer2.PlaybackInfo r0 = r1.playbackInfo     // Catch:{ all -> 0x00da }
            com.mbridge.msdk.playercommon.exoplayer2.source.MediaSource$MediaPeriodId r0 = r0.periodId     // Catch:{ all -> 0x00da }
            boolean r0 = r15.equals(r0)     // Catch:{ all -> 0x00da }
            if (r0 == 0) goto L_0x00b7
            com.mbridge.msdk.playercommon.exoplayer2.MediaPeriodQueue r0 = r1.queue     // Catch:{ all -> 0x00da }
            com.mbridge.msdk.playercommon.exoplayer2.MediaPeriodHolder r0 = r0.getPlayingPeriod()     // Catch:{ all -> 0x00da }
            if (r0 == 0) goto L_0x0090
            int r4 = (r12 > r4 ? 1 : (r12 == r4 ? 0 : -1))
            if (r4 == 0) goto L_0x0090
            com.mbridge.msdk.playercommon.exoplayer2.source.MediaPeriod r0 = r0.mediaPeriod     // Catch:{ all -> 0x00da }
            com.mbridge.msdk.playercommon.exoplayer2.SeekParameters r4 = r1.seekParameters     // Catch:{ all -> 0x00da }
            long r4 = r0.getAdjustedSeekPositionUs(r12, r4)     // Catch:{ all -> 0x00da }
            goto L_0x0091
        L_0x0090:
            r4 = r12
        L_0x0091:
            long r7 = com.mbridge.msdk.playercommon.exoplayer2.C8912C.usToMs(r4)     // Catch:{ all -> 0x00da }
            com.mbridge.msdk.playercommon.exoplayer2.PlaybackInfo r0 = r1.playbackInfo     // Catch:{ all -> 0x00da }
            long r10 = r0.positionUs     // Catch:{ all -> 0x00da }
            long r10 = com.mbridge.msdk.playercommon.exoplayer2.C8912C.usToMs(r10)     // Catch:{ all -> 0x00da }
    ...
    private boolean shouldKeepPeriodHolder(MediaSource.MediaPeriodId mediaPeriodId, long j, MediaPeriodHolder mediaPeriodHolder) {
        if (!mediaPeriodId.equals(mediaPeriodHolder.info.f21663id) || !mediaPeriodHolder.prepared) {
            return false;
        }
        this.playbackInfo.timeline.getPeriod(mediaPeriodHolder.info.f21663id.periodIndex, this.period);
    ...
    private boolean resolvePendingMessagePosition(PendingMessageInfo pendingMessageInfo) {
        if (pendingMessageInfo.resolvedPeriodUid == null) {
            Pair<Integer, Long> resolveSeekPosition = resolveSeekPosition(new SeekPosition(pendingMessageInfo.message.getTimeline(), pendingMessageInfo.message.getWindowIndex(), C8912C.msToUs(pendingMessageInfo.message.getPositionMs())), false);
    ...
    private boolean isTimelineReady() {
        MediaPeriodHolder playingPeriod = this.queue.getPlayingPeriod();
        long j = playingPeriod.info.durationUs;
        return j == -9223372036854775807L || this.playbackInfo.positionUs < j || (playingPeriod.next != null && (playingPeriod.next.prepared || playingPeriod.next.info.f21663id.isAd()));
    }
        ...
        if (mediaSource2 != null) {
            ...
            if (this.queue.hasPlayingPeriod()) {
                ...
                while (this.playWhenReady && playingPeriod != readingPeriod && this.rendererPositionUs >= playingPeriod.next.rendererPositionOffsetUs) {
                    ...
                    updatePlayingPeriodRenderers(playingPeriod);
                    this.playbackInfo = this.playbackInfo.fromNewPosition(advancePlayingPeriod.info.f21663id, advancePlayingPeriod.info.startPositionUs, advancePlayingPeriod.info.contentPositionUs);
    ...
    private void maybeUpdateLoadingPeriod() throws IOException {
        ...
        if (this.queue.shouldLoadNextMediaPeriod()) {
            ...
            this.queue.enqueueNextMediaPeriod(this.rendererCapabilities, this.trackSelector, this.loadControl.getAllocator(), this.mediaSource, this.playbackInfo.timeline.getPeriod(nextMediaPeriodInfo.f21663id.periodIndex, this.period, true).uid, nextMediaPeriodInfo).prepare(this, nextMediaPeriodInfo.startPositionUs);
            setIsLoading(true);
        }
    }
