...
public final class NalUnitUtil {
    ...
    public static void discardToSps(ByteBuffer byteBuffer) {
        ...
        while (true) {
            ...
            if (i3 < position) {
                ...
                if (i2 == 3) {
                    if (b == 1 && (byteBuffer.get(i3) & Ascii.f17947US) == 7) {
    ...
    public static boolean isNalUnitSei(String str, byte b) {
        if ("video/avc".equals(str) && (b & Ascii.f17947US) == 6) {
            return true;
        }
    ...
    public static int getNalUnitType(byte[] bArr, int i) {
        return bArr[i + 3] & Ascii.f17947US;
    }
    ...
    public static SpsData parseSpsNalUnit(byte[] bArr, int i, int i2) {
        ...
        if (parsableNalUnitBitArray.readBit()) {
            ...
            i11 -= (readUnsignedExpGolombCodedInt7 + readUnsignedExpGolombCodedInt8) * i7;
            i12 -= (readUnsignedExpGolombCodedInt9 + readUnsignedExpGolombCodedInt10) * i6;
        }
        int i14 = i12;
        int i15 = i11;
        float f2 = 1.0f;
        if (parsableNalUnitBitArray.readBit() && parsableNalUnitBitArray.readBit()) {
            ...
            if (readBits2 == 255) {
                ...
                if (readBits2 < fArr.length) {
                    f = fArr[readBits2];
                    return new SpsData(i4, i15, i14, f, z, readBit3, readUnsignedExpGolombCodedInt2, readUnsignedExpGolombCodedInt3, i5, z2);
                }
