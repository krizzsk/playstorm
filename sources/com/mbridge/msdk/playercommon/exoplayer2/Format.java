...
public final class Format implements Parcelable {
    ...
    Format(Parcel parcel) {
        this.f21662id = parcel.readString();
    ...
    public final String toString() {
        return "Format(" + this.f21662id + ", " + this.containerMimeType + ", " + this.sampleMimeType + ", " + this.bitrate + ", " + this.language + ", [" + this.width + ", " + this.height + ", " + this.frameRate + "], [" + this.channelCount + ", " + this.sampleRate + "])";
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        parcel.writeString(this.f21662id);
