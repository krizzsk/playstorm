...
public final class C9430n extends C9422g {

    /* renamed from: a */
    private MBridgeVideoView f23056a;

    public C9430n(MBridgeVideoView mBridgeVideoView) {
        this.f23056a = mBridgeVideoView;
    }
    ...
    public final void showVideoLocation(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
        ...
        MBridgeVideoView mBridgeVideoView = this.f23056a;
