...
public final class C2376g extends C2374f {

    /* renamed from: a */
    private static C2376g f4993a;

    /* access modifiers changed from: protected */
    /* renamed from: c */
    public final String mo15897c() {
        return "mbridge.msdk.db";
    }

    /* access modifiers changed from: protected */
    /* renamed from: d */
    public final int mo15898d() {
        return 68;
    }

    private C2376g(Context context) {
        super(context);
    }

    /* renamed from: a */
    public static synchronized C2376g m5723a(Context context) {
        C2376g gVar;
        synchronized (C2376g.class) {
            if (f4993a == null) {
                f4993a = new C2376g(context.getApplicationContext());
            }
            gVar = f4993a;
        }
        return gVar;
    ...
    /* access modifiers changed from: protected */
    /* renamed from: a */
    public final void mo15893a(SQLiteDatabase sQLiteDatabase) {
        m5724b(sQLiteDatabase);
    }

    /* access modifiers changed from: protected */
    /* renamed from: a */
    public final void mo15894a(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        m5725c(sQLiteDatabase);
        m5724b(sQLiteDatabase);
    }

    /* renamed from: b */
    private void m5724b(SQLiteDatabase sQLiteDatabase) {
        try {
    ...
    /* renamed from: c */
    private void m5725c(SQLiteDatabase sQLiteDatabase) {
        try {
    ...
    /* access modifiers changed from: protected */
    /* renamed from: b */
    public final void mo15896b(SQLiteDatabase sQLiteDatabase, int i, int i2) {
        m5725c(sQLiteDatabase);
        m5724b(sQLiteDatabase);
    }
}
