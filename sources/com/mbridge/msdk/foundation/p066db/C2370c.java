...
public class C2370c extends C2365a<CommonJumpLoader.JumpLoaderResult> {

    /* renamed from: a */
    public static final String f4967a = C2370c.class.getSimpleName();

    /* renamed from: b */
    private static C2370c f4968b;

    private C2370c(C2374f fVar) {
        super(fVar);
    }

    /* renamed from: a */
    public static synchronized C2370c m5669a(C2374f fVar) {
        C2370c cVar;
        synchronized (C2370c.class) {
            if (f4968b == null) {
                f4968b = new C2370c(fVar);
            }
            cVar = f4968b;
        }
        return cVar;
    ...
    public final synchronized long mo15851a(com.mbridge.msdk.foundation.entity.CampaignEx r8, java.lang.String r9) {
        /*
            r7 = this;
            monitor-enter(r7)
        ...
        L_0x0007:
            ...
            java.lang.String r2 = com.mbridge.msdk.foundation.tools.C8614z.m24961a((java.lang.Object) r2)     // Catch:{ Exception -> 0x00e2, all -> 0x00df }
            ...
            r3.put(r2, r4)     // Catch:{ Exception -> 0x00e2, all -> 0x00df }
            com.mbridge.msdk.c.b r2 = com.mbridge.msdk.p054c.C2283b.m5275a()     // Catch:{ Exception -> 0x00e2, all -> 0x00df }
            com.mbridge.msdk.foundation.controller.a r4 = com.mbridge.msdk.foundation.controller.C2350a.m5601e()     // Catch:{ Exception -> 0x00e2, all -> 0x00df }
            java.lang.String r4 = r4.mo15793h()     // Catch:{ Exception -> 0x00e2, all -> 0x00df }
            com.mbridge.msdk.c.a r2 = r2.mo15563b(r4)     // Catch:{ Exception -> 0x00e2, all -> 0x00df }
            ...
            int r4 = r2.mo15447U()     // Catch:{ Exception -> 0x00e2, all -> 0x00df }
            if (r4 <= 0) goto L_0x0075
            java.lang.String r4 = "cpei"
            int r5 = r2.mo15447U()     // Catch:{ Exception -> 0x00e2, all -> 0x00df }
            int r5 = r5 * 1000
            java.lang.Integer r5 = java.lang.Integer.valueOf(r5)     // Catch:{ Exception -> 0x00e2, all -> 0x00df }
            r3.put(r4, r5)     // Catch:{ Exception -> 0x00e2, all -> 0x00df }
        L_0x0075:
            if (r2 == 0) goto L_0x008c
            int r4 = r2.mo15448V()     // Catch:{ Exception -> 0x00e2, all -> 0x00df }
            if (r4 <= 0) goto L_0x008c
            java.lang.String r4 = "cpoci"
            int r2 = r2.mo15448V()     // Catch:{ Exception -> 0x00e2, all -> 0x00df }
            int r2 = r2 * 1000
        ...
        L_0x008c:
            ...
            boolean r2 = r7.m5670c(r2, r9)     // Catch:{ Exception -> 0x00e2, all -> 0x00df }
            r4 = 0
        ...
        L_0x00e2:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p066db.C2370c.mo15851a(com.mbridge.msdk.foundation.entity.CampaignEx, java.lang.String):long");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized boolean mo15853a(java.lang.String r4, java.lang.String r5) {
        /*
            r3 = this;
            monitor-enter(r3)
            r0 = 0
        ...
        L_0x0065:
            r4 = move-exception
            java.lang.String r5 = f4967a     // Catch:{ all -> 0x0063 }
            java.lang.String r4 = r4.getMessage()     // Catch:{ all -> 0x0063 }
            com.mbridge.msdk.foundation.tools.C8608u.m24884d(r5, r4)     // Catch:{ all -> 0x0063 }
            monitor-exit(r3)
            return r0
        L_0x0071:
            monitor-exit(r3)
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p066db.C2370c.mo15853a(java.lang.String, java.lang.String):boolean");
    }
    ...
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized com.mbridge.msdk.click.CommonJumpLoader.JumpLoaderResult mo15854b(java.lang.String r11, java.lang.String r12) {
        /*
            r10 = this;
            monitor-enter(r10)
            r0 = 0
            ...
            java.lang.Object r12 = com.mbridge.msdk.foundation.tools.C8614z.m24960a((java.lang.String) r12)     // Catch:{ Exception -> 0x0047 }
        ...
        L_0x0063:
            ...
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p066db.C2370c.mo15854b(java.lang.String, java.lang.String):com.mbridge.msdk.click.CommonJumpLoader$JumpLoaderResult");
    }

    /* renamed from: c */
    private synchronized boolean m5670c(String str, String str2) {
