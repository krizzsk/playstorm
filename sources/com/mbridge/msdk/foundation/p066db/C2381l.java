...
public final class C2381l extends C2365a {

    /* renamed from: a */
    private static String f4999a = "ReplaceTempDao";

    /* renamed from: b */
    private static C2381l f5000b;

    private C2381l(C2374f fVar) {
        super(fVar);
    }

    /* renamed from: a */
    public static C2381l m5751a(C2374f fVar) {
        if (f5000b == null) {
            synchronized (C2372e.class) {
                if (f5000b == null) {
                    f5000b = new C2381l(fVar);
                }
            }
        }
        return f5000b;
    ...
    public final org.json.JSONObject mo15915a(java.lang.String r4) {
        /*
            r3 = this;
        ...
        L_0x004d:
            ...
            goto L_0x0069
        L_0x0053:
            java.lang.String r2 = f4999a     // Catch:{ all -> 0x0062 }
            java.lang.String r0 = r0.getMessage()     // Catch:{ all -> 0x0062 }
            com.mbridge.msdk.foundation.tools.C8608u.m24884d(r2, r0)     // Catch:{ all -> 0x0062 }
        ...
        L_0x006c:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p066db.C2381l.mo15915a(java.lang.String):org.json.JSONObject");
    }

    /* renamed from: a */
    public final void mo15916a(String str, JSONObject jSONObject) {
        boolean z;
        try {
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final org.json.JSONObject mo15914a() {
        /*
            r8 = this;
        ...
        L_0x006e:
            ...
            goto L_0x008a
        L_0x0074:
            java.lang.String r3 = f4999a     // Catch:{ all -> 0x0083 }
            java.lang.String r2 = r2.getMessage()     // Catch:{ all -> 0x0083 }
            com.mbridge.msdk.foundation.tools.C8608u.m24884d(r3, r2)     // Catch:{ all -> 0x0083 }
        ...
        L_0x0090:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p066db.C2381l.mo15914a():org.json.JSONObject");
    }
}
