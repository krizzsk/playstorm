...
public class C2377h extends C2365a<Campaign> {

    /* renamed from: a */
    private static final String f4994a = C2377h.class.getName();

    /* renamed from: b */
    private static C2377h f4995b = null;

    private C2377h(C2374f fVar) {
        super(fVar);
    }

    /* renamed from: a */
    public static synchronized C2377h m5731a(C2374f fVar) {
        C2377h hVar;
        synchronized (C2377h.class) {
            if (f4995b == null) {
                f4995b = new C2377h(fVar);
            }
            hVar = f4995b;
        }
        return hVar;
    ...
    public final boolean mo15903a(java.lang.String r11, int r12) {
        /*
            r10 = this;
            r0 = 0
            r1 = 0
            ...
            r10.m5732b(r11)     // Catch:{ all -> 0x006d }
            goto L_0x0064
        L_0x005b:
        ...
        L_0x006d:
            r11 = move-exception
            java.lang.String r12 = f4994a     // Catch:{ all -> 0x007b }
            java.lang.String r11 = r11.getMessage()     // Catch:{ all -> 0x007b }
            com.mbridge.msdk.foundation.tools.C8608u.m24882b(r12, r11)     // Catch:{ all -> 0x007b }
            if (r0 == 0) goto L_0x007a
            goto L_0x0066
        L_0x007a:
            return r1
        ...
        L_0x0081:
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p066db.C2377h.mo15903a(java.lang.String, int):boolean");
    }

    /* renamed from: b */
    private synchronized void m5732b(String str) {
        try {
            ...
            C8608u.m24882b(f4994a, th.getMessage());
        }
        return;
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized void mo15902a(java.lang.String r17) {
        /*
            r16 = this;
            r0 = r17
            monitor-enter(r16)
        ...
        L_0x000c:
            ...
            boolean r5 = r16.m5733c(r17)     // Catch:{ Exception -> 0x00d4 }
            r6 = 1
            ...
            r16.m5732b(r17)     // Catch:{ Exception -> 0x006f, all -> 0x006b }
            r12 = r8
            goto L_0x0074
        L_0x006b:
            r0 = move-exception
        ...
        L_0x00e3:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p066db.C2377h.mo15902a(java.lang.String):void");
    }
    ...
    /* renamed from: c */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private synchronized boolean m5733c(java.lang.String r4) {
        /*
            r3 = this;
            monitor-enter(r3)
            r0 = 0
        ...
        L_0x0036:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p066db.C2377h.m5733c(java.lang.String):boolean");
    }
}
