...
public class C2369b extends C2365a {

    /* renamed from: a */
    private static volatile C2369b f4966a;

    private C2369b(C2374f fVar) {
        super(fVar);
    }

    /* renamed from: a */
    public static C2369b m5662a(Context context) {
        if (f4966a == null) {
            synchronized (C2369b.class) {
                if (f4966a == null) {
                    f4966a = new C2369b(C2376g.m5723a(context));
                }
            }
        }
        return f4966a;
    ...
    /* renamed from: a */
    public final void mo15849a(String str, List<CampaignEx> list) {
    ...
    /* renamed from: a */
    public final int mo15847a(String str, String str2) {
    ...
    /* renamed from: a */
    public final int mo15848a(String str, String str2, String str3) {
    ...
    public final java.util.List<com.mbridge.msdk.foundation.entity.C8402c> mo15850b(java.lang.String r9, java.lang.String r10) {
        /*
            r8 = this;
        ...
        L_0x005d:
            ...
            r10.mo57309a((java.lang.String) r1)     // Catch:{ Exception -> 0x00cf }
            r10.mo57312b((java.lang.String) r2)     // Catch:{ Exception -> 0x00cf }
            r10.mo57314c(r3)     // Catch:{ Exception -> 0x00cf }
            r10.mo57316d(r4)     // Catch:{ Exception -> 0x00cf }
            r10.mo57317e(r5)     // Catch:{ Exception -> 0x00cf }
            r10.mo57308a((int) r6)     // Catch:{ Exception -> 0x00cf }
            r10.mo57311b((int) r7)     // Catch:{ Exception -> 0x00cf }
        ...
        L_0x00cf:
            ...
            com.mbridge.msdk.foundation.tools.C8608u.m24884d(r1, r10)     // Catch:{ all -> 0x00cd }
            if (r9 == 0) goto L_0x00de
        L_0x00db:
            r9.close()
        L_0x00de:
        ...
        L_0x00e4:
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p066db.C2369b.mo15850b(java.lang.String, java.lang.String):java.util.List");
    }

    /* renamed from: a */
    public final int mo15846a(String str) {
        try {
            ...
            C8608u.m24884d("BidReplaceCampaignDao", e.getLocalizedMessage());
            return 0;
        }
    }

    /* renamed from: a */
    public final int mo15845a() {
        try {
            SQLiteDatabase writableDatabase = getWritableDatabase();
            if (writableDatabase == null) {
                return 0;
