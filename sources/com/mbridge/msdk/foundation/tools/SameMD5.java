...
public class SameMD5 implements NoProGuard {
    ...
    public static byte[] getQftJSMD5Bytes(String str) throws UnsupportedEncodingException {
        ...
        byte[] bytes = str.getBytes(C5487C.UTF16LE_NAME);
        C8608u.m24882b("----", "b = " + ByteArrayToHexString(bytes));
        ...
        C8608u.m24882b("----", "source = " + ByteArrayToHexString(bArr));
        return bArr;
    }
    ...
    private static String HexEncode(byte[] bArr) {
        ...
        for (byte b : bArr) {
            ...
            sb.append(Integer.toHexString(b & Ascii.f17944SI));
        }
