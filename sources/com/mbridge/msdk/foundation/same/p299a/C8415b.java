...
public final class C8415b implements C8416c<String, JSONObject> {

    /* renamed from: a */
    private final LinkedHashMap<String, JSONObject> f20348a;
    ...
    public final /* synthetic */ void mo15674a(Object obj) {
        ...
        if (str != null) {
            synchronized (this) {
                if (((JSONObject) this.f20348a.remove(str)) != null) {
                    this.f20350c--;
                }
            }
            return;
    ...
    public C8415b(int i) {
        if (i > 0) {
            this.f20349b = i;
            this.f20348a = new LinkedHashMap<>(0, 0.75f, true);
            return;
        }
    ...
    /* renamed from: a */
    public final JSONObject mo15677b(String str) {
        JSONObject jSONObject;
        if (str != null) {
            synchronized (this) {
                jSONObject = this.f20348a.get(str);
            }
            return jSONObject;
        }
        throw new NullPointerException("key == null");
    ...
    /* renamed from: a */
    public final boolean mo15675a(String str, JSONObject jSONObject) {
        if (str == null || jSONObject == null) {
            throw new NullPointerException("key == null || value == null");
        }
        synchronized (this) {
            this.f20350c++;
            if (((JSONObject) this.f20348a.put(str, jSONObject)) != null) {
                this.f20350c--;
            }
        }
        m24293a(this.f20349b);
        return true;
    }
    ...
    private void m24293a(int r3) {
        /*
            r2 = this;
        L_0x0000:
            monitor-enter(r2)
            int r0 = r2.f20350c     // Catch:{ all -> 0x006f }
            if (r0 < 0) goto L_0x0050
            java.util.LinkedHashMap<java.lang.String, org.json.JSONObject> r0 = r2.f20348a     // Catch:{ all -> 0x006f }
        ...
        L_0x0032:
            ...
            java.util.LinkedHashMap<java.lang.String, org.json.JSONObject> r0 = r2.f20348a     // Catch:{ all -> 0x004c }
            java.lang.Object r0 = r0.remove(r1)     // Catch:{ all -> 0x004c }
            org.json.JSONObject r0 = (org.json.JSONObject) r0     // Catch:{ all -> 0x004c }
            int r0 = r2.f20350c     // Catch:{ all -> 0x004c }
            int r0 = r0 + -1
            r2.f20350c = r0     // Catch:{ all -> 0x004c }
        L_0x004c:
            monitor-exit(r2)     // Catch:{ all -> 0x006f }
            goto L_0x0000
        L_0x004e:
        ...
        L_0x006f:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.same.p299a.C8415b.m24293a(int):void");
    }
    ...
    public final Collection<String> mo15673a() {
        HashSet hashSet;
        synchronized (this) {
            hashSet = new HashSet(this.f20348a.keySet());
        }
        return hashSet;
    }
    ...
    public final synchronized String toString() {
        return String.format("LruCache[maxSize=%d]", new Object[]{Integer.valueOf(this.f20349b)});
    }
}
