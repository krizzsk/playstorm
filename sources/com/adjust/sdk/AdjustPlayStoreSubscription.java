...
public class AdjustPlayStoreSubscription {
    ...
    public void addCallbackParameter(String str, String str2) {
        if (Util.isValidParameter(str, SDKConstants.PARAM_KEY, "Callback") && Util.isValidParameter(str2, "value", "Callback")) {
    ...
    public void addPartnerParameter(String str, String str2) {
        if (Util.isValidParameter(str, SDKConstants.PARAM_KEY, "Partner") && Util.isValidParameter(str2, "value", "Partner")) {
