...
public class AttributionHandler implements IAttributionHandler, IActivityPackageSender.ResponseDataCallbackSubscriber {
    ...
    private void checkDeeplinkI(AttributionResponseData attributionResponseData) {
        ...
        String optString;
        if (attributionResponseData.jsonResponse != null && (optJSONObject = attributionResponseData.jsonResponse.optJSONObject("attribution")) != null && (optString = optJSONObject.optString("deeplink", (String) null)) != null) {
