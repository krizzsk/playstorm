...
public class CacheDirectory {
    private static final String TEST_FILE_NAME = "SayPromoAdsTest.txt";
    ...
    public File getCacheDirectory(Context context) {
        ...
        if (Build.VERSION.SDK_INT > 18) {
            if ("mounted".equals(Environment.getExternalStorageState())) {
                ...
                if (testCacheDirectory(file)) {
                    ...
                    DeviceLog.debug("SayPromo Ads is using external cache directory: " + file.getAbsolutePath());
                    return this._cacheDirectory;
                }
            } else {
        ...
        if (testCacheDirectory(filesDir)) {
            ...
            DeviceLog.debug("SayPromo Ads is using internal cache directory: " + filesDir.getAbsolutePath());
            return this._cacheDirectory;
        }
        DeviceLog.error("SayPromo Ads failed to initialize cache directory");
        return null;
    }
    ...
    public boolean testCacheDirectory(File file) {
        if (file != null && file.isDirectory()) {
            try {
                ...
                DeviceLog.debug("SayPromo Ads exception while testing cache directory " + file.getAbsolutePath() + ": " + e.getMessage());
            }
        }
        return false;
    }
