...
public class DownloadRequest {
    ...
    public String toString() {
        return "DownloadRequest{networkType=" + this.networkType + ", priority=" + this.priority + ", url='" + this.url + '\'' + ", path='" + this.path + '\'' + ", pauseOnConnectionLost=" + this.pauseOnConnectionLost + ", id='" + this.f29329id + '\'' + ", cookieString='" + this.cookieString + '\'' + ", cancelled=" + this.cancelled + '}';
    }
    ...
    public DownloadRequest(int i, AssetPriority assetPriority, String str, String str2, boolean z, String str3) {
        ...
        this.url = str;
        this.path = str2;
        this.f29329id = UUID.nameUUIDFromBytes((str2 + "_" + str).getBytes()).toString();
