    ...
    private void buildCreators() {
        ...
        this.creators.put(Platform.class, new Creator<Platform>() {
            public Platform create() {
                return new AndroidPlatform(ServiceLocator.this.ctx, (Repository) ServiceLocator.this.getOrBuild(Repository.class), ((Executors) ServiceLocator.this.getOrBuild(Executors.class)).getUAExecutor());
            }
        });
