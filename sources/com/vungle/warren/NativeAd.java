...
import com.vungle.warren.p393ui.view.MediaView;
...
public class NativeAd {
    ...
    private void loadAd(AdConfig adConfig2, String str, NativeAdListener nativeAdListener) {
    ...
    public String getAdBodyText() {
        ...
        return map.get(TOKEN_APP_DESCRIPTION);
    }
    ...
    public String getAdCallToActionText() {
        ...
        return map.get(TOKEN_CTA_BUTTON_TEXT);
    }
    ...
    public String getAdSponsoredText() {
        ...
        return map.get(TOKEN_SPONSORED_BY);
    }
    ...
    public String getPrivacyIconUrl() {
        ...
        return map.get(TOKEN_VUNGLE_PRIVACY_ICON_URL);
    }
    ...
    public String getPrivacyUrl() {
        ...
        return map.get(TOKEN_VUNGLE_PRIVACY_URL);
    }
    ...
    public String getCtaUrl() {
        ...
        return map.get(TOKEN_CTA_BUTTON_URL);
    }

    public boolean hasCallToAction() {
        return getCtaUrl() != null;
    }
