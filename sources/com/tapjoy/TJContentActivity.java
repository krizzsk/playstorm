...
public class TJContentActivity extends Activity {
    ...
    /* renamed from: a */
    private static volatile ContentProducer f27339a;

    /* renamed from: b */
    private ContentProducer f27340b;

    /* renamed from: c */
    private boolean f27341c = false;
    ...
    public void onDestroy() {
        ContentProducer contentProducer = this.f27340b;
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        this.f27340b.onActivityResult(this, i, i2, intent);
    }
    ...
    private boolean m33056a(android.content.Intent r5) {
        /*
            r4 = this;
        ...
        L_0x000a:
            ...
            monitor-enter(r2)
            com.tapjoy.TJContentActivity$ContentProducer r3 = f27339a     // Catch:{ all -> 0x003f }
            if (r3 == 0) goto L_0x003d
            com.tapjoy.TJContentActivity$ContentProducer r3 = f27339a     // Catch:{ all -> 0x003f }
            java.lang.String r3 = toIdentityString(r3)     // Catch:{ all -> 0x003f }
            boolean r0 = r0.equals(r3)     // Catch:{ all -> 0x003f }
            if (r0 == 0) goto L_0x003d
            com.tapjoy.TJContentActivity$ContentProducer r0 = f27339a     // Catch:{ all -> 0x003f }
            r4.f27340b = r0     // Catch:{ all -> 0x003f }
            r0 = 0
            f27339a = r0     // Catch:{ all -> 0x003f }
            ...
            r5.setFlags(r0, r0)
        L_0x0036:
            com.tapjoy.TJContentActivity$ContentProducer r5 = r4.f27340b
            r5.show(r4)
            r5 = 1
            return r5
        L_0x003d:
        ...
        L_0x003f:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tapjoy.TJContentActivity.m33056a(android.content.Intent):boolean");
    }
