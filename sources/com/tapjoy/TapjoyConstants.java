...
public class TapjoyConstants {
    ...
    public static final String TJC_BRIDGE_VERSION_NUMBER = "1.0.19";
    ...
    public static final int TJC_LIBRARY_VERSION_INT = 12100;
    public static final String TJC_LIBRARY_VERSION_NUMBER = "12.10.0";
    ...
    public static final String TJC_VERSION = "12.10.0";
