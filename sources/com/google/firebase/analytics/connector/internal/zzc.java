...
public final class zzc {
    ...
    private static final List zzc = Arrays.asList(new String[]{TtmlNode.TEXT_EMPHASIS_AUTO, TapjoyConstants.TJC_APP_PLACEMENT, "am"});
    ...
    public static AnalyticsConnector.ConditionalUserProperty zzb(Bundle bundle) {
        ...
        conditionalUserProperty.name = (String) Preconditions.checkNotNull((String) zzhg.zza(bundle, "name", String.class, (Object) null));
