...
public class ComponentRuntime extends AbstractComponentContainer implements ComponentLoader {
    ...
    private ComponentRuntime(Executor executor, Iterable<Provider<ComponentRegistrar>> iterable, Collection<Component<?>> collection) {
        ...
        arrayList.add(Component.m20888of(this.eventBus, EventBus.class, Subscriber.class, Publisher.class));
        arrayList.add(Component.m20888of(this, ComponentLoader.class, new Class[0]));
    ...
    public <T> Deferred<T> getDeferred(Class<T> cls) {
        ...
        return OptionalProvider.m20889of(provider);
    }
