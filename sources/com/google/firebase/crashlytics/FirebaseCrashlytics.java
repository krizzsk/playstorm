...
public class FirebaseCrashlytics {
    ...
    static FirebaseCrashlytics init(FirebaseApp firebaseApp, FirebaseInstallationsApi firebaseInstallationsApi, Deferred<CrashlyticsNativeComponent> deferred, Deferred<AnalyticsConnector> deferred2) {
        ...
        logger.mo51965i("Initializing Firebase Crashlytics " + CrashlyticsCore.getVersion() + " for " + packageName);
        ...
        logger2.mo51961d("Mapping file ID is: " + mappingFileId);
        try {
            ...
            logger3.mo51969v("Installer package name is: " + create.installerPackageName);
            ...
            create2.loadSettingsData(buildSingleThreadExecutorService).continueWith(buildSingleThreadExecutorService, new Continuation<Void, Object>() {
                public Object then(Task<Void> task) throws Exception {
                    ...
                    Logger.getLogger().mo51964e("Error fetching settings.", task.getException());
                    return null;
                }
            });
            ...
            Logger.getLogger().mo51964e("Error retrieving app package info.", e);
            return null;
        }
    }
    ...
    public void recordException(Throwable th) {
        if (th == null) {
            Logger.getLogger().mo51971w("A null value was passed to recordException. Ignoring.");
        } else {
