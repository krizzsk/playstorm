...
public class IdManager implements InstallIdProvider {
    ...
    public synchronized String getCrashlyticsInstallId() {
        ...
        Logger.getLogger().mo51969v("Determining Crashlytics installation ID...");
        SharedPreferences sharedPrefs = CommonUtils.getSharedPrefs(this.appContext);
        String string = sharedPrefs.getString(PREFKEY_FIREBASE_IID, (String) null);
        Logger logger = Logger.getLogger();
        logger.mo51969v("Cached Firebase Installation ID: " + string);
        if (this.dataCollectionArbiter.isAutomaticDataCollectionEnabled()) {
            String fetchTrueFid = fetchTrueFid();
            Logger logger2 = Logger.getLogger();
            logger2.mo51969v("Fetched Firebase Installation ID: " + fetchTrueFid);
        ...
        if (this.crashlyticsInstallId == null) {
            Logger.getLogger().mo51971w("Unable to determine Crashlytics Install Id, creating a new one.");
            this.crashlyticsInstallId = createAndCacheCrashlyticsInstallId(createSyntheticFid(), sharedPrefs);
        }
        Logger logger3 = Logger.getLogger();
        logger3.mo51969v("Crashlytics installation ID: " + this.crashlyticsInstallId);
        return this.crashlyticsInstallId;
    }
    ...
    private String fetchTrueFid() {
        try {
            ...
            Logger.getLogger().mo51972w("Failed to retrieve Firebase Installations ID.", e);
            return null;
        }
    }
    ...
    private synchronized String createAndCacheCrashlyticsInstallId(String str, SharedPreferences sharedPreferences) {
        ...
        Logger logger = Logger.getLogger();
        logger.mo51969v("Created new Crashlytics installation ID: " + formatId + " for FID: " + str);
