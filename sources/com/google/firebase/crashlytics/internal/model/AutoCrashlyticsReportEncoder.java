...
public final class AutoCrashlyticsReportEncoder implements Configurator {
    ...
    public void configure(EncoderConfig<?> encoderConfig) {
        ...
        encoderConfig.registerEncoder((Class<U>) C7404x7e3e3ebd.class, (ObjectEncoder<? super U>) CrashlyticsReportSessionEventApplicationExecutionThreadEncoder.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame.class, (ObjectEncoder<? super U>) C7385xc3999712.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) C7406xce3d994b.class, (ObjectEncoder<? super U>) C7385xc3999712.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) CrashlyticsReport.Session.Event.Application.Execution.Exception.class, (ObjectEncoder<? super U>) C7384x55689506.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) C7400xc2f5febc.class, (ObjectEncoder<? super U>) C7384x55689506.INSTANCE);
        ...
        encoderConfig.registerEncoder((Class<U>) C7402x7c929f5b.class, (ObjectEncoder<? super U>) CrashlyticsReportSessionEventApplicationExecutionSignalEncoder.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) CrashlyticsReport.Session.Event.Application.Execution.BinaryImage.class, (ObjectEncoder<? super U>) C7383x99c932db.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) C7398xfe724d07.class, (ObjectEncoder<? super U>) C7383x99c932db.INSTANCE);
    ...
    private static final class CrashlyticsReportEncoder implements ObjectEncoder<CrashlyticsReport> {
        private static final FieldDescriptor BUILDVERSION_DESCRIPTOR = FieldDescriptor.m20901of("buildVersion");
        private static final FieldDescriptor DISPLAYVERSION_DESCRIPTOR = FieldDescriptor.m20901of("displayVersion");
        private static final FieldDescriptor GMPAPPID_DESCRIPTOR = FieldDescriptor.m20901of("gmpAppId");
        private static final FieldDescriptor INSTALLATIONUUID_DESCRIPTOR = FieldDescriptor.m20901of("installationUuid");
        static final CrashlyticsReportEncoder INSTANCE = new CrashlyticsReportEncoder();
        private static final FieldDescriptor NDKPAYLOAD_DESCRIPTOR = FieldDescriptor.m20901of("ndkPayload");
        private static final FieldDescriptor PLATFORM_DESCRIPTOR = FieldDescriptor.m20901of(TapjoyConstants.TJC_PLATFORM);
        private static final FieldDescriptor SDKVERSION_DESCRIPTOR = FieldDescriptor.m20901of(SmaatoSdk.KEY_SDK_VERSION);
        private static final FieldDescriptor SESSION_DESCRIPTOR = FieldDescriptor.m20901of("session");
    ...
    private static final class CrashlyticsReportSessionEncoder implements ObjectEncoder<CrashlyticsReport.Session> {
        private static final FieldDescriptor APP_DESCRIPTOR = FieldDescriptor.m20901of(TapjoyConstants.TJC_APP_PLACEMENT);
        private static final FieldDescriptor CRASHED_DESCRIPTOR = FieldDescriptor.m20901of("crashed");
        private static final FieldDescriptor DEVICE_DESCRIPTOR = FieldDescriptor.m20901of("device");
        private static final FieldDescriptor ENDEDAT_DESCRIPTOR = FieldDescriptor.m20901of("endedAt");
        private static final FieldDescriptor EVENTS_DESCRIPTOR = FieldDescriptor.m20901of("events");
        private static final FieldDescriptor GENERATORTYPE_DESCRIPTOR = FieldDescriptor.m20901of("generatorType");
        private static final FieldDescriptor GENERATOR_DESCRIPTOR = FieldDescriptor.m20901of("generator");
        private static final FieldDescriptor IDENTIFIER_DESCRIPTOR = FieldDescriptor.m20901of("identifier");
        static final CrashlyticsReportSessionEncoder INSTANCE = new CrashlyticsReportSessionEncoder();
        private static final FieldDescriptor OS_DESCRIPTOR = FieldDescriptor.m20901of("os");
        private static final FieldDescriptor STARTEDAT_DESCRIPTOR = FieldDescriptor.m20901of("startedAt");
        private static final FieldDescriptor USER_DESCRIPTOR = FieldDescriptor.m20901of("user");
    ...
    private static final class CrashlyticsReportSessionApplicationEncoder implements ObjectEncoder<CrashlyticsReport.Session.Application> {
        private static final FieldDescriptor DEVELOPMENTPLATFORMVERSION_DESCRIPTOR = FieldDescriptor.m20901of("developmentPlatformVersion");
        private static final FieldDescriptor DEVELOPMENTPLATFORM_DESCRIPTOR = FieldDescriptor.m20901of("developmentPlatform");
        private static final FieldDescriptor DISPLAYVERSION_DESCRIPTOR = FieldDescriptor.m20901of("displayVersion");
        private static final FieldDescriptor IDENTIFIER_DESCRIPTOR = FieldDescriptor.m20901of("identifier");
        private static final FieldDescriptor INSTALLATIONUUID_DESCRIPTOR = FieldDescriptor.m20901of("installationUuid");
        static final CrashlyticsReportSessionApplicationEncoder INSTANCE = new CrashlyticsReportSessionApplicationEncoder();
        private static final FieldDescriptor ORGANIZATION_DESCRIPTOR = FieldDescriptor.m20901of("organization");
        private static final FieldDescriptor VERSION_DESCRIPTOR = FieldDescriptor.m20901of("version");
    ...
    private static final class CrashlyticsReportSessionApplicationOrganizationEncoder implements ObjectEncoder<CrashlyticsReport.Session.Application.Organization> {
        private static final FieldDescriptor CLSID_DESCRIPTOR = FieldDescriptor.m20901of("clsId");
    ...
    private static final class CrashlyticsReportSessionOperatingSystemEncoder implements ObjectEncoder<CrashlyticsReport.Session.OperatingSystem> {
        ...
        private static final FieldDescriptor JAILBROKEN_DESCRIPTOR = FieldDescriptor.m20901of("jailbroken");
        private static final FieldDescriptor PLATFORM_DESCRIPTOR = FieldDescriptor.m20901of(TapjoyConstants.TJC_PLATFORM);
        private static final FieldDescriptor VERSION_DESCRIPTOR = FieldDescriptor.m20901of("version");
    ...
    private static final class CrashlyticsReportSessionDeviceEncoder implements ObjectEncoder<CrashlyticsReport.Session.Device> {
        private static final FieldDescriptor ARCH_DESCRIPTOR = FieldDescriptor.m20901of("arch");
        private static final FieldDescriptor CORES_DESCRIPTOR = FieldDescriptor.m20901of("cores");
        private static final FieldDescriptor DISKSPACE_DESCRIPTOR = FieldDescriptor.m20901of("diskSpace");
        static final CrashlyticsReportSessionDeviceEncoder INSTANCE = new CrashlyticsReportSessionDeviceEncoder();
        private static final FieldDescriptor MANUFACTURER_DESCRIPTOR = FieldDescriptor.m20901of("manufacturer");
        private static final FieldDescriptor MODELCLASS_DESCRIPTOR = FieldDescriptor.m20901of("modelClass");
        private static final FieldDescriptor MODEL_DESCRIPTOR = FieldDescriptor.m20901of(DeviceRequestsHelper.DEVICE_INFO_MODEL);
        private static final FieldDescriptor RAM_DESCRIPTOR = FieldDescriptor.m20901of("ram");
        private static final FieldDescriptor SIMULATOR_DESCRIPTOR = FieldDescriptor.m20901of("simulator");
        private static final FieldDescriptor STATE_DESCRIPTOR = FieldDescriptor.m20901of("state");
    ...
    private static final class CrashlyticsReportSessionEventEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event> {
        ...
        private static final FieldDescriptor LOG_DESCRIPTOR = FieldDescriptor.m20901of("log");
        private static final FieldDescriptor TIMESTAMP_DESCRIPTOR = FieldDescriptor.m20901of("timestamp");
        private static final FieldDescriptor TYPE_DESCRIPTOR = FieldDescriptor.m20901of("type");
    ...
    private static final class CrashlyticsReportSessionEventApplicationEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application> {
        private static final FieldDescriptor BACKGROUND_DESCRIPTOR = FieldDescriptor.m20901of("background");
        private static final FieldDescriptor CUSTOMATTRIBUTES_DESCRIPTOR = FieldDescriptor.m20901of("customAttributes");
        private static final FieldDescriptor EXECUTION_DESCRIPTOR = FieldDescriptor.m20901of("execution");
        static final CrashlyticsReportSessionEventApplicationEncoder INSTANCE = new CrashlyticsReportSessionEventApplicationEncoder();
        private static final FieldDescriptor INTERNALKEYS_DESCRIPTOR = FieldDescriptor.m20901of("internalKeys");
        private static final FieldDescriptor UIORIENTATION_DESCRIPTOR = FieldDescriptor.m20901of("uiOrientation");
    ...
    private static final class CrashlyticsReportSessionEventApplicationExecutionEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution> {
        private static final FieldDescriptor APPEXITINFO_DESCRIPTOR = FieldDescriptor.m20901of("appExitInfo");
        private static final FieldDescriptor BINARIES_DESCRIPTOR = FieldDescriptor.m20901of("binaries");
        private static final FieldDescriptor EXCEPTION_DESCRIPTOR = FieldDescriptor.m20901of("exception");
        static final CrashlyticsReportSessionEventApplicationExecutionEncoder INSTANCE = new CrashlyticsReportSessionEventApplicationExecutionEncoder();
        private static final FieldDescriptor SIGNAL_DESCRIPTOR = FieldDescriptor.m20901of("signal");
        private static final FieldDescriptor THREADS_DESCRIPTOR = FieldDescriptor.m20901of("threads");
    ...
    private static final class CrashlyticsReportSessionEventApplicationExecutionThreadEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Thread> {
        private static final FieldDescriptor FRAMES_DESCRIPTOR = FieldDescriptor.m20901of(CampaignUnit.JSON_KEY_FRAME_ADS);
        private static final FieldDescriptor IMPORTANCE_DESCRIPTOR = FieldDescriptor.m20901of("importance");
        static final CrashlyticsReportSessionEventApplicationExecutionThreadEncoder INSTANCE = new CrashlyticsReportSessionEventApplicationExecutionThreadEncoder();
        private static final FieldDescriptor NAME_DESCRIPTOR = FieldDescriptor.m20901of("name");
    ...
    private static final class C7385xc3999712 implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> {
        private static final FieldDescriptor FILE_DESCRIPTOR = FieldDescriptor.m20901of(ShareInternalUtility.STAGING_PARAM);
        private static final FieldDescriptor IMPORTANCE_DESCRIPTOR = FieldDescriptor.m20901of("importance");
        static final C7385xc3999712 INSTANCE = new C7385xc3999712();
        private static final FieldDescriptor OFFSET_DESCRIPTOR = FieldDescriptor.m20901of("offset");
        private static final FieldDescriptor PC_DESCRIPTOR = FieldDescriptor.m20901of("pc");
        private static final FieldDescriptor SYMBOL_DESCRIPTOR = FieldDescriptor.m20901of("symbol");

        private C7385xc3999712() {
        }
    ...
    private static final class C7384x55689506 implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Exception> {
        private static final FieldDescriptor CAUSEDBY_DESCRIPTOR = FieldDescriptor.m20901of("causedBy");
        private static final FieldDescriptor FRAMES_DESCRIPTOR = FieldDescriptor.m20901of(CampaignUnit.JSON_KEY_FRAME_ADS);
        static final C7384x55689506 INSTANCE = new C7384x55689506();
        private static final FieldDescriptor OVERFLOWCOUNT_DESCRIPTOR = FieldDescriptor.m20901of("overflowCount");
        private static final FieldDescriptor REASON_DESCRIPTOR = FieldDescriptor.m20901of(IronSourceConstants.EVENTS_ERROR_REASON);
        private static final FieldDescriptor TYPE_DESCRIPTOR = FieldDescriptor.m20901of("type");

        private C7384x55689506() {
        }
    ...
    private static final class CrashlyticsReportApplicationExitInfoEncoder implements ObjectEncoder<CrashlyticsReport.ApplicationExitInfo> {
        ...
        private static final FieldDescriptor PID_DESCRIPTOR = FieldDescriptor.m20901of("pid");
        private static final FieldDescriptor PROCESSNAME_DESCRIPTOR = FieldDescriptor.m20901of("processName");
        private static final FieldDescriptor PSS_DESCRIPTOR = FieldDescriptor.m20901of("pss");
        private static final FieldDescriptor REASONCODE_DESCRIPTOR = FieldDescriptor.m20901of("reasonCode");
        private static final FieldDescriptor RSS_DESCRIPTOR = FieldDescriptor.m20901of("rss");
        private static final FieldDescriptor TIMESTAMP_DESCRIPTOR = FieldDescriptor.m20901of("timestamp");
        private static final FieldDescriptor TRACEFILE_DESCRIPTOR = FieldDescriptor.m20901of("traceFile");
    ...
    private static final class CrashlyticsReportSessionEventApplicationExecutionSignalEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.Signal> {
        private static final FieldDescriptor ADDRESS_DESCRIPTOR = FieldDescriptor.m20901of(IntegrityManager.INTEGRITY_TYPE_ADDRESS);
        private static final FieldDescriptor CODE_DESCRIPTOR = FieldDescriptor.m20901of("code");
    ...
    private static final class C7383x99c932db implements ObjectEncoder<CrashlyticsReport.Session.Event.Application.Execution.BinaryImage> {
        private static final FieldDescriptor BASEADDRESS_DESCRIPTOR = FieldDescriptor.m20901of("baseAddress");
        static final C7383x99c932db INSTANCE = new C7383x99c932db();
        private static final FieldDescriptor NAME_DESCRIPTOR = FieldDescriptor.m20901of("name");
        private static final FieldDescriptor SIZE_DESCRIPTOR = FieldDescriptor.m20901of("size");
        private static final FieldDescriptor UUID_DESCRIPTOR = FieldDescriptor.m20901of("uuid");

        private C7383x99c932db() {
        }
    ...
    private static final class CrashlyticsReportCustomAttributeEncoder implements ObjectEncoder<CrashlyticsReport.CustomAttribute> {
        ...
        private static final FieldDescriptor KEY_DESCRIPTOR = FieldDescriptor.m20901of(SDKConstants.PARAM_KEY);
        private static final FieldDescriptor VALUE_DESCRIPTOR = FieldDescriptor.m20901of("value");
    ...
    private static final class CrashlyticsReportSessionEventDeviceEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Device> {
        private static final FieldDescriptor BATTERYLEVEL_DESCRIPTOR = FieldDescriptor.m20901of("batteryLevel");
        private static final FieldDescriptor BATTERYVELOCITY_DESCRIPTOR = FieldDescriptor.m20901of("batteryVelocity");
        private static final FieldDescriptor DISKUSED_DESCRIPTOR = FieldDescriptor.m20901of("diskUsed");
        static final CrashlyticsReportSessionEventDeviceEncoder INSTANCE = new CrashlyticsReportSessionEventDeviceEncoder();
        private static final FieldDescriptor ORIENTATION_DESCRIPTOR = FieldDescriptor.m20901of("orientation");
        private static final FieldDescriptor PROXIMITYON_DESCRIPTOR = FieldDescriptor.m20901of("proximityOn");
        private static final FieldDescriptor RAMUSED_DESCRIPTOR = FieldDescriptor.m20901of("ramUsed");
    ...
    private static final class CrashlyticsReportSessionEventLogEncoder implements ObjectEncoder<CrashlyticsReport.Session.Event.Log> {
        private static final FieldDescriptor CONTENT_DESCRIPTOR = FieldDescriptor.m20901of("content");
    ...
    private static final class CrashlyticsReportFilesPayloadEncoder implements ObjectEncoder<CrashlyticsReport.FilesPayload> {
        private static final FieldDescriptor FILES_DESCRIPTOR = FieldDescriptor.m20901of("files");
        static final CrashlyticsReportFilesPayloadEncoder INSTANCE = new CrashlyticsReportFilesPayloadEncoder();
        private static final FieldDescriptor ORGID_DESCRIPTOR = FieldDescriptor.m20901of("orgId");
    ...
    private static final class CrashlyticsReportFilesPayloadFileEncoder implements ObjectEncoder<CrashlyticsReport.FilesPayload.File> {
        private static final FieldDescriptor CONTENTS_DESCRIPTOR = FieldDescriptor.m20901of("contents");
        private static final FieldDescriptor FILENAME_DESCRIPTOR = FieldDescriptor.m20901of("filename");
