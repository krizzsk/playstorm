...
public class CachedSettingsIo {
    ...
    public JSONObject readCachedSettings() {
        ...
        Logger.getLogger().mo51961d("Checking for cached settings...");
        ...
        try {
            ...
            if (settingsFile.exists()) {
                ...
                try {
                    ...
                    e = e;
                    try {
                        Logger.getLogger().mo51964e("Failed to fetch cached settings", e);
                ...
                Logger.getLogger().mo51969v("Settings file does not exist.");
                jSONObject = null;
            }
    ...
    public void writeCachedSettings(long j, JSONObject jSONObject) {
        Logger.getLogger().mo51969v("Writing settings to cache file...");
        if (jSONObject != null) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        Logger.getLogger().mo51964e("Failed to cache settings", e);
