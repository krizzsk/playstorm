...
final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f18039FS = '\u001c';

    /* renamed from: GS */
    private static final char f18040GS = '\u001d';
    private static final char LATCHA = '￷';
    private static final char LATCHB = '￸';
    private static final char LOCK = '￹';

    /* renamed from: NS */
    private static final char f18041NS = '￻';
    private static final char PAD = '￼';

    /* renamed from: RS */
    private static final char f18042RS = '\u001e';
    ...
    static DecoderResult decode(byte[] bArr, int i) {
        ...
        if (i == 2 || i == 3) {
            ...
            if (sb.toString().startsWith("[)>\u001e01\u001d")) {
                sb.insert(9, str + f18040GS + format + f18040GS + format2 + f18040GS);
            } else {
                sb.insert(0, str + f18040GS + format + f18040GS + format2 + f18040GS);
            }
        } else if (i == 4) {
    ...
    private static int getPostCode2Length(byte[] bArr) {
        return getInt(bArr, new byte[]{39, 40, 41, 42, Ascii.f17947US, 32});
    }

    private static int getPostCode2(byte[] bArr) {
        return getInt(bArr, new byte[]{33, 34, 35, 36, Ascii.f17936EM, Ascii.SUB, Ascii.ESC, Ascii.f17938FS, Ascii.f17939GS, Ascii.f17943RS, 19, Ascii.DC4, Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, Ascii.f17935CR, Ascii.f17945SO, Ascii.f17944SI, Ascii.DLE, 17, Ascii.DC2, 7, 8, 9, 10, Ascii.f17948VT, Ascii.f17937FF, 1, 2});
    }

    private static String getPostCode3(byte[] bArr) {
        return String.valueOf(new char[]{SETS[0].charAt(getInt(bArr, new byte[]{39, 40, 41, 42, Ascii.f17947US, 32})), SETS[0].charAt(getInt(bArr, new byte[]{33, 34, 35, 36, Ascii.f17936EM, Ascii.SUB})), SETS[0].charAt(getInt(bArr, new byte[]{Ascii.ESC, Ascii.f17938FS, Ascii.f17939GS, Ascii.f17943RS, 19, Ascii.DC4})), SETS[0].charAt(getInt(bArr, new byte[]{Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, Ascii.f17935CR, Ascii.f17945SO})), SETS[0].charAt(getInt(bArr, new byte[]{Ascii.f17944SI, Ascii.DLE, 17, Ascii.DC2, 7, 8})), SETS[0].charAt(getInt(bArr, new byte[]{9, 10, Ascii.f17948VT, Ascii.f17937FF, 1, 2}))});
    }
