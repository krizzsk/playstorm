                        ...
                        while (xmlPullParser.next() != 3) {
                            if (xmlPullParser.getEventType() == 2) {
                                if (xmlPullParser.getName().equals("module")) {
                                    String zzb = zzb("name", xmlPullParser, zzi);
                                    if (zzb != null) {
                                        while (xmlPullParser.next() != 3) {
                                            if (xmlPullParser.getEventType() == 2) {
                                                    ...
                                                    while (xmlPullParser.next() != 3) {
                                                        if (xmlPullParser.getEventType() == 2) {
                                                            if (xmlPullParser.getName().equals("entry")) {
                                                                String zzb2 = zzb(SDKConstants.PARAM_KEY, xmlPullParser, zzi);
                                                                String zzb3 = zzb(TJAdUnitConstants.String.STYLE_SPLIT, xmlPullParser, zzi);
