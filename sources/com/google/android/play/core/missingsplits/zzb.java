...
final class zzb implements MissingSplitsManager {
    ...
    public final boolean disableAppIfMissingRequiredSplits() {
        /*
            ...
            monitor-enter(r0)
            java.util.concurrent.atomic.AtomicReference r3 = r8.zze     // Catch:{ all -> 0x01d0 }
            java.lang.Object r3 = r3.get()     // Catch:{ all -> 0x01d0 }
            java.lang.Boolean r3 = (java.lang.Boolean) r3     // Catch:{ all -> 0x01d0 }
            r4 = 1
            if (r3 != 0) goto L_0x00b6
            java.util.concurrent.atomic.AtomicReference r3 = r8.zze     // Catch:{ all -> 0x01d0 }
            int r5 = android.os.Build.VERSION.SDK_INT     // Catch:{ all -> 0x01d0 }
            if (r5 >= r1) goto L_0x001e
        L_0x001b:
            r1 = r2
            goto L_0x00af
        L_0x001e:
            android.content.Context r5 = r8.zzb     // Catch:{ all -> 0x01d0 }
            android.content.pm.PackageManager r5 = r5.getPackageManager()     // Catch:{ all -> 0x01d0 }
            ...
            java.util.Set r1 = java.util.Collections.emptySet()     // Catch:{ all -> 0x01d0 }
            goto L_0x0086
        L_0x004f:
        ...
        L_0x006f:
            ...
            goto L_0x0086
        L_0x0071:
            com.google.android.play.core.internal.zzag r1 = zza     // Catch:{ all -> 0x01d0 }
            java.lang.Object[] r5 = new java.lang.Object[r4]     // Catch:{ all -> 0x01d0 }
            android.content.Context r6 = r8.zzb     // Catch:{ all -> 0x01d0 }
            java.lang.String r6 = r6.getPackageName()     // Catch:{ all -> 0x01d0 }
            r5[r2] = r6     // Catch:{ all -> 0x01d0 }
            java.lang.String r6 = "App '%s' is not found in PackageManager"
            r1.zze(r6, r5)     // Catch:{ all -> 0x01d0 }
            java.util.Set r1 = java.util.Collections.emptySet()     // Catch:{ all -> 0x01d0 }
        L_0x0086:
            boolean r5 = r1.isEmpty()     // Catch:{ all -> 0x01d0 }
            if (r5 != 0) goto L_0x009a
            int r5 = r1.size()     // Catch:{ all -> 0x01d0 }
            if (r5 != r4) goto L_0x001b
            java.lang.String r5 = ""
            boolean r1 = r1.contains(r5)     // Catch:{ all -> 0x01d0 }
        ...
        L_0x009c:
            ...
            goto L_0x001b
        L_0x00af:
            java.lang.Boolean r1 = java.lang.Boolean.valueOf(r1)     // Catch:{ all -> 0x01d0 }
            r3.set(r1)     // Catch:{ all -> 0x01d0 }
        L_0x00b6:
            java.util.concurrent.atomic.AtomicReference r1 = r8.zze     // Catch:{ all -> 0x01d0 }
            java.lang.Object r1 = r1.get()     // Catch:{ all -> 0x01d0 }
            java.lang.Boolean r1 = (java.lang.Boolean) r1     // Catch:{ all -> 0x01d0 }
            boolean r1 = r1.booleanValue()     // Catch:{ all -> 0x01d0 }
        ...
        L_0x0159:
            ...
            r5.zze(r3, r6)
            android.content.Context r3 = r8.zzb     // Catch:{ NameNotFoundException -> 0x0117 }
            android.content.pm.PackageManager r3 = r3.getPackageManager()     // Catch:{ NameNotFoundException -> 0x0117 }
            android.content.pm.ActivityInfo r1 = r3.getActivityInfo(r1, r2)     // Catch:{ NameNotFoundException -> 0x0117 }
            if (r1 == 0) goto L_0x0117
            goto L_0x014d
        L_0x0171:
            r0 = r2
