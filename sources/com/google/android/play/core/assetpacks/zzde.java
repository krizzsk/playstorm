...
final class zzde {
    ...
    public final /* synthetic */ Boolean zza(Bundle bundle) {
        ...
        return Boolean.valueOf(!zzbg.zzc(zzdb.zzc.zzd, bundle.getInt(zzb.zza("status", zzs(bundle)))));
    }
    ...
    public final /* synthetic */ Boolean zzb(Bundle bundle) {
        ...
        if (map.containsKey(valueOf)) {
            zzdb zzq = zzq(i);
            int i2 = bundle2.getInt(zzb.zza("status", zzq.zzc.zza));
            zzda zzda = zzq.zzc;
            int i3 = zzda.zzd;
            if (zzbg.zzc(i3, i2)) {
            ...
            int i6 = bundle2.getInt(zzb.zza("status", zzs));
