            ...
            if (zzj == null) {
                ...
                try {
                    ...
                    if (zzlq == null || zzlq.zze == null) {
                        zzlq zzlq2 = new zzlq(zzt, TtmlNode.TEXT_EMPHASIS_AUTO, "_lte", zzr.zzs.zzav().currentTimeMillis(), 0L);
                        zzu2.add(zzlq2);
                    ...
                    if (zzu3.zzs.zzg().zze()) {
                        ...
                        if (zzj.zzai() && zzu3.zzf.zzo().zzn(zzt2)) {
                            ...
                            zzu2.add(new zzlq(zzt2, TtmlNode.TEXT_EMPHASIS_AUTO, "_npa", zzu3.zzs.zzav().currentTimeMillis(), 1L));
                        }
                    }
                    ...
                    zzgb2.zzah(Boolean.TRUE.booleanValue());
                    zzfz zzfz2 = zzfz;
                    zzfz2.zza(zzgb2);
                    zzh zzh3 = zzh;
                    zzh3.zzac(zzgb2.zzd());
