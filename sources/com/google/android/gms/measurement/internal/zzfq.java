...
final class zzfq implements Runnable {
    ...
    public final void run() {
        ...
        bundle2.putString(CampaignEx.JSON_KEY_PACKAGE_NAME, zza2);
        try {
                ...
                if (string == null || string.isEmpty()) {
                    ...
                    if (zzs2 == null) {
                        ...
                        if (zzfs.zza.zzJ()) {
                            ...
                            zzfs.zza.zzq().zzG(TtmlNode.TEXT_EMPHASIS_AUTO, Constants.ScionAnalytics.EVENT_FIREBASE_CAMPAIGN, zzs2, zza2);
                        }
                    }
                }
            }
