...
final class zzkt {
    ...
    public final void zzc(long j, boolean z) {
        ...
        if (this.zza.zzs.zzJ()) {
            ...
            this.zza.zzs.zzq().zzaa(TtmlNode.TEXT_EMPHASIS_AUTO, "_sid", valueOf, j);
            ...
            this.zza.zzs.zzq().zzI(TtmlNode.TEXT_EMPHASIS_AUTO, "_s", j, bundle);
            zzoc.zzc();
            if (this.zza.zzs.zzf().zzs((String) null, zzen.zzad)) {
                ...
                if (!TextUtils.isEmpty(zza2)) {
                    ...
                    this.zza.zzs.zzq().zzI(TtmlNode.TEXT_EMPHASIS_AUTO, "_ssr", j, bundle2);
                }
            }
        }
    }
