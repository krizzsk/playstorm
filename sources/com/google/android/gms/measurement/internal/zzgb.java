...
public final class zzgb extends zzkz implements zzaf {
    ...
    public final boolean zzv(String str) {
        zzg();
        zzC(str);
        if (this.zza.get(str) == null || (!((Set) this.zza.get(str)).contains("device_model") && !((Set) this.zza.get(str)).contains(DeviceRequestsHelper.DEVICE_INFO_PARAM))) {
            return false;
        }
        return true;
    }
    ...
    public final boolean zzy(String str) {
        zzg();
        zzC(str);
        if (this.zza.get(str) == null || (!((Set) this.zza.get(str)).contains(TapjoyConstants.TJC_DEVICE_OS_VERSION_NAME) && !((Set) this.zza.get(str)).contains(DeviceRequestsHelper.DEVICE_INFO_PARAM))) {
            return false;
        }
        return true;
    }
