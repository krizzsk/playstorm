...
public final class zzln extends zzkz {
        ...
        if (list != null) {
            ...
            while (it.hasNext()) {
                ...
                if (zzfw != null) {
                    ...
                    sb.append("param {\n");
                    Double d = null;
                    zzI(sb, i2, "name", zzfw.zzx() ? this.zzs.zzj().zze(zzfw.zzg()) : null);
    ...
    public final String zzm(zzga zzga) {
        ...
        for (zzgc zzgc : zzga.zzd()) {
            if (zzgc != null) {
                ...
                zzI(sb, 1, TapjoyConstants.TJC_PLATFORM, zzgc.zzJ());
                if (zzgc.zzbi()) {
                ...
                zzI(sb, 1, TapjoyConstants.TJC_APP_VERSION_NAME, zzgc.zzB());
                if (zzgc.zzbb()) {
                ...
                zzI(sb, 1, TapjoyConstants.TJC_DEVICE_OS_VERSION_NAME, zzgc.zzI());
                ...
                if (zzP != null) {
                    for (zzgl zzgl : zzP) {
                        if (zzgl != null) {
                            ...
                            zzI(sb, 2, "name", this.zzs.zzj().zzf(zzgl.zzf()));
                ...
                if (zzO != null) {
                    for (zzfs zzfs : zzO) {
                        if (zzfs != null) {
                            zzF(sb, 2);
                            sb.append("event {\n");
                            zzI(sb, 2, "name", this.zzs.zzj().zzd(zzfs.zzh()));
                            if (zzfs.zzu()) {
    ...
    public final String zzo(zzej zzej) {
        ...
        zzI(sb, 0, TJAdUnitConstants.PARAM_PLACEMENT_NAME, this.zzs.zzj().zzd(zzej.zzg()));
