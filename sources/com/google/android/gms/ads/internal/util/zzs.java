...
public final class zzs {
    ...
    public static final String zzv() {
        ...
        return zzd2 != null ? zzd2.getString(C5745R.string.f14504s7) : "Test Ad";
    }
    ...
    public final int zzk(Context context, Uri uri) {
        ...
        if (true == ((Boolean) zzay.zzc().zzb(zzbhy.zzdC)).equals(zzay.zzc().zzb(zzbhy.zzdD))) {
            i = 9;
        }
        if (i != 0) {
        ...
        if (!((Boolean) zzay.zzc().zzb(zzbhy.zzdD)).booleanValue()) {
            return 5;
        }
