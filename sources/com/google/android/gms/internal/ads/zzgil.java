    ...
    public static byte[] zza(byte[] bArr, byte[] bArr2) throws InvalidKeyException {
        ...
        if (bArr3.length == 32) {
            ...
            if (bArr4.length == 32) {
                ...
                int i2 = 0;
                while (i2 < 7) {
                    if (!zzghf.zzb(zzghh.zza[i2], copyOf2)) {
                        i2++;
                    } else {
                        throw new InvalidKeyException("Banned public key: ".concat(zzgia.zza(zzghh.zza[i2])));
                    }
                }
                ...
                while (i4 < i5) {
                    ...
                    while (i6 < 8) {
                        int i7 = (b2 >> (7 - i6)) & 1;
                        zzghh.zza(jArr4, jArr2, i7);
                        zzghh.zza(jArr5, jArr3, i7);
                        byte[] bArr5 = copyOf;
                        ...
                        zzghz.zzd(jArr20);
                        int i11 = i10;
                        zzghh.zza(jArr8, jArr6, i11);
                        zzghh.zza(jArr20, jArr7, i11);
                        i6 = i9 + 1;
                        byte[] bArr6 = bArr2;
                        jArr9 = jArr5;
                        jArr2 = jArr6;
