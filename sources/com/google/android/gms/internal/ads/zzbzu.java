...
public final class zzbzu extends AbstractSafeParcelable {
    ...
    public zzbzu(Bundle bundle, zzcfo zzcfo, ApplicationInfo applicationInfo, String str, List list, PackageInfo packageInfo, String str2, String str3, zzfdu zzfdu, String str4) {
        this.zza = bundle;
        this.zzb = zzcfo;
        this.zzd = str;
