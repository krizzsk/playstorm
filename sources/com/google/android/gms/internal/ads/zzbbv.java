...
public final class zzbbv {
    ...
    public static void zzc(String[] strArr, int i, int i2, PriorityQueue priorityQueue) {
        ...
        while (true) {
            ...
            if (i3 < length2 - 5) {
                zze = ((((((zze + 1073807359) - ((((((long) zzbbr.zza(strArr2[i3 - 1])) + 2147483647L) % 1073807359) * zza) % 1073807359)) % 1073807359) * 16785407) % 1073807359) + ((((long) zzbbr.zza(strArr2[i3 + 5])) + 2147483647L) % 1073807359)) % 1073807359;
    ...
    private static long zze(String[] strArr, int i, int i2) {
        ...
        for (int i3 = 1; i3 < i2; i3++) {
            zza = (((zza * 16785407) % 1073807359) + ((((long) zzbbr.zza(strArr[i3])) + 2147483647L) % 1073807359)) % 1073807359;
        }
        return zza;
    }
}
