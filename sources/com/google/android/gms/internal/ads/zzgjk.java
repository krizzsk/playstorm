...
final class zzgjk extends zzgjo {
    ...
    /* synthetic */ zzgjk(Iterable iterable, int i, boolean z, zzgjj zzgjj) {
        super((zzgjn) null);
        this.zzh = i;
        this.zze = iterable;
    ...
    public final int zzi() throws IOException {
        ...
        if (j - j2 >= 4) {
            this.zzm = 4 + j2;
            zza = (zzgns.zza(j2) & 255) | ((zzgns.zza(1 + j2) & 255) << 8) | ((zzgns.zza(2 + j2) & 255) << Ascii.DLE);
            zza2 = zzgns.zza(j2 + 3);
        } else {
    ...
    public final long zzq() throws IOException {
        ...
        if (j - j2 >= 8) {
            this.zzm = 8 + j2;
            return ((((long) zzgns.zza(j2 + 7)) & 255) << 56) | (((long) zzgns.zza(j2)) & 255) | ((((long) zzgns.zza(1 + j2)) & 255) << 8) | ((((long) zzgns.zza(2 + j2)) & 255) << 16) | ((((long) zzgns.zza(3 + j2)) & 255) << 24) | ((((long) zzgns.zza(4 + j2)) & 255) << 32) | ((((long) zzgns.zza(5 + j2)) & 255) << 40) | ((((long) zzgns.zza(6 + j2)) & 255) << 48);
        }
        ...
        if (this.zzo != j4) {
            ...
            if (zza >= 0) {
                ...
                if (zza2 < 0) {
                    ...
                    long j7 = j6 + 1;
                    byte zza3 = zza2 ^ (zzgns.zza(j6) << Ascii.f17945SO);
                    if (zza3 >= 0) {
                        j = (long) (zza3 ^ 16256);
                    } else {
                        j6 = j7 + 1;
                        byte zza4 = zza3 ^ (zzgns.zza(j7) << Ascii.NAK);
                        if (zza4 < 0) {
                            b = zza4 ^ -2080896;
                        } else {
                            j7 = j6 + 1;
