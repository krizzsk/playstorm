...
public final class zzgp {
    ...
    /* synthetic */ zzgp(float f, float f2, long j, float f3, long j2, long j3, float f4, zzgo zzgo) {
        this.zza = j2;
        this.zzb = j3;
    }
    ...
    public final float zza(long j, long j2) {
        ...
        if (this.zzh > j6) {
            ...
            long zzr = zzeg.zzr(j - ((long) (Math.max(0.0f, this.zzk - 4.0f) / 1.0E-7f)), this.zzh, j6);
            this.zzh = zzr;
            long j8 = this.zzg;
        ...
        float zza2 = zzeg.zza((((float) j9) * 1.0E-7f) + 1.0f, this.zzj, this.zzi);
        this.zzk = zza2;
        return zza2;
    }
}
