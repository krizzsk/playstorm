...
final class zzaju {
    ...
    zzaju(java.lang.String r14, com.google.android.gms.internal.ads.zzaik r15) {
        /*
            r13 = this;
    ...
    static zzaju zza(zzajv zzajv) throws IOException {
        if (zzajx.zze(zzajv) == 538247942) {
            ...
            if (zze2 >= 0) {
                ...
                for (int i = 0; i < zze2; i++) {
                    emptyList.add(new zzait(zzajx.zzh(zzajv).intern(), zzajx.zzh(zzajv).intern()));
                }
                return new zzaju(zzh2, zzh3, zzf2, zzf3, zzf4, zzf5, emptyList);
            }
