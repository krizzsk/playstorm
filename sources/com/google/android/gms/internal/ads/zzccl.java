...
public final class zzccl implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    zzccl(Context context, zzg zzg, zzcdn zzcdn) {
    ...
    public final void zza() {
        ...
        if (((Boolean) zzay.zzc().zzb(zzbhy.zzav)).booleanValue()) {
            onSharedPreferenceChanged(this.zzb, CmpApiConstants.IABTCF_GDPR_APPLIES);
            onSharedPreferenceChanged(this.zzb, CmpApiConstants.IABTCF_TC_STRING);
            return;
        }
