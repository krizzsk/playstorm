...
public class EventLogger implements AnalyticsListener {
            ...
            if (trackGroups.length == 0) {
                ...
                while (i3 < trackGroups.length) {
                    ...
                    while (i4 < trackGroup.length) {
                        ...
                        String formatSupportString = C5487C.getFormatSupportString(currentMappedTrackInfo.getTrackSupport(i, i3, i4));
        ...
        if (unmappedTrackGroups.length > 0) {
            ...
            while (i6 < unmappedTrackGroups.length) {
                ...
                while (i7 < trackGroup3.length) {
                    ...
                    String formatSupportString2 = C5487C.getFormatSupportString(0);
    ...
    public void logd(String str) {
        Log.m16943d(this.tag, str);
    }

    /* access modifiers changed from: protected */
    public void loge(String str) {
        Log.m16945e(this.tag, str);
    }
