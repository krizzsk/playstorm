...
class SampleDataQueue {
    ...
    private static AllocationNode readEncryptionData(AllocationNode allocationNode, DecoderInputBuffer decoderInputBuffer, SampleQueue.SampleExtrasHolder sampleExtrasHolder, ParsableByteArray parsableByteArray) {
        ...
        if (cryptoInfo.f14462iv == null) {
            cryptoInfo.f14462iv = new byte[16];
        } else {
            Arrays.fill(cryptoInfo.f14462iv, (byte) 0);
        }
        AllocationNode readData2 = readData(readData, j2, cryptoInfo.f14462iv, (int) b2);
        long j3 = j2 + ((long) b2);
        if (z) {
        ...
        cryptoInfo.set(i2, iArr2, iArr4, cryptoData.encryptionKey, cryptoInfo.f14462iv, cryptoData.cryptoMode, cryptoData.encryptedBlocks, cryptoData.clearBlocks);
