...
public class DefaultDashChunkSource implements DashChunkSource {
    ...
    public DefaultDashChunkSource(ChunkExtractor.Factory factory, LoaderErrorThrower loaderErrorThrower, DashManifest dashManifest, BaseUrlExclusionList baseUrlExclusionList2, int i, int[] iArr, ExoTrackSelection exoTrackSelection, int i2, DataSource dataSource2, long j, int i3, boolean z, List<Format> list, PlayerEmsgHandler.PlayerTrackEmsgHandler playerTrackEmsgHandler2) {
        ...
        while (i5 < this.representationHolders.length) {
            ...
            int i6 = i5;
            representationHolderArr[i6] = new RepresentationHolder(periodDurationUs, representation, selectBaseUrl, BundledChunkExtractor.FACTORY.createProgressiveMediaExtractor(i2, representation.format, z, list, playerTrackEmsgHandler2), 0, representation.getIndex());
            i5 = i6 + 1;
        }
    }
    ...
    public void getNextChunk(long j, long j2, List<? extends MediaChunk> list, ChunkHolder chunkHolder) {
        ...
        if (defaultDashChunkSource.fatalError == null) {
            long j5 = j2 - j4;
            long msToUs = C5487C.msToUs(defaultDashChunkSource.manifest.availabilityStartTimeMs) + C5487C.msToUs(defaultDashChunkSource.manifest.getPeriod(defaultDashChunkSource.periodIndex).startMs) + j2;
            ...
            if (playerTrackEmsgHandler2 == null || !playerTrackEmsgHandler2.maybeRefreshManifestBeforeLoadingNextChunk(msToUs)) {
                long msToUs2 = C5487C.msToUs(Util.getNowUnixTimeMs(defaultDashChunkSource.elapsedRealtimeOffsetMs));
                ...
                RepresentationHolder updateSelectedBaseUrl = defaultDashChunkSource.updateSelectedBaseUrl(defaultDashChunkSource.trackSelection.getSelectedIndex());
                if (updateSelectedBaseUrl.chunkExtractor != null) {
                    ...
                    if (!(initializationUri == null && indexUri == null)) {
                        chunkHolder2.chunk = newInitializationChunk(updateSelectedBaseUrl, defaultDashChunkSource.dataSource, defaultDashChunkSource.trackSelection.getSelectedFormat(), defaultDashChunkSource.trackSelection.getSelectionReason(), defaultDashChunkSource.trackSelection.getSelectionData(), initializationUri, indexUri);
                        return;
                    }
                }
                ...
                long firstAvailableSegmentNum2 = updateSelectedBaseUrl.getFirstAvailableSegmentNum(j6);
                long lastAvailableSegmentNum2 = updateSelectedBaseUrl.getLastAvailableSegmentNum(j6);
                boolean z4 = z3;
                ...
                if (i5 > 0 || (defaultDashChunkSource.missingLastSegment && i5 >= 0)) {
                    chunkHolder.endOfStream = z4;
                } else if (!z4 || updateSelectedBaseUrl.getSegmentStartTimeUs(segmentNum2) < access$000) {
                    ...
                    chunkHolder3.chunk = newMediaChunk(updateSelectedBaseUrl, defaultDashChunkSource.dataSource, defaultDashChunkSource.trackType, defaultDashChunkSource.trackSelection.getSelectedFormat(), defaultDashChunkSource.trackSelection.getSelectionReason(), defaultDashChunkSource.trackSelection.getSelectionData(), segmentNum2, i6, j7, nowPeriodTimeUs);
                } else {
    ...
    private long getNowPeriodTimeUs(long j) {
        ...
        return j - C5487C.msToUs(this.manifest.availabilityStartTimeMs + this.manifest.getPeriod(this.periodIndex).startMs);
    }
