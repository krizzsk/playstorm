...
public final class DashMediaSource extends BaseMediaSource {
    ...
    public MediaPeriod createPeriod(MediaSource.MediaPeriodId mediaPeriodId, Allocator allocator, long j) {
        ...
        this.periodsById.put(dashMediaPeriod3.f14483id, dashMediaPeriod3);
    ...
    public void releasePeriod(MediaPeriod mediaPeriod) {
        ...
        this.periodsById.remove(dashMediaPeriod.f14483id);
    }
    ...
    public void onManifestLoadCompleted(com.google.android.exoplayer2.upstream.ParsingLoadable<com.google.android.exoplayer2.source.dash.manifest.DashManifest> r19, long r20, long r22) {
        ...
        L_0x005a:
            ...
            com.google.android.exoplayer2.util.Log.m16949w(r5, r8)
        L_0x006e:
            r5 = r6
            goto L_0x00ac
        L_0x0070:
    ...
    public void onUtcTimestampResolutionError(IOException iOException) {
        Log.m16946e("DashMediaSource", "Failed to resolve time offset.", iOException);
        processManifest(true);
    }
    ...
    private void processManifest(boolean z) {
        ...
        long msToUs = C5487C.msToUs(Util.getNowUnixTimeMs(this.elapsedRealtimeOffsetMs));
        ...
        if (z3 && this.manifest.timeShiftBufferDepthMs != -9223372036854775807L) {
            availableStartTimeInManifestUs = Math.max(availableStartTimeInManifestUs, availableEndTimeInManifestUs - C5487C.msToUs(this.manifest.timeShiftBufferDepthMs));
        }
        ...
        if (this.manifest.dynamic) {
            ...
            long msToUs2 = (msToUs - C5487C.msToUs(this.manifest.availabilityStartTimeMs)) - availableStartTimeInManifestUs;
            updateMediaItemLiveConfiguration(msToUs2, j3);
            long msToUs3 = msToUs2 - C5487C.msToUs(this.liveConfiguration.targetOffsetMs);
            j2 = this.manifest.availabilityStartTimeMs + C5487C.usToMs(availableStartTimeInManifestUs);
        ...
        long msToUs4 = availableStartTimeInManifestUs - C5487C.msToUs(period.startMs);
    ...
    private void updateMediaItemLiveConfiguration(long j, long j2) {
        ...
        if (j4 > j3) {
            j4 = Util.constrainValue(C5487C.usToMs(j - Math.min(MIN_LIVE_DEFAULT_START_POSITION_US, j2 / 2)), j5, j3);
        }
        long j6 = j4;
    ...
    private static long getIntervalUntilNextManifestRefreshMs(DashManifest dashManifest, long j) {
        ...
        long msToUs = C5487C.msToUs(period.startMs);
        long periodDurationUs = dashManifest2.getPeriodDurationUs(periodCount);
        long msToUs2 = C5487C.msToUs(j);
        long msToUs3 = C5487C.msToUs(dashManifest2.availabilityStartTimeMs);
        long msToUs4 = C5487C.msToUs(5000);
    ...
    private static long getAvailableStartTimeInManifestUs(Period period, long j, long j2) {
        ...
        long j3 = j;
        long j4 = j2;
        long msToUs = C5487C.msToUs(period2.startMs);
    ...
    private static final class DashTimeline extends Timeline {
        ...
        public Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
            ...
            Integer num = null;
            String str = z ? this.manifest.getPeriod(i).f14486id : null;
            if (z) {
                num = Integer.valueOf(this.firstPeriodId + i);
            }
            return period.set(str, num, 0, this.manifest.getPeriodDurationUs(i), C5487C.msToUs(this.manifest.getPeriod(i).startMs - this.manifest.getPeriod(0).startMs) - this.offsetInFirstPeriodUs);
        }
