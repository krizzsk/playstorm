...
public final class AdPlaybackState implements Bundleable {
    ...
    public static final class AdGroup implements Bundleable {
        ...
        public AdGroup withAdState(int i, int i2) {
            ...
            if (copyStatesWithSpaceForAdCount[i4] == 0 || copyStatesWithSpaceForAdCount[i4] == 1 || copyStatesWithSpaceForAdCount[i4] == i3) {
                z = true;
            }
    ...
    public AdPlaybackState(Object obj, long... jArr) {
        this(obj, createEmptyAdGroups(jArr), 0, -9223372036854775807L, 0);
    }
    ...
    public static AdPlaybackState fromBundle(Bundle bundle) {
        ...
        return new AdPlaybackState((Object) null, adGroupArr, bundle.getLong(keyForField(2), 0), bundle.getLong(keyForField(3), -9223372036854775807L), bundle.getInt(keyForField(4)));
    }
