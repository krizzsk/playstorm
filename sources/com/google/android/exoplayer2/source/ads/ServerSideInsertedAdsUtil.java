...
public final class ServerSideInsertedAdsUtil {
    ...
    public static long getStreamDurationUs(Player player, AdPlaybackState adPlaybackState) {
        ...
        return getStreamPositionUsForContent(period.durationUs, -1, adPlaybackState);
    }
    ...
    public static long getStreamPositionUs(Player player, AdPlaybackState adPlaybackState) {
        ...
        if (!player.isPlayingAd()) {
            return getStreamPositionUsForContent(C5487C.msToUs(player.getCurrentPosition()) - period.getPositionInWindowUs(), -1, adPlaybackState);
        }
        return getStreamPositionUsForAd(C5487C.msToUs(player.getCurrentPosition()), player.getCurrentAdGroupIndex(), player.getCurrentAdIndexInAdGroup(), adPlaybackState);
    }
