...
public final class VideoFrameReleaseHelper {
    ...
    public void onEnabled() {
        if (this.displayHelper != null) {
            ...
            this.displayHelper.register(new DisplayHelper.Listener() {
    ...
    private static void setSurfaceFrameRateV30(Surface surface2, float f) {
        try {
            ...
            Log.m16946e(TAG, "Failed to call Surface.setFrameRate", e);
        }
    }
    ...
    public void updateDefaultDisplayRefreshRateParams(Display display) {
        ...
        Log.m16949w(TAG, "Unable to query display refresh rate");
        this.vsyncDurationNs = -9223372036854775807L;
        this.vsyncOffsetNs = -9223372036854775807L;
    }
