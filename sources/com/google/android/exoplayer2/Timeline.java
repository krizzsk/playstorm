...
public abstract class Timeline implements Bundleable {
    public static final Bundleable.Creator<Timeline> CREATOR = $$Lambda$Timeline$3htemBvdw1oIoC0nd88uD3NIYcE.INSTANCE;
    ...
    public static final class Window implements Bundleable {
        public static final Bundleable.Creator<Window> CREATOR = $$Lambda$Timeline$Window$TK1Cf46Ui_2_PQDZo5oFeEMLs40.INSTANCE;
        ...
        public long getDefaultPositionMs() {
            return C5487C.usToMs(this.defaultPositionUs);
        }
        ...
        public long getDurationMs() {
            return C5487C.usToMs(this.durationUs);
        }
        ...
        public long getPositionInFirstPeriodMs() {
            return C5487C.usToMs(this.positionInFirstPeriodUs);
        }
        ...
        public static Window fromBundle(Bundle bundle) {
            ...
            long j = bundle2.getLong(keyForField(2), -9223372036854775807L);
            long j2 = bundle2.getLong(keyForField(3), -9223372036854775807L);
            long j3 = bundle2.getLong(keyForField(4), -9223372036854775807L);
            ...
            long j5 = bundle2.getLong(keyForField(10), -9223372036854775807L);
    ...
    public static final class Period implements Bundleable {
        public static final Bundleable.Creator<Period> CREATOR = $$Lambda$Timeline$Period$yRUN2c0o3Ebzl87JR1Kjk8icoi8.INSTANCE;
        ...
        public long getPositionInWindowMs() {
            return C5487C.usToMs(this.positionInWindowUs);
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (Util.areEqual(this.f14461id, period.f14461id) && Util.areEqual(this.uid, period.uid) && this.windowIndex == period.windowIndex && this.durationUs == period.durationUs && this.positionInWindowUs == period.positionInWindowUs && this.isPlaceholder == period.isPlaceholder && Util.areEqual(this.adPlaybackState, period.adPlaybackState)) {
                return true;
            }
            return false;
        }
    ...
    public static final class RemotableTimeline extends Timeline {
        ...
        public Period getPeriod(int i, Period period, boolean z) {
            ...
            period.set(period2.f14461id, period2.uid, period2.windowIndex, period2.durationUs, period2.positionInWindowUs, period2.adPlaybackState, period2.isPlaceholder);
            return period;
        }
