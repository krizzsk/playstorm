...
public class SimpleExoPlayer extends BasePlayer implements ExoPlayer, ExoPlayer.AudioComponent, ExoPlayer.VideoComponent, ExoPlayer.TextComponent, ExoPlayer.MetadataComponent, ExoPlayer.DeviceComponent {
    ...
    protected SimpleExoPlayer(Builder builder) {
        ...
        try {
            ...
            if (Util.SDK_INT < 21) {
                ...
                this.audioSessionId = C5487C.generateAudioSessionIdV21(this.applicationContext);
            }
    ...
    public void setVideoTextureView(TextureView textureView2) {
        ...
        if (textureView2.getSurfaceTextureListener() != null) {
            Log.m16949w(TAG, "Replacing existing SurfaceTextureListener.");
        }
        ...
        if (this.audioSessionId != i) {
            if (i == 0) {
                if (Util.SDK_INT < 21) {
                    ...
                    i = C5487C.generateAudioSessionIdV21(this.applicationContext);
                }
    ...
    private void removeSurfaceCallbacks() {
        ...
        if (textureView2 != null) {
            if (textureView2.getSurfaceTextureListener() != this.componentListener) {
                Log.m16949w(TAG, "SurfaceTextureListener already unset or replaced.");
            } else {
    ...
    private void verifyApplicationThread() {
        ...
        if (Thread.currentThread() != getApplicationLooper().getThread()) {
            ...
            if (!this.throwsWhenUsingWrongThread) {
                Log.m16950w(TAG, formatInvariant, this.hasNotifiedFullWrongThreadWarning ? null : new IllegalStateException());
