...
public abstract class MediaCodecRenderer extends BaseRenderer {
    private static final byte[] ADAPTATION_WORKAROUND_BUFFER = {0, 0, 1, 103, 66, -64, Ascii.f17948VT, -38, 37, -112, 0, 0, 1, 104, -50, Ascii.f17944SI, 19, 32, 0, 0, 1, 101, -120, -124, Ascii.f17935CR, -50, 113, Ascii.CAN, -96, 0, 47, -65, Ascii.f17938FS, 49, -61, 39, 93, 120};
            ...
            while (this.codec == null) {
                ...
                if (shouldInitCodec(peekFirst)) {
                    try {
                        ...
                        sb.append(valueOf);
                        Log.m16950w(TAG, sb.toString(), e2);
            ...
            try {
                ...
                if (readSource == -5) {
                    ...
                    try {
                        ...
                        throw createRendererException(e, this.inputFormat, C5487C.getErrorCodeForMediaDrmErrorCode(e.getErrorCode()));
                    }
                    ...
                    if (isEncrypted) {
                        try {
                            ...
                            throw createRendererException(e2, this.inputFormat, C5487C.getErrorCodeForMediaDrmErrorCode(e2.getErrorCode()));
                        }
                    } else {
    ...
    private boolean drmNeedsCodecReinitialization(MediaCodecInfo mediaCodecInfo, Format format, DrmSession drmSession, DrmSession drmSession2) throws ExoPlaybackException {
        ...
        if (drmSession2 == null || drmSession == null || Util.SDK_INT < 23 || C5487C.PLAYREADY_UUID.equals(drmSession.getSchemeUuid()) || C5487C.PLAYREADY_UUID.equals(drmSession2.getSchemeUuid()) || (frameworkMediaCrypto = getFrameworkMediaCrypto(drmSession2)) == null) {
            return true;
        }
