...
public final class MediaCodecUtil {
    ...
    public static void warmDecoderInfoCache(String str, boolean z, boolean z2) {
        try {
            ...
            Log.m16946e(TAG, "Codec warming failed", e);
        }
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:63:0x011a A[SYNTHETIC] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static java.util.ArrayList<com.google.android.exoplayer2.mediacodec.MediaCodecInfo> getDecoderInfosInternal(com.google.android.exoplayer2.mediacodec.MediaCodecUtil.CodecKey r24, com.google.android.exoplayer2.mediacodec.MediaCodecUtil.MediaCodecListCompat r25) throws com.google.android.exoplayer2.mediacodec.MediaCodecUtil.DecoderQueryException {
        ...
        L_0x0038:
            ...
            goto L_0x0025
        L_0x003f:
            android.media.MediaCodecInfo$CodecCapabilities r9 = r0.getCapabilitiesForType(r10)     // Catch:{ Exception -> 0x00d4 }
            boolean r6 = r2.isFeatureSupported(r4, r10, r9)     // Catch:{ Exception -> 0x00d4 }
            boolean r7 = r2.isFeatureRequired(r4, r10, r9)     // Catch:{ Exception -> 0x00d4 }
            boolean r8 = r1.tunneling     // Catch:{ Exception -> 0x00d4 }
            if (r8 != 0) goto L_0x0051
            if (r7 != 0) goto L_0x0025
        L_0x0051:
            boolean r7 = r1.tunneling     // Catch:{ Exception -> 0x00d4 }
            if (r7 == 0) goto L_0x0058
            if (r6 != 0) goto L_0x0058
            goto L_0x0025
        L_0x0058:
            boolean r6 = r2.isFeatureSupported(r3, r10, r9)     // Catch:{ Exception -> 0x00d4 }
            boolean r7 = r2.isFeatureRequired(r3, r10, r9)     // Catch:{ Exception -> 0x00d4 }
            boolean r8 = r1.secure     // Catch:{ Exception -> 0x00d4 }
            if (r8 != 0) goto L_0x0066
            if (r7 != 0) goto L_0x0025
        L_0x0066:
            boolean r7 = r1.secure     // Catch:{ Exception -> 0x00d4 }
            if (r7 == 0) goto L_0x006d
            if (r6 != 0) goto L_0x006d
            goto L_0x0025
        L_0x006d:
            boolean r16 = isHardwareAccelerated(r0)     // Catch:{ Exception -> 0x00d4 }
            boolean r17 = isSoftwareOnly(r0)     // Catch:{ Exception -> 0x00d4 }
            boolean r0 = isVendor(r0)     // Catch:{ Exception -> 0x00d4 }
        ...
        L_0x00aa:
            ...
            java.lang.String r6 = java.lang.String.valueOf(r21)     // Catch:{ Exception -> 0x00a8 }
            java.lang.String r7 = ".secure"
            java.lang.String r6 = r6.concat(r7)     // Catch:{ Exception -> 0x00a8 }
            r13 = 0
            r14 = 1
            r7 = r15
            r8 = r20
        ...
        L_0x00d4:
            ...
            r18 = r14
        L_0x00df:
            int r6 = com.google.android.exoplayer2.util.Util.SDK_INT     // Catch:{ Exception -> 0x0154 }
            r7 = 23
            java.lang.String r8 = "MediaCodecUtil"
            if (r6 > r7) goto L_0x011a
            boolean r6 = r5.isEmpty()     // Catch:{ Exception -> 0x0154 }
            if (r6 != 0) goto L_0x011a
            java.lang.String r0 = java.lang.String.valueOf(r21)     // Catch:{ Exception -> 0x0154 }
            int r0 = r0.length()     // Catch:{ Exception -> 0x0154 }
            int r0 = r0 + 46
            java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x0154 }
            r6.<init>(r0)     // Catch:{ Exception -> 0x0154 }
            java.lang.String r0 = "Skipping codec "
            r6.append(r0)     // Catch:{ Exception -> 0x0154 }
            r7 = r21
            r6.append(r7)     // Catch:{ Exception -> 0x0154 }
            java.lang.String r0 = " (failed to query capabilities)"
            r6.append(r0)     // Catch:{ Exception -> 0x0154 }
            java.lang.String r0 = r6.toString()     // Catch:{ Exception -> 0x0154 }
            com.google.android.exoplayer2.util.Log.m16945e(r8, r0)     // Catch:{ Exception -> 0x0154 }
        L_0x0112:
            int r12 = r22 + 1
            r14 = r18
            r13 = r23
        ...
        L_0x011a:
            r7 = r21
            java.lang.String r1 = java.lang.String.valueOf(r7)     // Catch:{ Exception -> 0x0154 }
            int r1 = r1.length()     // Catch:{ Exception -> 0x0154 }
            int r1 = r1 + 25
            java.lang.String r2 = java.lang.String.valueOf(r20)     // Catch:{ Exception -> 0x0154 }
            int r2 = r2.length()     // Catch:{ Exception -> 0x0154 }
            int r1 = r1 + r2
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x0154 }
            r2.<init>(r1)     // Catch:{ Exception -> 0x0154 }
            java.lang.String r1 = "Failed to query codec "
            r2.append(r1)     // Catch:{ Exception -> 0x0154 }
            r2.append(r7)     // Catch:{ Exception -> 0x0154 }
            java.lang.String r1 = " ("
            r2.append(r1)     // Catch:{ Exception -> 0x0154 }
            r1 = r20
            r2.append(r1)     // Catch:{ Exception -> 0x0154 }
            ...
            com.google.android.exoplayer2.util.Log.m16945e(r8, r1)     // Catch:{ Exception -> 0x0154 }
    ...
    private static Pair<Integer, Integer> getDolbyVisionProfileAndLevel(String str, String[] strArr) {
        if (strArr.length < 3) {
            ...
            Log.m16949w(TAG, valueOf.length() != 0 ? "Ignoring malformed Dolby Vision codec string: ".concat(valueOf) : new String("Ignoring malformed Dolby Vision codec string: "));
            return null;
        }
        Matcher matcher = PROFILE_PATTERN.matcher(strArr[1]);
        if (!matcher.matches()) {
            String valueOf2 = String.valueOf(str);
            Log.m16949w(TAG, valueOf2.length() != 0 ? "Ignoring malformed Dolby Vision codec string: ".concat(valueOf2) : new String("Ignoring malformed Dolby Vision codec string: "));
            return null;
        }
        ...
        if (dolbyVisionStringToProfile == null) {
            ...
            Log.m16949w(TAG, valueOf3.length() != 0 ? "Unknown Dolby Vision profile string: ".concat(valueOf3) : new String("Unknown Dolby Vision profile string: "));
            return null;
        }
        ...
        Log.m16949w(TAG, valueOf4.length() != 0 ? "Unknown Dolby Vision level string: ".concat(valueOf4) : new String("Unknown Dolby Vision level string: "));
        return null;
    }
    ...
    private static Pair<Integer, Integer> getHevcProfileAndLevel(String str, String[] strArr) {
        if (strArr.length < 4) {
            String valueOf = String.valueOf(str);
            Log.m16949w(TAG, valueOf.length() != 0 ? "Ignoring malformed HEVC codec string: ".concat(valueOf) : new String("Ignoring malformed HEVC codec string: "));
            return null;
        }
        int i = 1;
        Matcher matcher = PROFILE_PATTERN.matcher(strArr[1]);
        if (!matcher.matches()) {
            String valueOf2 = String.valueOf(str);
            Log.m16949w(TAG, valueOf2.length() != 0 ? "Ignoring malformed HEVC codec string: ".concat(valueOf2) : new String("Ignoring malformed HEVC codec string: "));
            return null;
        }
        String group = matcher.group(1);
        if (!"1".equals(group)) {
            if ("2".equals(group)) {
                ...
                String valueOf3 = String.valueOf(group);
                Log.m16949w(TAG, valueOf3.length() != 0 ? "Unknown HEVC profile string: ".concat(valueOf3) : new String("Unknown HEVC profile string: "));
                return null;
            }
        }
        ...
        String valueOf4 = String.valueOf(str2);
        Log.m16949w(TAG, valueOf4.length() != 0 ? "Unknown HEVC level string: ".concat(valueOf4) : new String("Unknown HEVC level string: "));
        return null;
    }
    ...
    private static Pair<Integer, Integer> getAvcProfileAndLevel(String str, String[] strArr) {
        ...
        if (strArr.length < 2) {
            String valueOf = String.valueOf(str);
            Log.m16949w(TAG, valueOf.length() != 0 ? "Ignoring malformed AVC codec string: ".concat(valueOf) : new String("Ignoring malformed AVC codec string: "));
            return null;
        }
        try {
            if (strArr[1].length() == 6) {
                ...
                String valueOf2 = String.valueOf(str);
                Log.m16949w(TAG, valueOf2.length() != 0 ? "Ignoring malformed AVC codec string: ".concat(valueOf2) : new String("Ignoring malformed AVC codec string: "));
                return null;
            }
            ...
            Log.m16949w(TAG, valueOf3.length() != 0 ? "Ignoring malformed AVC codec string: ".concat(valueOf3) : new String("Ignoring malformed AVC codec string: "));
            return null;
        }
    }
    ...
    private static Pair<Integer, Integer> getVp9ProfileAndLevel(String str, String[] strArr) {
        if (strArr.length < 3) {
            String valueOf = String.valueOf(str);
            Log.m16949w(TAG, valueOf.length() != 0 ? "Ignoring malformed VP9 codec string: ".concat(valueOf) : new String("Ignoring malformed VP9 codec string: "));
            return null;
        }
        try {
            int parseInt = Integer.parseInt(strArr[1]);
            ...
            String valueOf2 = String.valueOf(str);
            Log.m16949w(TAG, valueOf2.length() != 0 ? "Ignoring malformed VP9 codec string: ".concat(valueOf2) : new String("Ignoring malformed VP9 codec string: "));
            return null;
        }
    }
    ...
    private static Pair<Integer, Integer> getAv1ProfileAndLevel(String str, String[] strArr, ColorInfo colorInfo) {
        if (strArr.length < 4) {
            String valueOf = String.valueOf(str);
            Log.m16949w(TAG, valueOf.length() != 0 ? "Ignoring malformed AV1 codec string: ".concat(valueOf) : new String("Ignoring malformed AV1 codec string: "));
            return null;
        }
        int i = 1;
        try {
            ...
            if (parseInt != 0) {
                ...
                Log.m16949w(TAG, sb3.toString());
                return null;
            }
        } catch (NumberFormatException unused) {
            String valueOf2 = String.valueOf(str);
            Log.m16949w(TAG, valueOf2.length() != 0 ? "Ignoring malformed AV1 codec string: ".concat(valueOf2) : new String("Ignoring malformed AV1 codec string: "));
            return null;
        }
    }
    ...
    private static Pair<Integer, Integer> getAacCodecProfileAndLevel(String str, String[] strArr) {
        ...
        if (strArr.length != 3) {
            String valueOf = String.valueOf(str);
            Log.m16949w(TAG, valueOf.length() != 0 ? "Ignoring malformed MP4A codec string: ".concat(valueOf) : new String("Ignoring malformed MP4A codec string: "));
            return null;
        }
        try {
            ...
            String valueOf2 = String.valueOf(str);
            Log.m16949w(TAG, valueOf2.length() != 0 ? "Ignoring malformed MP4A codec string: ".concat(valueOf2) : new String("Ignoring malformed MP4A codec string: "));
        }
        return null;
    }
