...
public class PlayerNotificationManager {
    ...
    public static class Builder {
        ...
        public Builder(Context context2, int i, String str) {
            ...
            this.smallIconResourceId = C5701R.C5702drawable.exo_notification_small_icon;
            this.playActionIconResourceId = C5701R.C5702drawable.exo_notification_play;
            this.pauseActionIconResourceId = C5701R.C5702drawable.exo_notification_pause;
            this.stopActionIconResourceId = C5701R.C5702drawable.exo_notification_stop;
            this.rewindActionIconResourceId = C5701R.C5702drawable.exo_notification_rewind;
            this.fastForwardActionIconResourceId = C5701R.C5702drawable.exo_notification_fastforward;
            this.previousActionIconResourceId = C5701R.C5702drawable.exo_notification_previous;
            this.nextActionIconResourceId = C5701R.C5702drawable.exo_notification_next;
        }
    ...
    protected PlayerNotificationManager(Context context2, String str, int i, MediaDescriptionAdapter mediaDescriptionAdapter2, NotificationListener notificationListener2, CustomActionReceiver customActionReceiver2, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, String str2) {
        ...
        this.visibility = 1;
        Map<String, NotificationCompat.Action> createPlaybackActions = createPlaybackActions(applicationContext, this.instanceId, i3, i4, i5, i6, i7, i8, i9);
    ...
    public List<String> getActions(Player player2) {
        boolean isCommandAvailable = player2.isCommandAvailable(6);
        boolean z = true;
        boolean z2 = player2.isCommandAvailable(10) && this.controlDispatcher.isRewindEnabled();
        if (!player2.isCommandAvailable(11) || !this.controlDispatcher.isFastForwardEnabled()) {
            z = false;
        }
        boolean isCommandAvailable2 = player2.isCommandAvailable(8);
    ...
    public int[] getActionIndicesForCompactView(java.util.List<java.lang.String> r7, com.google.android.exoplayer2.Player r8) {
        ...
        L_0x0062:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.p195ui.PlayerNotificationManager.getActionIndicesForCompactView(java.util.List, com.google.android.exoplayer2.Player):int[]");
    }
    ...
    private static Map<String, NotificationCompat.Action> createPlaybackActions(Context context2, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        ...
        hashMap.put(ACTION_PLAY, new NotificationCompat.Action(i2, (CharSequence) context2.getString(C5701R.string.exo_controls_play_description), createBroadcastIntent(ACTION_PLAY, context2, i)));
        hashMap.put(ACTION_PAUSE, new NotificationCompat.Action(i3, (CharSequence) context2.getString(C5701R.string.exo_controls_pause_description), createBroadcastIntent(ACTION_PAUSE, context2, i)));
        hashMap.put(ACTION_STOP, new NotificationCompat.Action(i4, (CharSequence) context2.getString(C5701R.string.exo_controls_stop_description), createBroadcastIntent(ACTION_STOP, context2, i)));
        hashMap.put(ACTION_REWIND, new NotificationCompat.Action(i5, (CharSequence) context2.getString(C5701R.string.exo_controls_rewind_description), createBroadcastIntent(ACTION_REWIND, context2, i)));
        hashMap.put(ACTION_FAST_FORWARD, new NotificationCompat.Action(i6, (CharSequence) context2.getString(C5701R.string.exo_controls_fastforward_description), createBroadcastIntent(ACTION_FAST_FORWARD, context2, i)));
        hashMap.put(ACTION_PREVIOUS, new NotificationCompat.Action(i7, (CharSequence) context2.getString(C5701R.string.exo_controls_previous_description), createBroadcastIntent(ACTION_PREVIOUS, context2, i)));
        hashMap.put(ACTION_NEXT, new NotificationCompat.Action(i8, (CharSequence) context2.getString(C5701R.string.exo_controls_next_description), createBroadcastIntent(ACTION_NEXT, context2, i)));
        return hashMap;
    }
    ...
    private static PendingIntent createBroadcastIntent(String str, Context context2, int i) {
        ...
        return PendingIntent.getBroadcast(context2, i, intent, Util.SDK_INT >= 23 ? 201326592 : 134217728);
    }
            ...
            if (access$500 != null && PlayerNotificationManager.this.isNotificationStarted && intent.getIntExtra(PlayerNotificationManager.EXTRA_INSTANCE_ID, PlayerNotificationManager.this.instanceId) == PlayerNotificationManager.this.instanceId) {
                ...
                if (PlayerNotificationManager.ACTION_PLAY.equals(action)) {
                    if (access$500.getPlaybackState() == 1) {
                        PlayerNotificationManager.this.controlDispatcher.dispatchPrepare(access$500);
                    } else if (access$500.getPlaybackState() == 4) {
                        PlayerNotificationManager.this.controlDispatcher.dispatchSeekTo(access$500, access$500.getCurrentWindowIndex(), -9223372036854775807L);
                    }
                    ...
                    PlayerNotificationManager.this.controlDispatcher.dispatchPrevious(access$500);
                } else if (PlayerNotificationManager.ACTION_REWIND.equals(action)) {
                    PlayerNotificationManager.this.controlDispatcher.dispatchRewind(access$500);
                } else if (PlayerNotificationManager.ACTION_FAST_FORWARD.equals(action)) {
                    PlayerNotificationManager.this.controlDispatcher.dispatchFastForward(access$500);
                } else if (PlayerNotificationManager.ACTION_NEXT.equals(action)) {
                    PlayerNotificationManager.this.controlDispatcher.dispatchNext(access$500);
