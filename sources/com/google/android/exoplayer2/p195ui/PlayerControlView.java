...
public class PlayerControlView extends FrameLayout {
    ...
    public PlayerControlView(Context context, AttributeSet attributeSet, int i, AttributeSet attributeSet2) {
        ...
        int i2 = C5701R.layout.exo_player_control_view;
        ...
        if (attributeSet2 != null) {
            TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet2, C5701R.styleable.PlayerControlView, i, 0);
            try {
                this.showTimeoutMs = obtainStyledAttributes.getInt(C5701R.styleable.PlayerControlView_show_timeout, this.showTimeoutMs);
                i2 = obtainStyledAttributes.getResourceId(C5701R.styleable.PlayerControlView_controller_layout_id, i2);
                this.repeatToggleModes = getRepeatToggleModes(obtainStyledAttributes, this.repeatToggleModes);
                this.showRewindButton = obtainStyledAttributes.getBoolean(C5701R.styleable.PlayerControlView_show_rewind_button, this.showRewindButton);
                this.showFastForwardButton = obtainStyledAttributes.getBoolean(C5701R.styleable.PlayerControlView_show_fastforward_button, this.showFastForwardButton);
                this.showPreviousButton = obtainStyledAttributes.getBoolean(C5701R.styleable.PlayerControlView_show_previous_button, this.showPreviousButton);
                this.showNextButton = obtainStyledAttributes.getBoolean(C5701R.styleable.PlayerControlView_show_next_button, this.showNextButton);
                this.showShuffleButton = obtainStyledAttributes.getBoolean(C5701R.styleable.PlayerControlView_show_shuffle_button, this.showShuffleButton);
                setTimeBarMinUpdateInterval(obtainStyledAttributes.getInt(C5701R.styleable.PlayerControlView_time_bar_min_update_interval, this.timeBarMinUpdateIntervalMs));
            } finally {
        ...
        View findViewById = findViewById(C5701R.C5703id.exo_progress_placeholder);
        if (timeBar2 != null) {
        ...
        View findViewById2 = findViewById(C5701R.C5703id.exo_play);
        this.playButton = findViewById2;
        if (findViewById2 != null) {
            findViewById2.setOnClickListener(this.componentListener);
        }
        View findViewById3 = findViewById(C5701R.C5703id.exo_pause);
        this.pauseButton = findViewById3;
        if (findViewById3 != null) {
            findViewById3.setOnClickListener(this.componentListener);
        }
        View findViewById4 = findViewById(C5701R.C5703id.exo_prev);
        this.previousButton = findViewById4;
        if (findViewById4 != null) {
            findViewById4.setOnClickListener(this.componentListener);
        }
        View findViewById5 = findViewById(C5701R.C5703id.exo_next);
        this.nextButton = findViewById5;
        if (findViewById5 != null) {
            findViewById5.setOnClickListener(this.componentListener);
        }
        View findViewById6 = findViewById(C5701R.C5703id.exo_rew);
        this.rewindButton = findViewById6;
        if (findViewById6 != null) {
            findViewById6.setOnClickListener(this.componentListener);
        }
        View findViewById7 = findViewById(C5701R.C5703id.exo_ffwd);
        this.fastForwardButton = findViewById7;
        if (findViewById7 != null) {
            findViewById7.setOnClickListener(this.componentListener);
        }
        ImageView imageView = (ImageView) findViewById(C5701R.C5703id.exo_repeat_toggle);
        this.repeatToggleButton = imageView;
        if (imageView != null) {
            imageView.setOnClickListener(this.componentListener);
        }
        ImageView imageView2 = (ImageView) findViewById(C5701R.C5703id.exo_shuffle);
        this.shuffleButton = imageView2;
        if (imageView2 != null) {
            imageView2.setOnClickListener(this.componentListener);
        }
        this.vrButton = findViewById(C5701R.C5703id.exo_vr);
        setShowVrButton(false);
        updateButton(false, false, this.vrButton);
        Resources resources = context.getResources();
        this.buttonAlphaEnabled = ((float) resources.getInteger(C5701R.integer.exo_media_button_opacity_percentage_enabled)) / 100.0f;
        this.buttonAlphaDisabled = ((float) resources.getInteger(C5701R.integer.exo_media_button_opacity_percentage_disabled)) / 100.0f;
        this.repeatOffButtonDrawable = resources.getDrawable(C5701R.C5702drawable.exo_controls_repeat_off);
        this.repeatOneButtonDrawable = resources.getDrawable(C5701R.C5702drawable.exo_controls_repeat_one);
        this.repeatAllButtonDrawable = resources.getDrawable(C5701R.C5702drawable.exo_controls_repeat_all);
        this.shuffleOnButtonDrawable = resources.getDrawable(C5701R.C5702drawable.exo_controls_shuffle_on);
        this.shuffleOffButtonDrawable = resources.getDrawable(C5701R.C5702drawable.exo_controls_shuffle_off);
        this.repeatOffButtonContentDescription = resources.getString(C5701R.string.exo_controls_repeat_off_description);
        this.repeatOneButtonContentDescription = resources.getString(C5701R.string.exo_controls_repeat_one_description);
        this.repeatAllButtonContentDescription = resources.getString(C5701R.string.exo_controls_repeat_all_description);
        this.shuffleOnContentDescription = resources.getString(C5701R.string.exo_controls_shuffle_on_description);
        this.shuffleOffContentDescription = resources.getString(C5701R.string.exo_controls_shuffle_off_description);
    }
    ...
    public void updateNavigation() {
        ...
        if (isVisible() && this.isAttachedToWindow) {
            ...
            if (player2 != null) {
                ...
                boolean isCommandAvailable2 = player2.isCommandAvailable(6);
                z = player2.isCommandAvailable(10) && this.controlDispatcher.isRewindEnabled();
                if (player2.isCommandAvailable(11) && this.controlDispatcher.isFastForwardEnabled()) {
                    z5 = true;
                }
                boolean z6 = isCommandAvailable;
    ...
    public void updateProgress() {
        ...
        if (isVisible() && this.isAttachedToWindow) {
            ...
            if (this.progressUpdateListener != null && (z2 || z)) {
                this.progressUpdateListener.onProgressUpdate(j2, j);
            }
            removeCallbacks(this.updateProgressAction);
            if (player2 == null) {
                i = 1;
    ...
    private static int getRepeatToggleModes(TypedArray typedArray, int i) {
        return typedArray.getInt(C5701R.styleable.PlayerControlView_repeat_toggle_modes, i);
    }
        ...
        public void onClick(View view) {
            ...
            if (access$1100 != null) {
                if (PlayerControlView.this.nextButton == view) {
                    PlayerControlView.this.controlDispatcher.dispatchNext(access$1100);
                } else if (PlayerControlView.this.previousButton == view) {
                    PlayerControlView.this.controlDispatcher.dispatchPrevious(access$1100);
                } else if (PlayerControlView.this.fastForwardButton == view) {
                    if (access$1100.getPlaybackState() != 4) {
                        PlayerControlView.this.controlDispatcher.dispatchFastForward(access$1100);
                    }
                } else if (PlayerControlView.this.rewindButton == view) {
                    PlayerControlView.this.controlDispatcher.dispatchRewind(access$1100);
                    ...
                    PlayerControlView.this.controlDispatcher.dispatchSetRepeatMode(access$1100, RepeatModeUtil.getNextRepeatMode(access$1100.getRepeatMode(), PlayerControlView.this.repeatToggleModes));
                } else if (PlayerControlView.this.shuffleButton == view) {
                    PlayerControlView.this.controlDispatcher.dispatchSetShuffleModeEnabled(access$1100, !access$1100.getShuffleModeEnabled());
                }
            }
        }
    }
