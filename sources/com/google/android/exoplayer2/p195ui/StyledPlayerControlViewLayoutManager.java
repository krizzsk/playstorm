...
final class StyledPlayerControlViewLayoutManager {
    ...
    private final Runnable hideAllBarsRunnable = new Runnable() {
    ...
    private final Runnable hideMainBarRunnable = new Runnable() {
        public final void run() {
            StyledPlayerControlViewLayoutManager.this.hideMainBar();
        }
    };
    private final AnimatorSet hideProgressBarAnimator;
    private final Runnable hideProgressBarRunnable = new Runnable() {
        public final void run() {
    ...
    /* access modifiers changed from: private */
    public final Runnable showAllBarsRunnable = new Runnable() {
        public final void run() {
    ...
    public StyledPlayerControlViewLayoutManager(final StyledPlayerControlView styledPlayerControlView2) {
        ...
        this.controlsBackground = styledPlayerControlView2.findViewById(C5701R.C5703id.exo_controls_background);
        this.centerControls = (ViewGroup) styledPlayerControlView2.findViewById(C5701R.C5703id.exo_center_controls);
        this.minimalControls = (ViewGroup) styledPlayerControlView2.findViewById(C5701R.C5703id.exo_minimal_controls);
        this.bottomBar = (ViewGroup) styledPlayerControlView2.findViewById(C5701R.C5703id.exo_bottom_bar);
        this.timeView = (ViewGroup) styledPlayerControlView2.findViewById(C5701R.C5703id.exo_time);
        this.timeBar = styledPlayerControlView2.findViewById(C5701R.C5703id.exo_progress);
        this.basicControls = (ViewGroup) styledPlayerControlView2.findViewById(C5701R.C5703id.exo_basic_controls);
        this.extraControls = (ViewGroup) styledPlayerControlView2.findViewById(C5701R.C5703id.exo_extra_controls);
        this.extraControlsScrollView = (ViewGroup) styledPlayerControlView2.findViewById(C5701R.C5703id.exo_extra_controls_scroll_view);
        this.overflowShowButton = styledPlayerControlView2.findViewById(C5701R.C5703id.exo_overflow_show);
        View findViewById = styledPlayerControlView2.findViewById(C5701R.C5703id.exo_overflow_hide);
        ...
        float dimension = resources.getDimension(C5701R.dimen.exo_styled_bottom_bar_height) - resources.getDimension(C5701R.dimen.exo_styled_progress_bar_height);
        float dimension2 = resources.getDimension(C5701R.dimen.exo_styled_bottom_bar_height);
        AnimatorSet animatorSet = new AnimatorSet();
        this.hideMainBarAnimator = animatorSet;
        animatorSet.setDuration(250);
        this.hideMainBarAnimator.addListener(new AnimatorListenerAdapter() {
            public void onAnimationStart(Animator animator) {
        ...
        this.hideProgressBarAnimator.addListener(new AnimatorListenerAdapter() {
            public void onAnimationStart(Animator animator) {
                StyledPlayerControlViewLayoutManager.this.setUxState(3);
            }
        ...
        this.hideAllBarsAnimator.addListener(new AnimatorListenerAdapter() {
            public void onAnimationStart(Animator animator) {
                StyledPlayerControlViewLayoutManager.this.setUxState(3);
            }
        ...
        this.showMainBarAnimator.addListener(new AnimatorListenerAdapter() {
            public void onAnimationStart(Animator animator) {
        ...
        this.showAllBarsAnimator.addListener(new AnimatorListenerAdapter() {
            public void onAnimationStart(Animator animator) {
                StyledPlayerControlViewLayoutManager.this.setUxState(4);
            }
        ...
        this.overflowShowAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                StyledPlayerControlViewLayoutManager.this.lambda$new$2$StyledPlayerControlViewLayoutManager(valueAnimator);
            }
        });
        this.overflowShowAnimator.addListener(new AnimatorListenerAdapter() {
            public void onAnimationStart(Animator animator) {
        ...
        this.overflowHideAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                StyledPlayerControlViewLayoutManager.this.lambda$new$3$StyledPlayerControlViewLayoutManager(valueAnimator);
            }
        });
        this.overflowHideAnimator.addListener(new AnimatorListenerAdapter() {
            public void onAnimationStart(Animator animator) {
                if (StyledPlayerControlViewLayoutManager.this.basicControls != null) {
    ...
    public void onOverflowButtonClick(View view) {
        resetHideCallbacks();
        if (view.getId() == C5701R.C5703id.exo_overflow_show) {
            this.overflowShowAnimator.start();
        } else if (view.getId() == C5701R.C5703id.exo_overflow_hide) {
    ...
    public void updateLayoutForSizeChange() {
        ...
        if (view != null) {
            ...
            int dimensionPixelSize = this.styledPlayerControlView.getResources().getDimensionPixelSize(C5701R.dimen.exo_styled_progress_margin_bottom);
    ...
    private boolean shouldHideInMinimalMode(View view) {
        int id = view.getId();
        return id == C5701R.C5703id.exo_bottom_bar || id == C5701R.C5703id.exo_prev || id == C5701R.C5703id.exo_next || id == C5701R.C5703id.exo_rew || id == C5701R.C5703id.exo_rew_with_amount || id == C5701R.C5703id.exo_ffwd || id == C5701R.C5703id.exo_ffwd_with_amount;
    }
