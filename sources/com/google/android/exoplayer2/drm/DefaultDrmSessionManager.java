...
public class DefaultDrmSessionManager implements DrmSessionManager {
    ...
    public static final class Builder {
        ...
        private UUID uuid = C5487C.WIDEVINE_UUID;
    ...
    private DefaultDrmSessionManager(UUID uuid2, ExoMediaDrm.Provider provider, MediaDrmCallback mediaDrmCallback, HashMap<String, String> hashMap, boolean z, int[] iArr, boolean z2, LoadErrorHandlingPolicy loadErrorHandlingPolicy2, long j) {
        ...
        Assertions.checkArgument(!C5487C.COMMON_PSSH_UUID.equals(uuid2), "Use C.CLEARKEY_UUID instead");
        this.uuid = uuid2;
    ...
    public DrmSession acquireSession(Looper looper, DrmSessionEventListener.EventDispatcher eventDispatcher, Format format, boolean z) {
        ...
        if (this.offlineLicenseKeySetId == null) {
            ...
            if (list.isEmpty()) {
                ...
                Log.m16946e(TAG, "DRM error", missingSchemeDataException);
    ...
    private DrmSession maybeAcquirePlaceholderSession(int i, boolean z) {
        ...
        if (defaultDrmSession == null) {
            DefaultDrmSession createAndAcquireSessionWithRetry = createAndAcquireSessionWithRetry(ImmutableList.m20745of(), true, (DrmSessionEventListener.EventDispatcher) null, z);
    ...
    private boolean canAcquireSession(DrmInitData drmInitData) {
        ...
        if (getSchemeDatas(drmInitData, this.uuid, true).isEmpty()) {
            if (drmInitData.schemeDataCount != 1 || !drmInitData.get(0).matches(C5487C.COMMON_PSSH_UUID)) {
                return false;
            }
    ...
    private synchronized void initPlaybackLooper(Looper looper) {
        if (this.playbackLooper == null) {
            ...
            Assertions.checkState(this.playbackLooper == looper);
    ...
    private static List<DrmInitData.SchemeData> getSchemeDatas(DrmInitData drmInitData, UUID uuid2, boolean z) {
        ...
        for (int i = 0; i < drmInitData.schemeDataCount; i++) {
            ...
            if ((schemeData.matches(uuid2) || (C5487C.CLEARKEY_UUID.equals(uuid2) && schemeData.matches(C5487C.COMMON_PSSH_UUID))) && (schemeData.data != null || z)) {
    ...
    private class ReferenceCountListenerImpl implements DefaultDrmSession.ReferenceCountListener {
        ...
        public void onReferenceCountDecremented(DefaultDrmSession defaultDrmSession, int i) {
            if (i == 1 && DefaultDrmSessionManager.this.prepareCallsCount > 0 && DefaultDrmSessionManager.this.sessionKeepaliveMs != -9223372036854775807L) {
                ...
                ((Handler) Assertions.checkNotNull(DefaultDrmSessionManager.this.playbackHandler)).postAtTime(new Runnable() {
    ...
    private class PreacquiredSessionReference implements DrmSessionManager.DrmSessionReference {
        ...
        public void acquire(Format format) {
            ((Handler) Assertions.checkNotNull(DefaultDrmSessionManager.this.playbackHandler)).post(new Runnable(format) {
                ...
                public final void run() {
                    DefaultDrmSessionManager.PreacquiredSessionReference.this.mo28518xc86a28b6(this.f$1);
                }
            });
        }

        /* renamed from: lambda$acquire$0$DefaultDrmSessionManager$PreacquiredSessionReference */
        public /* synthetic */ void mo28518xc86a28b6(Format format) {
        ...
        public void release() {
            Util.postOrRun((Handler) Assertions.checkNotNull(DefaultDrmSessionManager.this.playbackHandler), new Runnable() {
                public final void run() {
                    DefaultDrmSessionManager.PreacquiredSessionReference.this.mo28519xc451dd04();
                }
            });
        }

        /* renamed from: lambda$release$1$DefaultDrmSessionManager$PreacquiredSessionReference */
        public /* synthetic */ void mo28519xc451dd04() {
            if (!this.isReleased) {
