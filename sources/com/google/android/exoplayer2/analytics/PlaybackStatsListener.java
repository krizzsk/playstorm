    ...
    public void onEvents(Player player, AnalyticsListener.Events events) {
        ...
        if (events.size() != 0) {
            ...
            for (String next : this.playbackStatsTrackers.keySet()) {
                ...
                boolean hasEvent8 = hasEvent(events2, next, 1028);
