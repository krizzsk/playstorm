...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    public static final ImmutableList<Long> DEFAULT_INITIAL_BITRATE_ESTIMATES_2G = ImmutableList.m20750of(248000L, 160000L, 142000L, 127000L, 113000L);
    public static final ImmutableList<Long> DEFAULT_INITIAL_BITRATE_ESTIMATES_3G = ImmutableList.m20750of(2200000L, 1300000L, 950000L, 760000L, 520000L);
    public static final ImmutableList<Long> DEFAULT_INITIAL_BITRATE_ESTIMATES_4G = ImmutableList.m20750of(4400000L, 2300000L, 1500000L, 1100000L, 640000L);
    public static final ImmutableList<Long> DEFAULT_INITIAL_BITRATE_ESTIMATES_5G_NSA = ImmutableList.m20750of(10000000L, 7200000L, 5000000L, 2700000L, 1600000L);
    public static final ImmutableList<Long> DEFAULT_INITIAL_BITRATE_ESTIMATES_5G_SA = ImmutableList.m20750of(2600000L, 2200000L, 2000000L, 1500000L, 470000L);
    public static final ImmutableList<Long> DEFAULT_INITIAL_BITRATE_ESTIMATES_WIFI = ImmutableList.m20750of(6200000L, 3900000L, 2300000L, 1300000L, 620000L);
    ...
    public static final class Builder {
        ...
        private static Map<Integer, Long> getInitialBitrateEstimatesForCountry(String str) {
            ...
            hashMap.put(10, (Long) DefaultBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_5G_NSA.get(countryGroupIndices.get(4).intValue()));
            hashMap.put(9, (Long) DefaultBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_5G_SA.get(countryGroupIndices.get(5).intValue()));
        ...
        private static ImmutableList<Integer> getCountryGroupIndices(String str) {
            ...
            return immutableList.isEmpty() ? ImmutableList.m20751of(2, 2, 2, 2, 2, 2) : immutableList;
        }
    }
    ...
    public DefaultBandwidthMeter() {
        this((Context) null, ImmutableMap.m20764of(), 2000, Clock.DEFAULT, false);
    }
    ...
    private DefaultBandwidthMeter(Context context, Map<Integer, Long> map, int i, Clock clock2, boolean z) {
        ...
        if (context != null) {
            ...
            instance.register(new NetworkTypeObserver.Listener() {
                public final void onNetworkTypeChanged(int i) {
                    DefaultBandwidthMeter.this.onNetworkTypeChanged(i);
                }
            });
            return;
        }
    ...
    public synchronized void onNetworkTypeChanged(int r9) {
        /*
            r8 = this;
            monitor-enter(r8)
            int r0 = r8.networkType     // Catch:{ all -> 0x0056 }
            if (r0 == 0) goto L_0x000b
            boolean r0 = r8.resetOnNetworkTypeChange     // Catch:{ all -> 0x0056 }
            if (r0 != 0) goto L_0x000b
            monitor-exit(r8)
            return
        L_0x000b:
            boolean r0 = r8.networkTypeOverrideSet     // Catch:{ all -> 0x0056 }
            if (r0 == 0) goto L_0x0011
            int r9 = r8.networkTypeOverride     // Catch:{ all -> 0x0056 }
        L_0x0011:
            int r0 = r8.networkType     // Catch:{ all -> 0x0056 }
            ...
            return
        L_0x0017:
            r8.networkType = r9     // Catch:{ all -> 0x0056 }
            r0 = 1
            ...
            goto L_0x0054
        L_0x0023:
            long r0 = r8.getInitialBitrateEstimateForNetworkType(r9)     // Catch:{ all -> 0x0056 }
            r8.bitrateEstimate = r0     // Catch:{ all -> 0x0056 }
            com.google.android.exoplayer2.util.Clock r9 = r8.clock     // Catch:{ all -> 0x0056 }
            long r0 = r9.elapsedRealtime()     // Catch:{ all -> 0x0056 }
            int r9 = r8.streamCount     // Catch:{ all -> 0x0056 }
            if (r9 <= 0) goto L_0x0039
            long r2 = r8.sampleStartTimeMs     // Catch:{ all -> 0x0056 }
            long r2 = r0 - r2
            int r9 = (int) r2     // Catch:{ all -> 0x0056 }
            goto L_0x003a
        L_0x0039:
            r9 = 0
        L_0x003a:
            r3 = r9
            long r4 = r8.sampleBytesTransferred     // Catch:{ all -> 0x0056 }
            long r6 = r8.bitrateEstimate     // Catch:{ all -> 0x0056 }
            r2 = r8
            r2.maybeNotifyBandwidthSample(r3, r4, r6)     // Catch:{ all -> 0x0056 }
            r8.sampleStartTimeMs = r0     // Catch:{ all -> 0x0056 }
            r0 = 0
            r8.sampleBytesTransferred = r0     // Catch:{ all -> 0x0056 }
            r8.totalBytesTransferred = r0     // Catch:{ all -> 0x0056 }
            r8.totalElapsedTimeMs = r0     // Catch:{ all -> 0x0056 }
            com.google.android.exoplayer2.util.SlidingPercentile r9 = r8.slidingPercentile     // Catch:{ all -> 0x0056 }
            r9.reset()     // Catch:{ all -> 0x0056 }
            monitor-exit(r8)
            return
        L_0x0054:
            monitor-exit(r8)
