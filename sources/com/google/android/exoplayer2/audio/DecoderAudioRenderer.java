...
public abstract class DecoderAudioRenderer<T extends Decoder<DecoderInputBuffer, ? extends SimpleOutputBuffer, ? extends DecoderException>> extends BaseRenderer implements MediaClock {
        ...
        if (this.outputStreamEnded) {
            ...
            if (this.inputFormat == null) {
                ...
                if (readSource == -5) {
                    ...
                    try {
                        ...
                        throw createRendererException(e2, (Format) null, 5002);
                    }
                } else {
                    return;
                }
            ...
            if (this.decoder != null) {
                try {
                    ...
                    Log.m16946e(TAG, "Audio codec error", e3);
        ...
        if (this.decoder == null) {
            ...
            if (drmSession == null || (exoMediaCrypto = drmSession.getMediaCrypto()) != null || this.decoderDrmSession.getError() != null) {
                try {
                    ...
                    Log.m16946e(TAG, "Audio codec error", e);
    ...
    private final class AudioSinkListener implements AudioSink.Listener {
        ...
        public void onAudioSinkError(Exception exc) {
            Log.m16946e(DecoderAudioRenderer.TAG, "Audio sink error", exc);
