...
public final class Ac3Util {
    ...
    public static SyncFrameInfo parseAc3SyncframeInfo(ParsableBitArray parsableBitArray) {
        ...
        if (z) {
            ...
            str = (parsableBitArray.readBit() && parsableBitArray2.readBits(i8) == 1 && parsableBitArray2.readBits(8) == 1) ? "audio/eac3-joc" : "audio/eac3";
            i = i11;
        } else {
            parsableBitArray2.skipBits(32);
            int readBits6 = parsableBitArray2.readBits(2);
            String str2 = readBits6 == 3 ? null : "audio/ac3";
