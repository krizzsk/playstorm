...
public final class MediaItem implements Bundleable {
    ...
    public static final class Builder {
        ...
        public MediaItem build() {
            ...
            Uri uri2 = this.uri;
            if (uri2 != null) {
                playbackProperties = new PlaybackProperties(uri2, this.mimeType, this.drmUuid != null ? new DrmConfiguration(this.drmUuid, this.drmLicenseUri, this.drmLicenseRequestHeaders, this.drmMultiSession, this.drmForceDefaultLicenseUri, this.drmPlayClearContentWithoutKey, this.drmSessionForClearTypes, this.drmKeySetId) : null, this.adTagUri != null ? new AdsConfiguration(this.adTagUri, this.adsId) : null, this.streamKeys, this.customCacheKey, this.subtitles, this.tag);
            } else {
    ...
    public static final class LiveConfiguration implements Bundleable {
        public static final Bundleable.Creator<LiveConfiguration> CREATOR = C5485x2616e06f.INSTANCE;
    ...
    public static final class ClippingProperties implements Bundleable {
        public static final Bundleable.Creator<ClippingProperties> CREATOR = C5484x7b207f6c.INSTANCE;
