...
public final class TypeAdapters {
    ...
    public static final TypeAdapterFactory ENUM_FACTORY = new TypeAdapterFactory() {
        ...
        public <T> com.google.gson.TypeAdapter<T> create(com.google.gson.Gson r1, com.google.gson.reflect.TypeToken<T> r2) {
            ...
            L_0x0021:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C753729.create(com.google.gson.Gson, com.google.gson.reflect.TypeToken):com.google.gson.TypeAdapter");
        }
    };
    ...
    static {
        ...
        TypeAdapter<BitSet> nullSafe2 = new TypeAdapter<BitSet>() {
            public BitSet read(JsonReader jsonReader) throws IOException {
                ...
                while (peek != JsonToken.END_ARRAY) {
                    int i2 = C754535.$SwitchMap$com$google$gson$stream$JsonToken[peek.ordinal()];
                    boolean z = true;
                    if (i2 == 1 || i2 == 2) {
                        int nextInt = jsonReader.nextInt();
                        if (nextInt == 0) {
        ...
        C752619 r0 = new TypeAdapter<StringBuilder>() {
        ...
        STRING_BUILDER = r0;
        STRING_BUILDER_FACTORY = newFactory(StringBuilder.class, r0);
        C752820 r02 = new TypeAdapter<StringBuffer>() {
        ...
        STRING_BUFFER = r02;
        STRING_BUFFER_FACTORY = newFactory(StringBuffer.class, r02);
        C752921 r03 = new TypeAdapter<URL>() {
        ...
        URL = r03;
        URL_FACTORY = newFactory(URL.class, r03);
        C753022 r04 = new TypeAdapter<URI>() {
        ...
        URI = r04;
        URI_FACTORY = newFactory(URI.class, r04);
        C753123 r05 = new TypeAdapter<InetAddress>() {
        ...
        INET_ADDRESS = r05;
        INET_ADDRESS_FACTORY = newTypeHierarchyFactory(InetAddress.class, r05);
        C753224 r06 = new TypeAdapter<UUID>() {
        ...
        UUID = r06;
        UUID_FACTORY = newFactory(UUID.class, r06);
        ...
        C753426 r07 = new TypeAdapter<Calendar>() {
        ...
        CALENDAR = r07;
        CALENDAR_FACTORY = newFactoryForMultipleTypes(Calendar.class, GregorianCalendar.class, r07);
        C753527 r08 = new TypeAdapter<Locale>() {
        ...
        LOCALE = r08;
        LOCALE_FACTORY = newFactory(Locale.class, r08);
        C753628 r09 = new TypeAdapter<JsonElement>() {
            public JsonElement read(JsonReader jsonReader) throws IOException {
                if (jsonReader instanceof JsonTreeReader) {
                    return ((JsonTreeReader) jsonReader).nextJsonElement();
                }
                switch (C754535.$SwitchMap$com$google$gson$stream$JsonToken[jsonReader.peek().ordinal()]) {
                    case 1:
        ...
        JSON_ELEMENT = r09;
        JSON_ELEMENT_FACTORY = newTypeHierarchyFactory(JsonElement.class, r09);
    }

    /* renamed from: com.google.gson.internal.bind.TypeAdapters$35 */
    static /* synthetic */ class C754535 {
        ...
        static {
            ...
            L_0x0078:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C754535.<clinit>():void");
        }
    }
