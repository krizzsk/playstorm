...
public abstract class FluentIterable<E> implements Iterable<E> {
    ...
    private Iterable<E> getDelegate() {
        return this.iterableDelegate.mo47125or(this);
    }
    ...
    /* renamed from: of */
    public static <E> FluentIterable<E> m20735of() {
        return from(ImmutableList.m20745of());
    }

    /* renamed from: of */
    public static <E> FluentIterable<E> m20736of(@NullableDecl E e, E... eArr) {
    ...
    public final Optional<E> first() {
        ...
        return it.hasNext() ? Optional.m20716of(it.next()) : Optional.absent();
    }
    ...
    public final Optional<E> last() {
        ...
        if (delegate instanceof List) {
            ...
            return Optional.m20716of(list.get(list.size() - 1));
        }
        ...
        if (delegate instanceof SortedSet) {
            return Optional.m20716of(((SortedSet) delegate).last());
        }
        do {
            next = it.next();
        } while (it.hasNext());
        return Optional.m20716of(next);
    }
