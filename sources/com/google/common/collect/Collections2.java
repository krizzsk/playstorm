...
public final class Collections2 {
    ...
    private static class PermutationIterator<E> extends AbstractIterator<List<E>> {
        ...
        PermutationIterator(List<E> list2) {
            ...
            this.f17969c = iArr;
            this.f17971o = new int[size];
            Arrays.fill(iArr, 0);
            Arrays.fill(this.f17971o, 1);
        }
        ...
        public void calculateNextPermutation() {
            ...
            if (size != -1) {
                int i = 0;
                while (true) {
                    int[] iArr = this.f17969c;
                    int i2 = this.f17970j;
                    int i3 = iArr[i2] + this.f17971o[i2];
                    if (i3 < 0) {
                        switchDirection();
                    } else if (i3 != i2 + 1) {
                        Collections.swap(this.list, (i2 - iArr[i2]) + i, (i2 - i3) + i);
                        this.f17969c[this.f17970j] = i3;
                        return;
                    } else if (i2 != 0) {
                        i++;
                        switchDirection();
