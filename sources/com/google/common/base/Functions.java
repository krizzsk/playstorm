...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        /* renamed from: f */
        private final Function<A, ? extends B> f17949f;

        /* renamed from: g */
        private final Function<B, C> f17950g;

        public FunctionComposition(Function<B, C> function, Function<A, ? extends B> function2) {
            this.f17950g = (Function) Preconditions.checkNotNull(function);
            this.f17949f = (Function) Preconditions.checkNotNull(function2);
        }

        public C apply(@NullableDecl A a) {
            return this.f17950g.apply(this.f17949f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f17949f.equals(functionComposition.f17949f) || !this.f17950g.equals(functionComposition.f17950g)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f17949f.hashCode() ^ this.f17950g.hashCode();
        }

        public String toString() {
            return this.f17950g + "(" + this.f17949f + ")";
        }
    }
