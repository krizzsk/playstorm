...
public enum CaseFormat {
    LOWER_HYPHEN(CharMatcher.m20708is('-'), "-") {
    ...
    LOWER_UNDERSCORE(CharMatcher.m20708is('_'), "_") {
        /* access modifiers changed from: package-private */
        public String normalizeWord(String str) {
            return Ascii.toLowerCase(str);
        }
    ...
    UPPER_UNDERSCORE(CharMatcher.m20708is('_'), "_") {
        /* access modifiers changed from: package-private */
        public String normalizeWord(String str) {
            return Ascii.toUpperCase(str);
        }
    ...
    /* renamed from: to */
    public final String mo47137to(CaseFormat caseFormat, String str) {
    ...
    private static final class StringConverter extends Converter<String, String> implements Serializable {
        ...
        public String doForward(String str) {
            return this.sourceFormat.mo47137to(this.targetFormat, str);
        }

        /* access modifiers changed from: protected */
        public String doBackward(String str) {
            return this.targetFormat.mo47137to(this.sourceFormat, str);
        }
