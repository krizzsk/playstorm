...
public final class Predicates {
    ...
    /* renamed from: or */
    public static <T> Predicate<T> m20722or(Iterable<? extends Predicate<? super T>> iterable) {
        return new OrPredicate(defensiveCopy(iterable));
    }

    @SafeVarargs
    /* renamed from: or */
    public static <T> Predicate<T> m20723or(Predicate<? super T>... predicateArr) {
        return new OrPredicate(defensiveCopy((T[]) predicateArr));
    }

    /* renamed from: or */
    public static <T> Predicate<T> m20721or(Predicate<? super T> predicate, Predicate<? super T> predicate2) {
    ...
    /* renamed from: in */
    public static <T> Predicate<T> m20720in(Collection<? extends T> collection) {
    ...
    private static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        /* renamed from: f */
        final Function<A, ? extends B> f17951f;

        /* renamed from: p */
        final Predicate<B> f17952p;

        private CompositionPredicate(Predicate<B> predicate, Function<A, ? extends B> function) {
            this.f17952p = (Predicate) Preconditions.checkNotNull(predicate);
            this.f17951f = (Function) Preconditions.checkNotNull(function);
        }

        public boolean apply(@NullableDecl A a) {
            return this.f17952p.apply(this.f17951f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f17951f.equals(compositionPredicate.f17951f) || !this.f17952p.equals(compositionPredicate.f17952p)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f17951f.hashCode() ^ this.f17952p.hashCode();
        }

        public String toString() {
            return this.f17952p + "(" + this.f17951f + ")";
        }
    }
