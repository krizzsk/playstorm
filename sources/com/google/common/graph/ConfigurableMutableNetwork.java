...
final class ConfigurableMutableNetwork<N, E> extends ConfigurableNetwork<N, E> implements MutableNetwork<N, E> {
    ...
    public boolean addEdge(N n, N n2, E e) {
        ...
        if (containsEdge(e)) {
            ...
            EndpointPair of = EndpointPair.m20845of((Network<?, ?>) this, n, n2);
    ...
    private NetworkConnections<N, E> newConnections() {
        if (isDirected()) {
            if (allowsParallelEdges()) {
                return DirectedMultiNetworkConnections.m20842of();
            }
            return DirectedNetworkConnections.m20843of();
        } else if (allowsParallelEdges()) {
            return UndirectedMultiNetworkConnections.m20848of();
        } else {
            return UndirectedNetworkConnections.m20849of();
        }
    }
}
