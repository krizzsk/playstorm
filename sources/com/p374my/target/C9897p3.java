...
public final class C9897p3 {

    /* renamed from: a */
    public static final Handler f24478a = new Handler(Looper.getMainLooper());

    /* renamed from: b */
    public static final AtomicBoolean f24479b = new AtomicBoolean();

    /* renamed from: c */
    public final CreativeType f24480c;

    /* renamed from: d */
    public final C9879o2 f24481d;

    /* renamed from: e */
    public final C9711g2<VideoData> f24482e;

    /* renamed from: f */
    public int f24483f = -1;

    /* renamed from: g */
    public float f24484g = 1.0f;

    /* renamed from: h */
    public AdEvents f24485h;

    /* renamed from: i */
    public AdSession f24486i;

    /* renamed from: j */
    public MediaEvents f24487j;
    ...
    /* renamed from: m */
    public C9902e f24490m;

    /* renamed from: com.my.target.p3$b */
    public static class C9899b implements Runnable {

        /* renamed from: a */
        public final AdSession f24491a;

        public C9899b(AdSession adSession) {
            this.f24491a = adSession;
        }

        public void run() {
            C9672e0.m27882a("OmTracker: keep adSession " + this.f24491a);
        }
    }

    /* renamed from: com.my.target.p3$c */
    public static final class C9900c {

        /* renamed from: a */
        public final View f24492a;

        /* renamed from: b */
        public final int f24493b;

        public C9900c(View view, int i) {
            this.f24492a = view;
            this.f24493b = i;
        }
    }
    ...
    public interface C9901d {
        ...
        /* renamed from: a */
        public static final Partner f24494a = Partner.createPartner("Corpmailru", MyTargetVersion.VERSION);
    }

    /* renamed from: com.my.target.p3$e */
    public static class C9902e implements Runnable {

        /* renamed from: a */
        public final WeakReference<C9897p3> f24495a;

        /* renamed from: b */
        public final AdSession f24496b;

        public C9902e(C9897p3 p3Var, AdSession adSession) {
            this.f24495a = new WeakReference<>(p3Var);
            this.f24496b = adSession;
        }

        public void run() {
            if (((C9897p3) this.f24495a.get()) == null) {
                C9672e0.m27882a("OmTracker: AdSession finished by cleaning references");
                this.f24496b.finish();
                return;
            }
            C9897p3.f24478a.postDelayed(this, 7000);
        }
    }

    public C9897p3(CreativeType creativeType, C9879o2 o2Var, C9711g2<VideoData> g2Var) {
        this.f24480c = creativeType;
        this.f24481d = o2Var;
        this.f24482e = g2Var;
    }

    /* renamed from: a */
    public static int m28957a(float f, float f2) {
        if (f2 == 0.0f) {
            return -1;
        }
        float f3 = f / f2;
        if (C9787j8.m28415a(f3, 0.0f) < 0) {
            return -1;
        }
        if (C9787j8.m28415a(f3, 0.25f) < 0) {
            return 0;
        }
        if (C9787j8.m28415a(f3, 0.5f) < 0) {
            return 1;
        }
        if (C9787j8.m28415a(f3, 0.75f) < 0) {
            return 2;
        }
        return C9787j8.m28415a(f3, 1.0f) < 0 ? 3 : 4;
    }

    /* renamed from: a */
    public static AdSession m28958a(AdSessionContext adSessionContext, CreativeType creativeType, boolean z) {
        try {
            ...
            C9672e0.m27882a("OmTracker: Unable to create AdSession: " + th.getMessage());
            return null;
        }
    }

    /* renamed from: a */
    public static AdSessionContext m28959a(View view, CreativeType creativeType, C9879o2 o2Var) {
        return (creativeType != CreativeType.HTML_DISPLAY || !(view instanceof WebView)) ? m28961a(o2Var) : m28960a((WebView) view, o2Var);
    }

    /* renamed from: a */
    public static AdSessionContext m28960a(WebView webView, C9879o2 o2Var) {
        String str;
        if (webView == null) {
            str = "OmTracker: HTML could not be tracked without WebView";
        } else {
            try {
                return AdSessionContext.createHtmlAdSessionContext(C9901d.f24494a, webView, o2Var.f24429b, o2Var.f24428a);
            } catch (Throwable th) {
    ...
    /* renamed from: a */
    public static C9897p3 m28962a(C10066z1 z1Var, int i, C9711g2<VideoData> g2Var, Context context) {
        String str;
        C9879o2 omData = z1Var.getOmData();
        if (omData == null) {
            return null;
        }
        if (f24479b.compareAndSet(false, true)) {
            try {
                C9672e0.m27882a("OmTracker: activating OmSDK");
        ...
        return new C9897p3(i != 1 ? i != 2 ? i != 3 ? i != 4 ? CreativeType.DEFINED_BY_JAVASCRIPT : CreativeType.AUDIO : CreativeType.VIDEO : CreativeType.NATIVE_DISPLAY : CreativeType.HTML_DISPLAY, omData, g2Var);
    }

    /* renamed from: a */
    public static String m28963a(String str) {
        ...
        try {
            ...
            C9672e0.m27882a("OmTracker: Unable to inject script: " + th.getMessage());
            return null;
        }
    }
    ...
    public static java.util.List<com.iab.omid.library.corpmailru.adsession.VerificationScriptResource> m28964a(java.util.List<com.p374my.target.C9896p2> r6) {
        /*
            r0 = 0
        ...
        L_0x000d:
            ...
            com.my.target.p2 r2 = (com.p374my.target.C9896p2) r2
            java.net.URL r3 = new java.net.URL     // Catch:{ all -> 0x003b }
            java.lang.String r4 = r2.f24475a     // Catch:{ all -> 0x003b }
            r3.<init>(r4)     // Catch:{ all -> 0x003b }
            java.lang.String r4 = r2.f24476b     // Catch:{ all -> 0x003b }
            java.lang.String r2 = r2.f24477c     // Catch:{ all -> 0x003b }
        ...
        L_0x003b:
            ...
            com.p374my.target.C9672e0.m27882a(r2)
            r2 = r0
        L_0x0055:
        ...
        L_0x005b:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p374my.target.C9897p3.m28964a(java.util.List):java.util.List");
    }

    /* renamed from: a */
    public static void m28965a(C9900c cVar, AdSession adSession) {
        try {
            int i = cVar.f24493b;
            adSession.addFriendlyObstruction(cVar.f24492a, i != 0 ? i != 1 ? i != 2 ? FriendlyObstructionPurpose.OTHER : FriendlyObstructionPurpose.NOT_VISIBLE : FriendlyObstructionPurpose.VIDEO_CONTROLS : FriendlyObstructionPurpose.CLOSE_AD, " ");
        } catch (Throwable th) {
            C9672e0.m27882a("OmTracker: Unable to addObstruction: " + th.getMessage());
        }
    }

    /* renamed from: a */
    public void mo65195a() {
        C9672e0.m27882a("OmTracker: finishing session");
        this.f24485h = null;
        if (this.f24486i == null) {
            C9672e0.m27882a("OmTracker: Unable to finish adSession: adSession is not initialized");
            return;
        }
        C9902e eVar = this.f24490m;
        if (eVar != null) {
            eVar.f24495a.clear();
            f24478a.removeCallbacks(this.f24490m);
            this.f24490m = null;
        }
        try {
            this.f24486i.finish();
            f24478a.postDelayed(new C9899b(this.f24486i), 7000);
        } catch (Throwable th) {
            C9672e0.m27882a("OmTracker: Unable to finish adSession: " + th.getMessage());
        }
    }

    /* renamed from: a */
    public void mo65196a(float f) {
        if (this.f24487j != null && C9787j8.m28415a(f, this.f24484g) != 0) {
            this.f24484g = f;
            try {
                this.f24487j.volumeChange(f);
            } catch (Throwable th) {
                C9672e0.m27882a("OmTracker: Unable to track media volume: " + th.getMessage());
            }
        }
    }

    /* renamed from: a */
    public void mo65197a(int i) {
        MediaEvents mediaEvents = this.f24487j;
        if (mediaEvents != null) {
            if (i == 0) {
                mediaEvents.pause();
            } else if (i == 1) {
                ...
                try {
                    ...
                    C9672e0.m27882a("OmTracker: Unable to track mediaEvent " + i + ": " + th.getMessage());
                }
            }
        }
    }
    ...
    /* renamed from: a */
    public final void mo65198a(int i, float f) {
        if (this.f24487j != null) {
            C9672e0.m27882a("OmTracker: sendQuartile() called with: quartile = [" + i + "]");
            if (i == 0) {
                this.f24487j.start(f, this.f24484g);
            } else if (i == 1) {
                this.f24487j.firstQuartile();
            } else if (i == 2) {
                this.f24487j.midpoint();
            } else if (i == 3) {
                this.f24487j.thirdQuartile();
            } else if (i == 4) {
                try {
                    this.f24487j.complete();
                } catch (Throwable th) {
                    C9672e0.m27882a("OmTracker: Unable to track quartiles: " + th.getMessage());
                }
            }
        }
    }
    ...
    /* renamed from: a */
    public void mo65199a(View view) {
        AdSession adSession = this.f24486i;
        if (adSession != null) {
            try {
                adSession.registerAdView(view);
            } catch (Throwable th) {
                C9672e0.m27882a("OmTracker: Unable to register view: " + th.getMessage());
            }
        }
    }

    /* renamed from: a */
    public void mo65200a(View view, C9900c... cVarArr) {
        StringBuilder sb;
        String str;
        String sb2;
        VastProperties vastProperties;
        AdSessionContext a = m28959a(view, this.f24480c, this.f24481d);
        if (a == null) {
            sb2 = "OmTracker: OmSDK start failed, AdSessionContext is not created";
        } else {
            AdSession a2 = m28958a(a, this.f24480c, this.f24482e != null);
            this.f24486i = a2;
            if (a2 == null) {
                sb2 = "OmTracker: OmSDK start failed, AdSession is not created";
            } else {
                C9902e eVar = new C9902e(this, a2);
                this.f24490m = eVar;
                f24478a.postDelayed(eVar, 7000);
                for (C9900c a3 : cVarArr) {
                    m28965a(a3, this.f24486i);
                }
                try {
                    C9672e0.m27882a("OmTracker: registering view");
                    this.f24486i.registerAdView(view);
                    try {
                        C9672e0.m27882a("OmTracker: creating AdEvents");
                        this.f24485h = AdEvents.createAdEvents(this.f24486i);
                        vastProperties = null;
                        if (this.f24482e != null) {
                            C9672e0.m27882a("OmTracker: Creating MediaEvents");
                            try {
                                this.f24487j = MediaEvents.createMediaEvents(this.f24486i);
                                int mediaSectionType = this.f24482e.getMediaSectionType();
                                ...
                                vastProperties = this.f24482e.isAllowClose() ? VastProperties.createVastPropertiesForSkippableMedia(this.f24482e.getAllowCloseDelay(), this.f24482e.isAutoPlay(), position) : VastProperties.createVastPropertiesForNonSkippableMedia(this.f24482e.isAutoPlay(), position);
                            } catch (Throwable th) {
                                C9672e0.m27882a("OmTracker: Unable to create MediaEvents: " + th.getMessage());
                            }
                        }
                    } catch (Throwable th2) {
                        th = th2;
                ...
                try {
                    ...
                    if (vastProperties != null) {
                        try {
                            this.f24485h.loaded(vastProperties);
                            return;
                        } catch (Throwable th4) {
                            C9672e0.m27882a("OmTracker: Unable to call loaded: " + th4.getMessage());
                            return;
                        }
                    } else {
                        this.f24485h.loaded();
    ...
    /* renamed from: a */
    public void mo65201a(boolean z) {
        PlayerState playerState;
        MediaEvents mediaEvents = this.f24487j;
        if (mediaEvents != null && z != this.f24488k) {
            this.f24488k = z;
            if (z) {
                try {
                    playerState = PlayerState.FULLSCREEN;
                } catch (Throwable th) {
                    C9672e0.m27882a("OmTracker: Unable to track media fullscreen: " + th.getMessage());
                    return;
                }
            } else {
    ...
    /* renamed from: a */
    public void mo65202a(C9900c... cVarArr) {
        if (this.f24486i != null) {
            for (C9900c a : cVarArr) {
                m28965a(a, this.f24486i);
            }
        }
    }

    /* renamed from: b */
    public void mo65203b(float f, float f2) {
        int a;
        int i;
        if (this.f24487j != null && (a = m28957a(f, f2)) != (i = this.f24483f) && a > i) {
            mo65198a(a, f2);
            this.f24483f = a;
        }
    }
    ...
    /* renamed from: b */
    public boolean mo65204b() {
        return this.f24480c == CreativeType.HTML_DISPLAY;
    }

    /* renamed from: c */
    public void mo65205c() {
        AdEvents adEvents;
        if (!this.f24489l && (adEvents = this.f24485h) != null) {
            try {
                adEvents.impressionOccurred();
                this.f24489l = true;
            } catch (Throwable th) {
                C9672e0.m27882a("OmTracker: Unable to call impression: " + th.getMessage());
            }
        }
    }
}
